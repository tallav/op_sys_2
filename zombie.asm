 ...
 379:	85 d2                	test   %edx,%edx
{
 ...
 3a7:	f7 f1                	div    %ecx
 3a9:	0f b6 92 8c 0b 00 00 	movzbl 0xb8c(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, const char *fmt, ...)
{
 ...
 5c4:	e9 8f fe ff ff       	jmp    458 <printf+0x48>
          s = "(null)";
 5c9:	bb 84 0b 00 00       	mov    $0xb84,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 5e1:	a1 f0 0f 00 00       	mov    0xff0,%eax
{
 ...
 61d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 61f:	a3 f0 0f 00 00       	mov    %eax,0xff0
}
 624:	5b                   	pop    %ebx
 625:	5e                   	pop    %esi
 626:	5f                   	pop    %edi
 ...
 636:	72 ce                	jb     606 <free+0x26>
{
 ...
 657:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 65a:	a3 f0 0f 00 00       	mov    %eax,0xff0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 679:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 67c:	8b 15 f0 0f 00 00    	mov    0xff0,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6bf:	73 47                	jae    708 <malloc+0x98>
    ...
    if(p == freep)
 6c1:	39 05 f0 0f 00 00    	cmp    %eax,0xff0
 ...
 6e6:	e8 f5 fe ff ff       	call   5e0 <free>
  return freep;
 6eb:	8b 15 f0 0f 00 00    	mov    0xff0,%edx
 ...
 714:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 717:	89 15 f0 0f 00 00    	mov    %edx,0xff0
}
 ...
 729:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 730:	c7 05 f0 0f 00 00 f4 	movl   $0xff4,0xff0
 737:	0f 00 00 
 73a:	c7 05 f4 0f 00 00 f4 	movl   $0xff4,0xff4
 741:	0f 00 00 
    base.s.size = 0;
 744:	b8 f4 0f 00 00       	mov    $0xff4,%eax
 749:	c7 05 f8 0f 00 00 00 	movl   $0x0,0xff8
 750:	00 00 00 
...
void create_tree(struct tree_node* node, int depth){
 ...
 781:	0f 84 8a 00 00 00    	je     811 <create_tree+0xa1>
 787:	8d 04 b5 fc ff ff ff 	lea    -0x4(,%esi,4),%eax
 78e:	89 45 e4             	mov    %eax,-0x1c(%ebp)
 791:	8d 4e fe             	lea    -0x2(%esi),%ecx
 794:	8b 55 e4             	mov    -0x1c(%ebp),%edx
 797:	03 15 04 10 00 00    	add    0x1004,%edx
        return;
    }
    if(curLevel != depth-2){
 79d:	39 0d ec 0f 00 00    	cmp    %ecx,0xfec
 7a3:	a1 fc 0f 00 00       	mov    0xffc,%eax
 7a8:	74 08                	je     7b2 <create_tree+0x42>
        index = level_index[depth-1];
 7aa:	8b 02                	mov    (%edx),%eax
        curLevel = depth-2;
 7ac:	89 0d ec 0f 00 00    	mov    %ecx,0xfec
    }
    node->level = curLevel;
    node->index = index;
 7b2:	89 43 10             	mov    %eax,0x10(%ebx)
    index++;
 7b5:	83 c0 01             	add    $0x1,%eax
    level_index[depth-1] = index;
    if(depth == 1){
 7b8:	83 fe 01             	cmp    $0x1,%esi
    node->level = curLevel;
 7bb:	89 4b 14             	mov    %ecx,0x14(%ebx)
    index++;
 7be:	a3 fc 0f 00 00       	mov    %eax,0xffc
    level_index[depth-1] = index;
 7c3:	89 02                	mov    %eax,(%edx)
    if(depth == 1){
 7c5:	74 59                	je     820 <create_tree+0xb0>
        node->left_child = 0;
        node->right_child = 0;
 ...
 7ca:	83 ee 01             	sub    $0x1,%esi
        struct tree_node *left = malloc(sizeof(struct tree_node));
 7cd:	6a 1c                	push   $0x1c
 7cf:	e8 9c fe ff ff       	call   670 <malloc>
 7d4:	89 c7                	mov    %eax,%edi
        struct tree_node *right = malloc(sizeof(struct tree_node));
 7d6:	c7 04 24 1c 00 00 00 	movl   $0x1c,(%esp)
 7dd:	e8 8e fe ff ff       	call   670 <malloc>
        left->parent = node;
 7e2:	89 5f 08             	mov    %ebx,0x8(%edi)
        right->parent = node;
 7e5:	89 58 08             	mov    %ebx,0x8(%eax)
        node->left_child = left;
 7e8:	89 3b                	mov    %edi,(%ebx)
        node->right_child = right;
 7ea:	89 43 04             	mov    %eax,0x4(%ebx)
 7ed:	89 45 e0             	mov    %eax,-0x20(%ebp)
        node->mutex_id = kthread_mutex_alloc();
 7f0:	e8 4d fb ff ff       	call   342 <kthread_mutex_alloc>
 7f5:	89 43 0c             	mov    %eax,0xc(%ebx)
        create_tree(left, depth-1);
 7f8:	58                   	pop    %eax
 7f9:	5a                   	pop    %edx
 7fa:	56                   	push   %esi
 7fb:	57                   	push   %edi
 7fc:	e8 6f ff ff ff       	call   770 <create_tree>
 801:	8b 55 e0             	mov    -0x20(%ebp),%edx
 804:	83 6d e4 04          	subl   $0x4,-0x1c(%ebp)
    if(depth == 0){
 808:	83 c4 10             	add    $0x10,%esp
 80b:	85 f6                	test   %esi,%esi
 80d:	89 d3                	mov    %edx,%ebx
 80f:	75 80                	jne    791 <create_tree+0x21>
 ...
 819:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
        node->left_child = 0;
 820:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
        node->lockPath = (int*)malloc(treeDepth*sizeof(int));
 826:	a1 00 10 00 00       	mov    0x1000,%eax
 82b:	83 ec 0c             	sub    $0xc,%esp
        node->right_child = 0;
 82e:	c7 43 04 00 00 00 00 	movl   $0x0,0x4(%ebx)
        node->lockPath = (int*)malloc(treeDepth*sizeof(int));
 835:	c1 e0 02             	shl    $0x2,%eax
 838:	50                   	push   %eax
 839:	e8 32 fe ff ff       	call   670 <malloc>
 83e:	83 c4 10             	add    $0x10,%esp
 841:	89 43 18             	mov    %eax,0x18(%ebx)
}
...
trnmnt_tree* trnmnt_tree_alloc(int depth){
 ...
 85a:	7e 74                	jle    8d0 <trnmnt_tree_alloc+0x80>
    trnmnt_tree *tree = malloc(sizeof(trnmnt_tree));
 85c:	83 ec 0c             	sub    $0xc,%esp
 85f:	6a 08                	push   $0x8
 861:	e8 0a fe ff ff       	call   670 <malloc>
    struct tree_node *root = malloc(sizeof(struct tree_node));
 866:	c7 04 24 1c 00 00 00 	movl   $0x1c,(%esp)
    trnmnt_tree *tree = malloc(sizeof(trnmnt_tree));
 86d:	89 c6                	mov    %eax,%esi
    struct tree_node *root = malloc(sizeof(struct tree_node));
 86f:	e8 fc fd ff ff       	call   670 <malloc>
    int arr[depth+1];
 874:	8d 53 01             	lea    0x1(%ebx),%edx
    treeDepth = depth;
 877:	89 1d 00 10 00 00    	mov    %ebx,0x1000
    tree->depth = depth;
 87d:	89 5e 04             	mov    %ebx,0x4(%esi)
    tree->root = root;
 880:	89 06                	mov    %eax,(%esi)
    root->parent = 0;
 882:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
    int arr[depth+1];
 889:	83 c4 10             	add    $0x10,%esp
 88c:	8d 04 95 12 00 00 00 	lea    0x12(,%edx,4),%eax
 893:	83 e0 f0             	and    $0xfffffff0,%eax
 896:	29 c4                	sub    %eax,%esp
    for(int i = 0; i < depth+1; i++)
 898:	31 c0                	xor    %eax,%eax
    int arr[depth+1];
 89a:	89 e1                	mov    %esp,%ecx
 89c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
        arr[i] = 0;
 8a0:	c7 04 81 00 00 00 00 	movl   $0x0,(%ecx,%eax,4)
    for(int i = 0; i < depth+1; i++)
 8a7:	83 c0 01             	add    $0x1,%eax
 8aa:	39 c2                	cmp    %eax,%edx
 8ac:	75 f2                	jne    8a0 <trnmnt_tree_alloc+0x50>
    create_tree(tree->root, depth+1);
 8ae:	83 ec 08             	sub    $0x8,%esp
    level_index = arr;
 8b1:	89 0d 04 10 00 00    	mov    %ecx,0x1004
    create_tree(tree->root, depth+1);
 8b7:	52                   	push   %edx
 8b8:	ff 36                	pushl  (%esi)
 8ba:	e8 b1 fe ff ff       	call   770 <create_tree>
    return tree;
 8bf:	83 c4 10             	add    $0x10,%esp
}
 8c2:	8d 65 f8             	lea    -0x8(%ebp),%esp
...
void print_node(struct tree_node *n,int l){
 ...
 8f1:	74 5a                	je     94d <print_node+0x6d>
    int i;
	print_node(n->right_child,l+1);
 8f3:	8d 43 01             	lea    0x1(%ebx),%eax
 8f6:	83 ec 08             	sub    $0x8,%esp
 8f9:	50                   	push   %eax
 8fa:	ff 76 04             	pushl  0x4(%esi)
 8fd:	89 45 e4             	mov    %eax,-0x1c(%ebp)
 900:	e8 db ff ff ff       	call   8e0 <print_node>
	for(i=0;i<l;++i){
 905:	83 c4 10             	add    $0x10,%esp
 908:	85 db                	test   %ebx,%ebx
 90a:	7e 1d                	jle    929 <print_node+0x49>
 90c:	31 ff                	xor    %edi,%edi
 90e:	66 90                	xchg   %ax,%ax
		printf(1,"    ");
 910:	83 ec 08             	sub    $0x8,%esp
	for(i=0;i<l;++i){
 913:	83 c7 01             	add    $0x1,%edi
		printf(1,"    ");
 916:	68 9d 0b 00 00       	push   $0xb9d
 91b:	6a 01                	push   $0x1
 91d:	e8 ee fa ff ff       	call   410 <printf>
	for(i=0;i<l;++i){
 922:	83 c4 10             	add    $0x10,%esp
 925:	39 df                	cmp    %ebx,%edi
 927:	75 e7                	jne    910 <print_node+0x30>
    }
	printf(1,"%d,%d,%d\n",n->level, n->index, n->mutex_id);
 929:	83 ec 0c             	sub    $0xc,%esp
 92c:	ff 76 0c             	pushl  0xc(%esi)
 92f:	ff 76 10             	pushl  0x10(%esi)
 932:	ff 76 14             	pushl  0x14(%esi)
 935:	68 a2 0b 00 00       	push   $0xba2
 93a:	6a 01                	push   $0x1
 93c:	e8 cf fa ff ff       	call   410 <printf>
	print_node(n->left_child,l+1);
 941:	8b 36                	mov    (%esi),%esi
	if(!n) return;
 943:	83 c4 20             	add    $0x20,%esp
	print_node(n->left_child,l+1);
 946:	8b 5d e4             	mov    -0x1c(%ebp),%ebx
	if(!n) return;
 949:	85 f6                	test   %esi,%esi
 94b:	75 a6                	jne    8f3 <print_node+0x13>
}
...
void print_tree(trnmnt_tree *t){
 ...
 96b:	74 0f                	je     97c <print_tree+0x1c>
	print_node(t->root,0);
 96d:	83 ec 08             	sub    $0x8,%esp
 970:	6a 00                	push   $0x0
 972:	ff 30                	pushl  (%eax)
 974:	e8 67 ff ff ff       	call   8e0 <print_node>
...
int delete_node(struct tree_node *node){
 ...
 98e:	74 5e                	je     9ee <delete_node+0x6e>
        if(kthread_mutex_dealloc(node->mutex_id) == -1){
 990:	83 ec 0c             	sub    $0xc,%esp
 993:	ff 73 0c             	pushl  0xc(%ebx)
 996:	e8 af f9 ff ff       	call   34a <kthread_mutex_dealloc>
 99b:	83 c4 10             	add    $0x10,%esp
 99e:	83 f8 ff             	cmp    $0xffffffff,%eax
 9a1:	74 4b                	je     9ee <delete_node+0x6e>
        delete_node(node->left_child); 
 9a3:	83 ec 0c             	sub    $0xc,%esp
 9a6:	ff 33                	pushl  (%ebx)
 9a8:	e8 d3 ff ff ff       	call   980 <delete_node>
        delete_node(node->right_child); 
 9ad:	58                   	pop    %eax
 9ae:	ff 73 04             	pushl  0x4(%ebx)
 9b1:	e8 ca ff ff ff       	call   980 <delete_node>
        if(node->lockPath){
 9b6:	8b 43 18             	mov    0x18(%ebx),%eax
 9b9:	83 c4 10             	add    $0x10,%esp
        node->left_child = 0;
 9bc:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
        node->right_child = 0;
 9c2:	c7 43 04 00 00 00 00 	movl   $0x0,0x4(%ebx)
        if(node->lockPath){
 9c9:	85 c0                	test   %eax,%eax
 9cb:	74 13                	je     9e0 <delete_node+0x60>
            free(node->lockPath);
 9cd:	83 ec 0c             	sub    $0xc,%esp
 9d0:	50                   	push   %eax
 9d1:	e8 0a fc ff ff       	call   5e0 <free>
            node->lockPath = 0;
 9d6:	c7 43 18 00 00 00 00 	movl   $0x0,0x18(%ebx)
 9dd:	83 c4 10             	add    $0x10,%esp
        free(node); 
 9e0:	83 ec 0c             	sub    $0xc,%esp
 9e3:	53                   	push   %ebx
 9e4:	e8 f7 fb ff ff       	call   5e0 <free>
...
int trnmnt_tree_dealloc(trnmnt_tree* tree){
 ...
 a0b:	ff 33                	pushl  (%ebx)
 a0d:	e8 6e ff ff ff       	call   980 <delete_node>
 a12:	83 c4 10             	add    $0x10,%esp
 a15:	85 c0                	test   %eax,%eax
 a17:	75 27                	jne    a40 <trnmnt_tree_dealloc+0x40>
        tree->root = 0;
        free(tree);
 a19:	83 ec 0c             	sub    $0xc,%esp
        tree->root = 0;
 a1c:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
 a22:	89 c6                	mov    %eax,%esi
        free(tree);
 a24:	53                   	push   %ebx
 a25:	e8 b6 fb ff ff       	call   5e0 <free>
        tree = 0;
        return 0;
 ...
 a45:	eb e6                	jmp    a2d <trnmnt_tree_dealloc+0x2d>
...
struct tree_node* find_leaf(struct tree_node* node, int ID){
 ...
 a5c:	8b 5d 0c             	mov    0xc(%ebp),%ebx
    if(node->right_child == 0 && node->left_child == 0){ 
 a5f:	8b 72 04             	mov    0x4(%edx),%esi
 a62:	8b 02                	mov    (%edx),%eax
 a64:	85 f6                	test   %esi,%esi
 a66:	75 18                	jne    a80 <find_leaf+0x30>
 a68:	85 c0                	test   %eax,%eax
 a6a:	75 14                	jne    a80 <find_leaf+0x30>
        if(ID == node->index){
 a6c:	39 5a 10             	cmp    %ebx,0x10(%edx)
 a6f:	0f 44 c2             	cmove  %edx,%eax
        if(leaf1)
            return leaf1;
        else
            return leaf2;
 ...
 a83:	53                   	push   %ebx
 a84:	50                   	push   %eax
 a85:	e8 c6 ff ff ff       	call   a50 <find_leaf>
 a8a:	5a                   	pop    %edx
 a8b:	59                   	pop    %ecx
 ...
 a8e:	89 c7                	mov    %eax,%edi
        struct tree_node* leaf2 = find_leaf(node->right_child, ID);
 a90:	e8 bb ff ff ff       	call   a50 <find_leaf>
 a95:	83 c4 10             	add    $0x10,%esp
        if(leaf1)
 a98:	85 ff                	test   %edi,%edi
 a9a:	0f 45 c7             	cmovne %edi,%eax
} 
...
int trnmnt_tree_acquire(trnmnt_tree* tree,int ID){
 ...
 abc:	ff 75 0c             	pushl  0xc(%ebp)
 abf:	ff 30                	pushl  (%eax)
 ac1:	e8 8a ff ff ff       	call   a50 <find_leaf>
 ac6:	8b 50 08             	mov    0x8(%eax),%edx
 ac9:	83 c4 10             	add    $0x10,%esp
 acc:	89 c7                	mov    %eax,%edi
    while(curNode->parent){
 ace:	89 c3                	mov    %eax,%ebx
 ad0:	85 d2                	test   %edx,%edx
 ad2:	74 32                	je     b06 <trnmnt_tree_acquire+0x56>
        int level = curNode->parent->level;
 ad4:	8b 72 14             	mov    0x14(%edx),%esi
        int mutex_lock = kthread_mutex_lock(mutexID);
 ad7:	83 ec 0c             	sub    $0xc,%esp
 ada:	ff 72 0c             	pushl  0xc(%edx)
 add:	e8 70 f8 ff ff       	call   352 <kthread_mutex_lock>
        leaf->lockPath[level] = curNode->parent->mutex_id;
 ae2:	8b 53 08             	mov    0x8(%ebx),%edx
        if(mutex_lock == -1){
 ae5:	83 c4 10             	add    $0x10,%esp
 ae8:	83 f8 ff             	cmp    $0xffffffff,%eax
        leaf->lockPath[level] = curNode->parent->mutex_id;
 aeb:	8b 4a 0c             	mov    0xc(%edx),%ecx
 aee:	8b 57 18             	mov    0x18(%edi),%edx
 af1:	89 0c b2             	mov    %ecx,(%edx,%esi,4)
        if(mutex_lock == -1){
 af4:	74 12                	je     b08 <trnmnt_tree_acquire+0x58>
        if(mutex_lock == 0){
 af6:	85 c0                	test   %eax,%eax
 af8:	8b 53 08             	mov    0x8(%ebx),%edx
 afb:	75 d3                	jne    ad0 <trnmnt_tree_acquire+0x20>
 afd:	89 d3                	mov    %edx,%ebx
 aff:	8b 52 08             	mov    0x8(%edx),%edx
    while(curNode->parent){
 b02:	85 d2                	test   %edx,%edx
 b04:	75 ce                	jne    ad4 <trnmnt_tree_acquire+0x24>
    return 0;
...
int trnmnt_tree_release(trnmnt_tree* tree,int ID){
 ...
 b14:	56                   	push   %esi
 b15:	53                   	push   %ebx
 b16:	83 ec 14             	sub    $0x14,%esp
    struct tree_node* leaf = find_leaf(tree->root, ID);
 b19:	8b 45 08             	mov    0x8(%ebp),%eax
 b1c:	ff 75 0c             	pushl  0xc(%ebp)
 b1f:	ff 30                	pushl  (%eax)
 b21:	e8 2a ff ff ff       	call   a50 <find_leaf>
    for(int i = treeDepth-1; i >= 0; i--){
 b26:	8b 35 00 10 00 00    	mov    0x1000,%esi
    struct tree_node* leaf = find_leaf(tree->root, ID);
 b2c:	83 c4 10             	add    $0x10,%esp
    for(int i = treeDepth-1; i >= 0; i--){
 b2f:	83 ee 01             	sub    $0x1,%esi
 b32:	78 44                	js     b78 <trnmnt_tree_release+0x68>
 b34:	89 c7                	mov    %eax,%edi
 b36:	8d 1c b5 00 00 00 00 	lea    0x0(,%esi,4),%ebx
 b3d:	eb 16                	jmp    b55 <trnmnt_tree_release+0x45>
 b3f:	90                   	nop
        leaf->lockPath[i] = 0;
 b40:	8b 47 18             	mov    0x18(%edi),%eax
    for(int i = treeDepth-1; i >= 0; i--){
 b43:	83 ee 01             	sub    $0x1,%esi
        leaf->lockPath[i] = 0;
 b46:	c7 04 18 00 00 00 00 	movl   $0x0,(%eax,%ebx,1)
 b4d:	83 eb 04             	sub    $0x4,%ebx
    for(int i = treeDepth-1; i >= 0; i--){
 b50:	83 fe ff             	cmp    $0xffffffff,%esi
 b53:	74 23                	je     b78 <trnmnt_tree_release+0x68>
        int res = kthread_mutex_unlock(leaf->lockPath[i]);
 b55:	8b 47 18             	mov    0x18(%edi),%eax
 b58:	83 ec 0c             	sub    $0xc,%esp
 b5b:	ff 34 18             	pushl  (%eax,%ebx,1)
 b5e:	e8 f7 f7 ff ff       	call   35a <kthread_mutex_unlock>
        if(res == -1){
 b63:	83 c4 10             	add    $0x10,%esp
 b66:	83 f8 ff             	cmp    $0xffffffff,%eax
 b69:	75 d5                	jne    b40 <trnmnt_tree_release+0x30>
}
 b6b:	8d 65 f4             	lea    -0xc(%ebp),%esp
 b6e:	5b                   	pop    %ebx
 b6f:	5e                   	pop    %esi
 b70:	5f                   	pop    %edi
 b71:	5d                   	pop    %ebp

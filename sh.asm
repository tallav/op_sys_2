...
main(void)
{
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
      38:	80 3d a2 1e 00 00 20 	cmpb   $0x20,0x1ea2
...
fork1(void)
{
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
      ...
      57:	6a 64                	push   $0x64
      59:	68 a0 1e 00 00       	push   $0x1ea0
      5e:	e8 9d 00 00 00       	call   100 <getcmd>
      63:	83 c4 10             	add    $0x10,%esp
      66:	85 c0                	test   %eax,%eax
      68:	78 37                	js     a1 <main+0xa1>
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
      6a:	80 3d a0 1e 00 00 63 	cmpb   $0x63,0x1ea0
      71:	75 ce                	jne    41 <main+0x41>
      73:	80 3d a1 1e 00 00 64 	cmpb   $0x64,0x1ea1
  ...
  exit();
      ...
      e6:	50                   	push   %eax
      e7:	68 a3 1e 00 00       	push   $0x1ea3
      ec:	68 bd 16 00 00       	push   $0x16bd
      f1:	6a 02                	push   $0x2
...
00000100 <getcmd>:
{
  ...
  printf(2, "$ ");
     ...
     10e:	68 14 16 00 00       	push   $0x1614
     113:	6a 02                	push   $0x2
...
00000150 <panic>:
{
  ...
  printf(2, "%s\n", s);
     ...
     159:	68 b1 16 00 00       	push   $0x16b1
     15e:	6a 02                	push   $0x2
...
00000170 <runcmd>:
{
  ...
  switch(cmd->type){
     ...
     189:	ff 24 85 cc 16 00 00 	jmp    *0x16cc(,%eax,4)
    if(ecmd->argv[0] == 0)
    ...
    printf(2, "exec %s failed\n", ecmd->argv[0]);
     ...
     1a9:	68 1e 16 00 00       	push   $0x161e
     1ae:	6a 02                	push   $0x2
  ...
  if(pid == -1)
    ...
    if(open(rcmd->file, rcmd->mode) < 0){
     ...
     1fd:	68 2e 16 00 00       	push   $0x162e
     202:	6a 02                	push   $0x2
  ...
  if(pid == -1)
    ...
    panic("runcmd");
     ...
     290:	68 17 16 00 00       	push   $0x1617
     295:	e8 b6 fe ff ff       	call   150 <panic>
    panic("fork");
     29a:	83 ec 0c             	sub    $0xc,%esp
     29d:	68 3e 16 00 00       	push   $0x163e
     ...
     2d8:	68 43 16 00 00       	push   $0x1643
...
00000310 <fork1>:
{
  ...
  return pid;
    ...
    panic("fork");
     ...
     325:	68 3e 16 00 00       	push   $0x163e
     ...
     469:	8b 45 08             	mov    0x8(%ebp),%eax
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     48d:	50                   	push   %eax
     48e:	68 84 1e 00 00       	push   $0x1e84
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     4dd:	50                   	push   %eax
     4de:	68 84 1e 00 00       	push   $0x1e84
  ...
  *ps = s;
  ...
  switch(*s){
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     536:	50                   	push   %eax
     537:	68 7c 1e 00 00       	push   $0x1e7c
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     555:	50                   	push   %eax
     556:	68 84 1e 00 00       	push   $0x1e84
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     5fd:	50                   	push   %eax
     5fe:	68 84 1e 00 00       	push   $0x1e84
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     653:	68 65 16 00 00       	push   $0x1665
     658:	53                   	push   %ebx
     659:	56                   	push   %esi
  ...
  return cmd;
     ...
     6de:	68 48 16 00 00       	push   $0x1648
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     6ff:	68 68 16 00 00       	push   $0x1668
     704:	57                   	push   %edi
     705:	56                   	push   %esi
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     74e:	68 7f 16 00 00       	push   $0x167f
     753:	57                   	push   %edi
     754:	56                   	push   %esi
    ...
    if(argc >= MAXARGS)
     ...
     798:	68 71 16 00 00       	push   $0x1671
  ...
  cmd->eargv[argc] = 0;
     ...
     7ea:	68 6a 16 00 00       	push   $0x166a
...
00000800 <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     81b:	68 84 16 00 00       	push   $0x1684
     820:	56                   	push   %esi
     821:	53                   	push   %ebx
...
00000870 <parseline>:
{
  ...
  while(peek(ps, es, "&")){
     ...
     8ab:	68 86 16 00 00       	push   $0x1686
     8b0:	56                   	push   %esi
     8b1:	53                   	push   %ebx
  ...
  if(peek(ps, es, ";")){
     ...
     8c1:	68 82 16 00 00       	push   $0x1682
     8c6:	56                   	push   %esi
     8c7:	53                   	push   %ebx
...
00000910 <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     91f:	68 68 16 00 00       	push   $0x1668
     924:	56                   	push   %esi
     925:	53                   	push   %ebx
  ...
  if(!peek(ps, es, ")"))
     94b:	68 a4 16 00 00       	push   $0x16a4
     950:	56                   	push   %esi
     951:	53                   	push   %ebx
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     9b5:	ff 24 85 e4 16 00 00 	jmp    *0x16e4(,%eax,4)
...
00000a50 <parsecmd>:
{
  ...
  peek(&s, es, "");
     ...
     a77:	68 23 17 00 00       	push   $0x1723
     a7c:	53                   	push   %ebx
     a7d:	50                   	push   %eax
  ...
  nulterminate(cmd);
    ...
    printf(2, "leftovers: %s\n", s);
     a9f:	52                   	push   %edx
     aa0:	50                   	push   %eax
     aa1:	68 a6 16 00 00       	push   $0x16a6
     aa6:	6a 02                	push   $0x2
     aa8:	e8 f3 03 00 00       	call   ea0 <printf>
    panic("syntax");
     aad:	c7 04 24 6a 16 00 00 	movl   $0x166a,(%esp)
     ...
     e09:	85 d2                	test   %edx,%edx
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     e37:	f7 f1                	div    %ecx
     e39:	0f b6 92 04 17 00 00 	movzbl 0x1704(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, const char *fmt, ...)
{
  ...
  write(fd, &c, 1);
    ...
    1054:	e9 8f fe ff ff       	jmp    ee8 <printf+0x48>
          s = "(null)";
    1059:	bb fc 16 00 00       	mov    $0x16fc,%ebx
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    1071:	a1 04 1f 00 00       	mov    0x1f04,%eax
{
  ...
  freep = p;
    10af:	a3 04 1f 00 00       	mov    %eax,0x1f04
}
    10b4:	5b                   	pop    %ebx
    10b5:	5e                   	pop    %esi
    10b6:	5f                   	pop    %edi
    ...
    10c6:	72 ce                	jb     1096 <free+0x26>
{
  ...
  freep = p;
    10ea:	a3 04 1f 00 00       	mov    %eax,0x1f04
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    110c:	8b 15 04 1f 00 00    	mov    0x1f04,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p == freep)
    1151:	39 05 04 1f 00 00    	cmp    %eax,0x1f04
  ...
  return freep;
    117b:	8b 15 04 1f 00 00    	mov    0x1f04,%edx
    ...
    11a4:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
    11a7:	89 15 04 1f 00 00    	mov    %edx,0x1f04
}
    ...
    base.s.ptr = freep = prevp = &base;
    11c0:	c7 05 04 1f 00 00 08 	movl   $0x1f08,0x1f04
    11c7:	1f 00 00 
    11ca:	c7 05 08 1f 00 00 08 	movl   $0x1f08,0x1f08
    11d1:	1f 00 00 
    base.s.size = 0;
    11d4:	b8 08 1f 00 00       	mov    $0x1f08,%eax
    11d9:	c7 05 0c 1f 00 00 00 	movl   $0x0,0x1f0c
    11e0:	00 00 00 
...
void create_tree(struct tree_node* node, int depth){
    ...
    120c:	8b 5d 08             	mov    0x8(%ebp),%ebx
    if(depth == 0){
    120f:	85 f6                	test   %esi,%esi
    1211:	0f 84 8a 00 00 00    	je     12a1 <create_tree+0xa1>
    1217:	8d 04 b5 fc ff ff ff 	lea    -0x4(,%esi,4),%eax
    121e:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    1221:	8d 4e fe             	lea    -0x2(%esi),%ecx
    1224:	8b 55 e4             	mov    -0x1c(%ebp),%edx
    1227:	03 15 18 1f 00 00    	add    0x1f18,%edx
        return;
    }
    if(curLevel != depth-2){
    122d:	39 0d 8c 1e 00 00    	cmp    %ecx,0x1e8c
    1233:	a1 10 1f 00 00       	mov    0x1f10,%eax
    1238:	74 08                	je     1242 <create_tree+0x42>
        index = level_index[depth-1];
    123a:	8b 02                	mov    (%edx),%eax
        curLevel = depth-2;
    123c:	89 0d 8c 1e 00 00    	mov    %ecx,0x1e8c
    }
    node->level = curLevel;
    node->index = index;
    1242:	89 43 10             	mov    %eax,0x10(%ebx)
    index++;
    1245:	83 c0 01             	add    $0x1,%eax
    level_index[depth-1] = index;
    if(depth == 1){
    1248:	83 fe 01             	cmp    $0x1,%esi
    node->level = curLevel;
    124b:	89 4b 14             	mov    %ecx,0x14(%ebx)
    index++;
    124e:	a3 10 1f 00 00       	mov    %eax,0x1f10
    level_index[depth-1] = index;
    1253:	89 02                	mov    %eax,(%edx)
    if(depth == 1){
    1255:	74 59                	je     12b0 <create_tree+0xb0>
        node->left_child = 0;
        node->right_child = 0;
    ...
    125a:	83 ee 01             	sub    $0x1,%esi
        struct tree_node *left = malloc(sizeof(struct tree_node));
    125d:	6a 1c                	push   $0x1c
    125f:	e8 9c fe ff ff       	call   1100 <malloc>
    1264:	89 c7                	mov    %eax,%edi
        struct tree_node *right = malloc(sizeof(struct tree_node));
    1266:	c7 04 24 1c 00 00 00 	movl   $0x1c,(%esp)
    126d:	e8 8e fe ff ff       	call   1100 <malloc>
        left->parent = node;
    1272:	89 5f 08             	mov    %ebx,0x8(%edi)
        right->parent = node;
    1275:	89 58 08             	mov    %ebx,0x8(%eax)
        node->left_child = left;
    1278:	89 3b                	mov    %edi,(%ebx)
        node->right_child = right;
    127a:	89 43 04             	mov    %eax,0x4(%ebx)
    127d:	89 45 e0             	mov    %eax,-0x20(%ebp)
        node->mutex_id = kthread_mutex_alloc();
    1280:	e8 4d fb ff ff       	call   dd2 <kthread_mutex_alloc>
    ...
    128a:	56                   	push   %esi
    128b:	57                   	push   %edi
    128c:	e8 6f ff ff ff       	call   1200 <create_tree>
    1291:	8b 55 e0             	mov    -0x20(%ebp),%edx
    1294:	83 6d e4 04          	subl   $0x4,-0x1c(%ebp)
    if(depth == 0){
    1298:	83 c4 10             	add    $0x10,%esp
    129b:	85 f6                	test   %esi,%esi
    129d:	89 d3                	mov    %edx,%ebx
    129f:	75 80                	jne    1221 <create_tree+0x21>
        create_tree(right, depth-1);
    }
    return;
}
    12a1:	8d 65 f4             	lea    -0xc(%ebp),%esp
    12a4:	5b                   	pop    %ebx
    12a5:	5e                   	pop    %esi
    12a6:	5f                   	pop    %edi
    12a7:	5d                   	pop    %ebp
    ...
    12a9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
        node->left_child = 0;
    12b0:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
        node->lockPath = (int*)malloc(treeDepth*sizeof(int));
    12b6:	a1 14 1f 00 00       	mov    0x1f14,%eax
    12bb:	83 ec 0c             	sub    $0xc,%esp
        node->right_child = 0;
    12be:	c7 43 04 00 00 00 00 	movl   $0x0,0x4(%ebx)
        node->lockPath = (int*)malloc(treeDepth*sizeof(int));
    12c5:	c1 e0 02             	shl    $0x2,%eax
    12c8:	50                   	push   %eax
    12c9:	e8 32 fe ff ff       	call   1100 <malloc>
    12ce:	83 c4 10             	add    $0x10,%esp
    12d1:	89 43 18             	mov    %eax,0x18(%ebx)
}
    12d4:	8d 65 f4             	lea    -0xc(%ebp),%esp
    12d7:	5b                   	pop    %ebx
    12d8:	5e                   	pop    %esi
    12d9:	5f                   	pop    %edi
    12da:	5d                   	pop    %ebp
...
trnmnt_tree* trnmnt_tree_alloc(int depth){
    ...
    12e8:	85 db                	test   %ebx,%ebx
    12ea:	7e 74                	jle    1360 <trnmnt_tree_alloc+0x80>
    trnmnt_tree *tree = malloc(sizeof(trnmnt_tree));
    12ec:	83 ec 0c             	sub    $0xc,%esp
    12ef:	6a 08                	push   $0x8
    12f1:	e8 0a fe ff ff       	call   1100 <malloc>
    struct tree_node *root = malloc(sizeof(struct tree_node));
    12f6:	c7 04 24 1c 00 00 00 	movl   $0x1c,(%esp)
    trnmnt_tree *tree = malloc(sizeof(trnmnt_tree));
    12fd:	89 c6                	mov    %eax,%esi
    struct tree_node *root = malloc(sizeof(struct tree_node));
    12ff:	e8 fc fd ff ff       	call   1100 <malloc>
    int arr[depth+1];
    1304:	8d 53 01             	lea    0x1(%ebx),%edx
    treeDepth = depth;
    1307:	89 1d 14 1f 00 00    	mov    %ebx,0x1f14
    tree->depth = depth;
    130d:	89 5e 04             	mov    %ebx,0x4(%esi)
    tree->root = root;
    1310:	89 06                	mov    %eax,(%esi)
    root->parent = 0;
    1312:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
    int arr[depth+1];
    1319:	83 c4 10             	add    $0x10,%esp
    131c:	8d 04 95 12 00 00 00 	lea    0x12(,%edx,4),%eax
    1323:	83 e0 f0             	and    $0xfffffff0,%eax
    1326:	29 c4                	sub    %eax,%esp
    for(int i = 0; i < depth+1; i++)
    1328:	31 c0                	xor    %eax,%eax
    int arr[depth+1];
    132a:	89 e1                	mov    %esp,%ecx
    132c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
        arr[i] = 0;
    1330:	c7 04 81 00 00 00 00 	movl   $0x0,(%ecx,%eax,4)
    for(int i = 0; i < depth+1; i++)
    1337:	83 c0 01             	add    $0x1,%eax
    133a:	39 c2                	cmp    %eax,%edx
    133c:	75 f2                	jne    1330 <trnmnt_tree_alloc+0x50>
    create_tree(tree->root, depth+1);
    133e:	83 ec 08             	sub    $0x8,%esp
    level_index = arr;
    1341:	89 0d 18 1f 00 00    	mov    %ecx,0x1f18
    create_tree(tree->root, depth+1);
    1347:	52                   	push   %edx
    1348:	ff 36                	pushl  (%esi)
    134a:	e8 b1 fe ff ff       	call   1200 <create_tree>
    return tree;
    134f:	83 c4 10             	add    $0x10,%esp
}
    1352:	8d 65 f8             	lea    -0x8(%ebp),%esp
    1355:	89 f0                	mov    %esi,%eax
    1357:	5b                   	pop    %ebx
    1358:	5e                   	pop    %esi
    1359:	5d                   	pop    %ebp
    135a:	c3                   	ret    
...
void print_node(struct tree_node *n,int l){
    ...
    1379:	8b 75 08             	mov    0x8(%ebp),%esi
    137c:	8b 5d 0c             	mov    0xc(%ebp),%ebx
	if(!n) return;
    137f:	85 f6                	test   %esi,%esi
    1381:	74 5a                	je     13dd <print_node+0x6d>
    int i;
	print_node(n->right_child,l+1);
    1383:	8d 43 01             	lea    0x1(%ebx),%eax
    1386:	83 ec 08             	sub    $0x8,%esp
    1389:	50                   	push   %eax
    138a:	ff 76 04             	pushl  0x4(%esi)
    138d:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    1390:	e8 db ff ff ff       	call   1370 <print_node>
	for(i=0;i<l;++i){
    1395:	83 c4 10             	add    $0x10,%esp
    1398:	85 db                	test   %ebx,%ebx
    139a:	7e 1d                	jle    13b9 <print_node+0x49>
    139c:	31 ff                	xor    %edi,%edi
    139e:	66 90                	xchg   %ax,%ax
		printf(1,"    ");
    13a0:	83 ec 08             	sub    $0x8,%esp
	for(i=0;i<l;++i){
    13a3:	83 c7 01             	add    $0x1,%edi
		printf(1,"    ");
    13a6:	68 15 17 00 00       	push   $0x1715
    13ab:	6a 01                	push   $0x1
    13ad:	e8 ee fa ff ff       	call   ea0 <printf>
	for(i=0;i<l;++i){
    13b2:	83 c4 10             	add    $0x10,%esp
    13b5:	39 df                	cmp    %ebx,%edi
    13b7:	75 e7                	jne    13a0 <print_node+0x30>
    }
	printf(1,"%d,%d,%d\n",n->level, n->index, n->mutex_id);
    13b9:	83 ec 0c             	sub    $0xc,%esp
    13bc:	ff 76 0c             	pushl  0xc(%esi)
    13bf:	ff 76 10             	pushl  0x10(%esi)
    13c2:	ff 76 14             	pushl  0x14(%esi)
    13c5:	68 1a 17 00 00       	push   $0x171a
    13ca:	6a 01                	push   $0x1
    13cc:	e8 cf fa ff ff       	call   ea0 <printf>
	print_node(n->left_child,l+1);
    13d1:	8b 36                	mov    (%esi),%esi
	if(!n) return;
    13d3:	83 c4 20             	add    $0x20,%esp
	print_node(n->left_child,l+1);
    13d6:	8b 5d e4             	mov    -0x1c(%ebp),%ebx
	if(!n) return;
    13d9:	85 f6                	test   %esi,%esi
    13db:	75 a6                	jne    1383 <print_node+0x13>
}
...
void print_tree(trnmnt_tree *t){
    ...
    13fb:	74 0f                	je     140c <print_tree+0x1c>
	print_node(t->root,0);
    13fd:	83 ec 08             	sub    $0x8,%esp
    1400:	6a 00                	push   $0x0
    1402:	ff 30                	pushl  (%eax)
    1404:	e8 67 ff ff ff       	call   1370 <print_node>
...
int delete_node(struct tree_node *node){
    ...
    1419:	8b 5d 08             	mov    0x8(%ebp),%ebx
    if (node != 0){ 
    141c:	85 db                	test   %ebx,%ebx
    141e:	74 5e                	je     147e <delete_node+0x6e>
        if(kthread_mutex_dealloc(node->mutex_id) == -1){
    1420:	83 ec 0c             	sub    $0xc,%esp
    1423:	ff 73 0c             	pushl  0xc(%ebx)
    1426:	e8 af f9 ff ff       	call   dda <kthread_mutex_dealloc>
    142b:	83 c4 10             	add    $0x10,%esp
    142e:	83 f8 ff             	cmp    $0xffffffff,%eax
    1431:	74 4b                	je     147e <delete_node+0x6e>
        delete_node(node->left_child); 
    1433:	83 ec 0c             	sub    $0xc,%esp
    1436:	ff 33                	pushl  (%ebx)
    1438:	e8 d3 ff ff ff       	call   1410 <delete_node>
        delete_node(node->right_child); 
    143d:	58                   	pop    %eax
    143e:	ff 73 04             	pushl  0x4(%ebx)
    1441:	e8 ca ff ff ff       	call   1410 <delete_node>
        if(node->lockPath){
    1446:	8b 43 18             	mov    0x18(%ebx),%eax
    1449:	83 c4 10             	add    $0x10,%esp
        node->left_child = 0;
    144c:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
        node->right_child = 0;
    1452:	c7 43 04 00 00 00 00 	movl   $0x0,0x4(%ebx)
        if(node->lockPath){
    1459:	85 c0                	test   %eax,%eax
    145b:	74 13                	je     1470 <delete_node+0x60>
            free(node->lockPath);
    145d:	83 ec 0c             	sub    $0xc,%esp
    1460:	50                   	push   %eax
    1461:	e8 0a fc ff ff       	call   1070 <free>
            node->lockPath = 0;
    1466:	c7 43 18 00 00 00 00 	movl   $0x0,0x18(%ebx)
    146d:	83 c4 10             	add    $0x10,%esp
        free(node); 
    1470:	83 ec 0c             	sub    $0xc,%esp
    1473:	53                   	push   %ebx
    1474:	e8 f7 fb ff ff       	call   1070 <free>
    1479:	83 c4 10             	add    $0x10,%esp
    147c:	31 c0                	xor    %eax,%eax
}
    147e:	8b 5d fc             	mov    -0x4(%ebp),%ebx
    1481:	c9                   	leave  
    1482:	c3                   	ret    
    1483:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    1489:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi

00001490 <trnmnt_tree_dealloc>:
...
int trnmnt_tree_dealloc(trnmnt_tree* tree){
    ...
    149b:	ff 33                	pushl  (%ebx)
    149d:	e8 6e ff ff ff       	call   1410 <delete_node>
    14a2:	83 c4 10             	add    $0x10,%esp
    14a5:	85 c0                	test   %eax,%eax
    14a7:	75 27                	jne    14d0 <trnmnt_tree_dealloc+0x40>
        tree->root = 0;
        free(tree);
    14a9:	83 ec 0c             	sub    $0xc,%esp
        tree->root = 0;
    14ac:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
    14b2:	89 c6                	mov    %eax,%esi
        free(tree);
    14b4:	53                   	push   %ebx
    14b5:	e8 b6 fb ff ff       	call   1070 <free>
        tree = 0;
        return 0;
    ...
    14c9:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
        return -1;
    14d0:	be ff ff ff ff       	mov    $0xffffffff,%esi
    14d5:	eb e6                	jmp    14bd <trnmnt_tree_dealloc+0x2d>
...
struct tree_node* find_leaf(struct tree_node* node, int ID){
    ...
    14ec:	8b 5d 0c             	mov    0xc(%ebp),%ebx
    if(node->right_child == 0 && node->left_child == 0){ 
    14ef:	8b 72 04             	mov    0x4(%edx),%esi
    14f2:	8b 02                	mov    (%edx),%eax
    14f4:	85 f6                	test   %esi,%esi
    14f6:	75 18                	jne    1510 <find_leaf+0x30>
    14f8:	85 c0                	test   %eax,%eax
    14fa:	75 14                	jne    1510 <find_leaf+0x30>
        if(ID == node->index){
    14fc:	39 5a 10             	cmp    %ebx,0x10(%edx)
    14ff:	0f 44 c2             	cmove  %edx,%eax
        if(leaf1)
            return leaf1;
        else
            return leaf2;
    ...
    1513:	53                   	push   %ebx
    1514:	50                   	push   %eax
    1515:	e8 c6 ff ff ff       	call   14e0 <find_leaf>
    151a:	5a                   	pop    %edx
    151b:	59                   	pop    %ecx
    ...
    151e:	89 c7                	mov    %eax,%edi
        struct tree_node* leaf2 = find_leaf(node->right_child, ID);
    1520:	e8 bb ff ff ff       	call   14e0 <find_leaf>
    1525:	83 c4 10             	add    $0x10,%esp
        if(leaf1)
    1528:	85 ff                	test   %edi,%edi
    152a:	0f 45 c7             	cmovne %edi,%eax
} 
    ...
    1533:	5d                   	pop    %ebp
    1534:	c3                   	ret    
    1535:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    1539:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi

00001540 <trnmnt_tree_acquire>:
int trnmnt_tree_acquire(trnmnt_tree* tree,int ID){
    ...
    1544:	56                   	push   %esi
    1545:	53                   	push   %ebx
    1546:	83 ec 14             	sub    $0x14,%esp
    struct tree_node* leaf = find_leaf(tree->root, ID);
    1549:	8b 45 08             	mov    0x8(%ebp),%eax
    154c:	ff 75 0c             	pushl  0xc(%ebp)
    154f:	ff 30                	pushl  (%eax)
    1551:	e8 8a ff ff ff       	call   14e0 <find_leaf>
    1556:	8b 50 08             	mov    0x8(%eax),%edx
    1559:	83 c4 10             	add    $0x10,%esp
    155c:	89 c7                	mov    %eax,%edi
    while(curNode->parent){
    155e:	89 c3                	mov    %eax,%ebx
    1560:	85 d2                	test   %edx,%edx
    1562:	74 32                	je     1596 <trnmnt_tree_acquire+0x56>
        int level = curNode->parent->level;
    1564:	8b 72 14             	mov    0x14(%edx),%esi
        int mutex_lock = kthread_mutex_lock(mutexID);
    1567:	83 ec 0c             	sub    $0xc,%esp
    156a:	ff 72 0c             	pushl  0xc(%edx)
    156d:	e8 70 f8 ff ff       	call   de2 <kthread_mutex_lock>
        leaf->lockPath[level] = curNode->parent->mutex_id;
    1572:	8b 53 08             	mov    0x8(%ebx),%edx
        if(mutex_lock == -1){
    1575:	83 c4 10             	add    $0x10,%esp
    1578:	83 f8 ff             	cmp    $0xffffffff,%eax
        leaf->lockPath[level] = curNode->parent->mutex_id;
    157b:	8b 4a 0c             	mov    0xc(%edx),%ecx
    157e:	8b 57 18             	mov    0x18(%edi),%edx
    1581:	89 0c b2             	mov    %ecx,(%edx,%esi,4)
        if(mutex_lock == -1){
    1584:	74 12                	je     1598 <trnmnt_tree_acquire+0x58>
        if(mutex_lock == 0){
    1586:	85 c0                	test   %eax,%eax
    1588:	8b 53 08             	mov    0x8(%ebx),%edx
    158b:	75 d3                	jne    1560 <trnmnt_tree_acquire+0x20>
    158d:	89 d3                	mov    %edx,%ebx
    158f:	8b 52 08             	mov    0x8(%edx),%edx
    while(curNode->parent){
    1592:	85 d2                	test   %edx,%edx
    1594:	75 ce                	jne    1564 <trnmnt_tree_acquire+0x24>
    return 0;
    1596:	31 c0                	xor    %eax,%eax
}
    1598:	8d 65 f4             	lea    -0xc(%ebp),%esp
    159b:	5b                   	pop    %ebx
    159c:	5e                   	pop    %esi
    159d:	5f                   	pop    %edi
    159e:	5d                   	pop    %ebp
...
int trnmnt_tree_release(trnmnt_tree* tree,int ID){
    ...
    15a4:	56                   	push   %esi
    15a5:	53                   	push   %ebx
    15a6:	83 ec 14             	sub    $0x14,%esp
    struct tree_node* leaf = find_leaf(tree->root, ID);
    15a9:	8b 45 08             	mov    0x8(%ebp),%eax
    15ac:	ff 75 0c             	pushl  0xc(%ebp)
    15af:	ff 30                	pushl  (%eax)
    15b1:	e8 2a ff ff ff       	call   14e0 <find_leaf>
    for(int i = treeDepth-1; i >= 0; i--){
    15b6:	8b 35 14 1f 00 00    	mov    0x1f14,%esi
    struct tree_node* leaf = find_leaf(tree->root, ID);
    15bc:	83 c4 10             	add    $0x10,%esp
    for(int i = treeDepth-1; i >= 0; i--){
    15bf:	83 ee 01             	sub    $0x1,%esi
    15c2:	78 44                	js     1608 <trnmnt_tree_release+0x68>
    15c4:	89 c7                	mov    %eax,%edi
    15c6:	8d 1c b5 00 00 00 00 	lea    0x0(,%esi,4),%ebx
    15cd:	eb 16                	jmp    15e5 <trnmnt_tree_release+0x45>
    15cf:	90                   	nop
        leaf->lockPath[i] = 0;
    15d0:	8b 47 18             	mov    0x18(%edi),%eax
    for(int i = treeDepth-1; i >= 0; i--){
    15d3:	83 ee 01             	sub    $0x1,%esi
        leaf->lockPath[i] = 0;
    15d6:	c7 04 18 00 00 00 00 	movl   $0x0,(%eax,%ebx,1)
    15dd:	83 eb 04             	sub    $0x4,%ebx
    for(int i = treeDepth-1; i >= 0; i--){
    15e0:	83 fe ff             	cmp    $0xffffffff,%esi
    15e3:	74 23                	je     1608 <trnmnt_tree_release+0x68>
        int res = kthread_mutex_unlock(leaf->lockPath[i]);
    15e5:	8b 47 18             	mov    0x18(%edi),%eax
    15e8:	83 ec 0c             	sub    $0xc,%esp
    15eb:	ff 34 18             	pushl  (%eax,%ebx,1)
    15ee:	e8 f7 f7 ff ff       	call   dea <kthread_mutex_unlock>
        if(res == -1){
    15f3:	83 c4 10             	add    $0x10,%esp
    15f6:	83 f8 ff             	cmp    $0xffffffff,%eax
    15f9:	75 d5                	jne    15d0 <trnmnt_tree_release+0x30>
}
    ...
    1608:	8d 65 f4             	lea    -0xc(%ebp),%esp
    return 0;
    160b:	31 c0                	xor    %eax,%eax
}
    160d:	5b                   	pop    %ebx
    160e:	5e                   	pop    %esi
    160f:	5f                   	pop    %edi

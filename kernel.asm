...
80100a27:	e8 a4 2e 00 00       	call   801038d0 <mythread>
...
80101c99:	e8 32 1c 00 00       	call   801038d0 <mythread>
  acquire(&icache.lock);
...
80101ee8:	68 fe 77 10 80       	push   $0x801077fe
...
80102e67:	e8 14 0a 00 00       	call   80103880 <cpuid>
80102e6c:	89 c3                	mov    %eax,%ebx
80102e6e:	e8 0d 0a 00 00       	call   80103880 <cpuid>
...
80102e87:	e8 74 09 00 00       	call   80103800 <mycpu>
...
80102e9a:	e8 61 0d 00 00       	call   80103c00 <scheduler>
80102e9f:	90                   	nop
...
80102f04:	e8 e7 2c 00 00       	call   80105bf0 <uartinit>
  pinit();         // process table
80102f09:	e8 d2 08 00 00       	call   801037e0 <pinit>
  tvinit();        // trap vectors
...
80102f60:	e8 9b 08 00 00       	call   80103800 <mycpu>
...
80102fd5:	e8 26 09 00 00       	call   80103900 <userinit>
...
801034a4:	e8 f7 03 00 00       	call   801038a0 <myproc>
...
80103583:	0f 84 8f 00 00 00    	je     80103618 <piperead+0xf8>
    if(myproc()->killed){
80103589:	e8 12 03 00 00       	call   801038a0 <myproc>
...
801036ac:	0f 83 ae 00 00 00    	jae    80103760 <allocproc+0xe0>
    if(p->state == UNUSED)
...
80103715:	74 65                	je     8010377c <allocproc+0xfc>
  sp -= sizeof *t->tf;
80103717:	8d 90 b4 0f 00 00    	lea    0xfb4(%eax),%edx
  memset(t->context, 0, sizeof *t->context);
8010371d:	83 ec 04             	sub    $0x4,%esp
  sp -= sizeof *t->context;
80103720:	05 9c 0f 00 00       	add    $0xf9c,%eax
  sp -= sizeof *t->tf;
80103725:	89 57 10             	mov    %edx,0x10(%edi)
  *(uint*)sp = (uint)trapret;
80103728:	c7 40 14 32 58 10 80 	movl   $0x80105832,0x14(%eax)
  memset(t->context, 0, sizeof *t->context);
8010372f:	6a 14                	push   $0x14
80103731:	6a 00                	push   $0x0
80103733:	50                   	push   %eax
  t->context = (struct context*)sp;
80103734:	89 47 14             	mov    %eax,0x14(%edi)
  memset(t->context, 0, sizeof *t->context);
80103737:	e8 f4 0e 00 00       	call   80104630 <memset>
  t->context->eip = (uint)forkret;
8010373c:	8b 47 14             	mov    0x14(%edi),%eax
  return p;
8010373f:	83 c4 10             	add    $0x10,%esp
  t->context->eip = (uint)forkret;
80103742:	c7 40 10 90 37 10 80 	movl   $0x80103790,0x10(%eax)
  t->kstack = p->kstack;
80103749:	8b 43 08             	mov    0x8(%ebx),%eax
8010374c:	89 86 40 2d 11 80    	mov    %eax,-0x7feed2c0(%esi)
}
80103752:	8d 65 f4             	lea    -0xc(%ebp),%esp
...
80103763:	31 db                	xor    %ebx,%ebx
  release(&ptable.lock);
80103765:	68 40 2d 11 80       	push   $0x80112d40
8010376a:	e8 71 0e 00 00       	call   801045e0 <release>
  return 0;
...
80103785:	eb cb                	jmp    80103752 <allocproc+0xd2>
...
80103793:	83 ec 14             	sub    $0x14,%esp
  release(&ptable.lock);
80103796:	68 40 2d 11 80       	push   $0x80112d40
8010379b:	e8 40 0e 00 00       	call   801045e0 <release>
  if (first) {
...
801037bf:	e8 dc dc ff ff       	call   801014a0 <iinit>
    initlog(ROOTDEV);
801037c4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
801037cb:	e8 50 f3 ff ff       	call   80102b20 <initlog>
...
801037e6:	68 f5 75 10 80       	push   $0x801075f5
801037eb:	68 40 2d 11 80       	push   $0x80112d40
801037f0:	e8 eb 0b 00 00       	call   801043e0 <initlock>
}
...
8010380a:	75 5e                	jne    8010386a <mycpu+0x6a>
  apicid = lapicid();
8010380c:	e8 3f ef ff ff       	call   80102750 <lapicid>
  for (i = 0; i < ncpu; ++i) {
...
80103826:	b9 34 28 11 80       	mov    $0x80112834,%ecx
  for (i = 0; i < ncpu; ++i) {
...
801038a4:	83 ec 04             	sub    $0x4,%esp
  pushcli();
801038a7:	e8 a4 0b 00 00       	call   80104450 <pushcli>
  c = mycpu();
801038ac:	e8 4f ff ff ff       	call   80103800 <mycpu>
  p = c->proc;
801038b1:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801038b7:	e8 d4 0b 00 00       	call   80104490 <popcli>
}
...
801038d4:	83 ec 04             	sub    $0x4,%esp
  pushcli();
801038d7:	e8 74 0b 00 00       	call   80104450 <pushcli>
  c = mycpu();
801038dc:	e8 1f ff ff ff       	call   80103800 <mycpu>
  t = c->thread;
801038e1:	8b 98 b0 00 00 00    	mov    0xb0(%eax),%ebx
  popcli();
801038e7:	e8 a4 0b 00 00       	call   80104490 <popcli>
}
...
80103904:	53                   	push   %ebx
  p = allocproc();
80103905:	e8 76 fd ff ff       	call   80103680 <allocproc>
8010390a:	89 c6                	mov    %eax,%esi
  initproc = p;
8010390c:	a3 b8 a5 10 80       	mov    %eax,0x8010a5b8
  if((p->pgdir = setupkvm()) == 0)
80103911:	e8 ea 34 00 00       	call   80106e00 <setupkvm>
80103916:	85 c0                	test   %eax,%eax
80103918:	89 46 04             	mov    %eax,0x4(%esi)
8010391b:	0f 84 c9 00 00 00    	je     801039ea <userinit+0xea>
  inituvm(p->pgdir, _binary_initcode_start, (int)_binary_initcode_size);
80103921:	83 ec 04             	sub    $0x4,%esp
80103924:	68 2c 00 00 00       	push   $0x2c
80103929:	68 60 a4 10 80       	push   $0x8010a460
8010392e:	50                   	push   %eax
8010392f:	e8 ac 31 00 00       	call   80106ae0 <inituvm>
  t = p->threads;
80103934:	8b 5e 6c             	mov    0x6c(%esi),%ebx
  memset(t->tf, 0, sizeof(*t->tf));
80103937:	83 c4 0c             	add    $0xc,%esp
  p->sz = PGSIZE;
8010393a:	c7 06 00 10 00 00    	movl   $0x1000,(%esi)
  memset(t->tf, 0, sizeof(*t->tf));
80103940:	6a 4c                	push   $0x4c
80103942:	6a 00                	push   $0x0
80103944:	ff 73 10             	pushl  0x10(%ebx)
80103947:	e8 e4 0c 00 00       	call   80104630 <memset>
  t->tf->cs = (SEG_UCODE << 3) | DPL_USER;
8010394c:	8b 43 10             	mov    0x10(%ebx),%eax
8010394f:	ba 1b 00 00 00       	mov    $0x1b,%edx
  t->tf->ds = (SEG_UDATA << 3) | DPL_USER;
80103954:	b9 23 00 00 00       	mov    $0x23,%ecx
  safestrcpy(p->name, "initcode", sizeof(p->name));
80103959:	83 c4 0c             	add    $0xc,%esp
  t->tf->cs = (SEG_UCODE << 3) | DPL_USER;
8010395c:	66 89 50 3c          	mov    %dx,0x3c(%eax)
  t->tf->ds = (SEG_UDATA << 3) | DPL_USER;
80103960:	8b 43 10             	mov    0x10(%ebx),%eax
80103963:	66 89 48 2c          	mov    %cx,0x2c(%eax)
  t->tf->es = t->tf->ds;
80103967:	8b 43 10             	mov    0x10(%ebx),%eax
8010396a:	0f b7 50 2c          	movzwl 0x2c(%eax),%edx
8010396e:	66 89 50 28          	mov    %dx,0x28(%eax)
  t->tf->ss = t->tf->ds;
80103972:	8b 43 10             	mov    0x10(%ebx),%eax
80103975:	0f b7 50 2c          	movzwl 0x2c(%eax),%edx
80103979:	66 89 50 48          	mov    %dx,0x48(%eax)
  t->tf->eflags = FL_IF;
8010397d:	8b 43 10             	mov    0x10(%ebx),%eax
80103980:	c7 40 40 00 02 00 00 	movl   $0x200,0x40(%eax)
  t->tf->esp = PGSIZE;
80103987:	8b 43 10             	mov    0x10(%ebx),%eax
8010398a:	c7 40 44 00 10 00 00 	movl   $0x1000,0x44(%eax)
  t->tf->eip = 0;  // beginning of initcode.S
80103991:	8b 43 10             	mov    0x10(%ebx),%eax
80103994:	c7 40 38 00 00 00 00 	movl   $0x0,0x38(%eax)
  safestrcpy(p->name, "initcode", sizeof(p->name));
8010399b:	8d 46 5c             	lea    0x5c(%esi),%eax
8010399e:	6a 10                	push   $0x10
801039a0:	68 25 76 10 80       	push   $0x80107625
801039a5:	50                   	push   %eax
801039a6:	e8 65 0e 00 00       	call   80104810 <safestrcpy>
  t->cwd = namei("/");
801039ab:	c7 04 24 2e 76 10 80 	movl   $0x8010762e,(%esp)
801039b2:	e8 49 e5 ff ff       	call   80101f00 <namei>
801039b7:	89 43 20             	mov    %eax,0x20(%ebx)
  acquire(&ptable.lock);
801039ba:	c7 04 24 40 2d 11 80 	movl   $0x80112d40,(%esp)
801039c1:	e8 5a 0b 00 00       	call   80104520 <acquire>
  p->state = USED;
801039c6:	c7 46 0c 02 00 00 00 	movl   $0x2,0xc(%esi)
  t->state = RUNNABLE;
801039cd:	c7 43 04 02 00 00 00 	movl   $0x2,0x4(%ebx)
  release(&ptable.lock);
801039d4:	c7 04 24 40 2d 11 80 	movl   $0x80112d40,(%esp)
801039db:	e8 00 0c 00 00       	call   801045e0 <release>
}
801039e0:	83 c4 10             	add    $0x10,%esp
801039e3:	8d 65 f8             	lea    -0x8(%ebp),%esp
801039e6:	5b                   	pop    %ebx
801039e7:	5e                   	pop    %esi
801039e8:	5d                   	pop    %ebp
801039e9:	c3                   	ret    
...
801039ed:	68 0c 76 10 80       	push   $0x8010760c
...
80103a05:	8b 75 08             	mov    0x8(%ebp),%esi
  pushcli();
80103a08:	e8 43 0a 00 00       	call   80104450 <pushcli>
  c = mycpu();
80103a0d:	e8 ee fd ff ff       	call   80103800 <mycpu>
  p = c->proc;
80103a12:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103a18:	e8 73 0a 00 00       	call   80104490 <popcli>
  acquire(&ptable.lock);
80103a1d:	83 ec 0c             	sub    $0xc,%esp
80103a20:	68 40 2d 11 80       	push   $0x80112d40
80103a25:	e8 f6 0a 00 00       	call   80104520 <acquire>
  if(n > 0){
...
80103a30:	8b 03                	mov    (%ebx),%eax
  if(n > 0){
80103a32:	7f 2c                	jg     80103a60 <growproc+0x60>
  } else if(n < 0){
80103a34:	75 4a                	jne    80103a80 <growproc+0x80>
  switchuvm(curproc);
...
80103a3c:	e8 8f 2f 00 00       	call   801069d0 <switchuvm>
  release(&ptable.lock);
80103a41:	c7 04 24 40 2d 11 80 	movl   $0x80112d40,(%esp)
80103a48:	e8 93 0b 00 00       	call   801045e0 <release>
  return 0;
...
80103a6a:	e8 b1 31 00 00       	call   80106c20 <allocuvm>
80103a6f:	83 c4 10             	add    $0x10,%esp
80103a72:	85 c0                	test   %eax,%eax
80103a74:	75 c0                	jne    80103a36 <growproc+0x36>
      return -1;
80103a76:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80103a7b:	eb d5                	jmp    80103a52 <growproc+0x52>
...
80103a8a:	e8 c1 32 00 00       	call   80106d50 <deallocuvm>
80103a8f:	83 c4 10             	add    $0x10,%esp
80103a92:	85 c0                	test   %eax,%eax
80103a94:	75 a0                	jne    80103a36 <growproc+0x36>
80103a96:	eb de                	jmp    80103a76 <growproc+0x76>
80103a98:	90                   	nop
...
80103aa6:	83 ec 1c             	sub    $0x1c,%esp
  pushcli();
80103aa9:	e8 a2 09 00 00       	call   80104450 <pushcli>
  c = mycpu();
80103aae:	e8 4d fd ff ff       	call   80103800 <mycpu>
  p = c->proc;
80103ab3:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103ab9:	e8 d2 09 00 00       	call   80104490 <popcli>
  pushcli();
80103abe:	e8 8d 09 00 00       	call   80104450 <pushcli>
  c = mycpu();
80103ac3:	e8 38 fd ff ff       	call   80103800 <mycpu>
  t = c->thread;
80103ac8:	8b 80 b0 00 00 00    	mov    0xb0(%eax),%eax
80103ace:	89 45 dc             	mov    %eax,-0x24(%ebp)
  popcli();
80103ad1:	e8 ba 09 00 00       	call   80104490 <popcli>
  if((np = allocproc()) == 0){
80103ad6:	e8 a5 fb ff ff       	call   80103680 <allocproc>
80103adb:	85 c0                	test   %eax,%eax
80103add:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80103ae0:	89 c7                	mov    %eax,%edi
80103ae2:	0f 84 d7 00 00 00    	je     80103bbf <fork+0x11f>
  nt = np->threads;
80103ae8:	8b 48 6c             	mov    0x6c(%eax),%ecx
  if((np->pgdir = copyuvm(curproc->pgdir, curproc->sz)) == 0){
80103aeb:	83 ec 08             	sub    $0x8,%esp
  nt->tproc = np;
80103aee:	89 41 0c             	mov    %eax,0xc(%ecx)
  if((np->pgdir = copyuvm(curproc->pgdir, curproc->sz)) == 0){
80103af1:	ff 33                	pushl  (%ebx)
80103af3:	ff 73 04             	pushl  0x4(%ebx)
  nt = np->threads;
80103af6:	89 4d e0             	mov    %ecx,-0x20(%ebp)
  if((np->pgdir = copyuvm(curproc->pgdir, curproc->sz)) == 0){
80103af9:	e8 d2 33 00 00       	call   80106ed0 <copyuvm>
80103afe:	83 c4 10             	add    $0x10,%esp
80103b01:	85 c0                	test   %eax,%eax
80103b03:	89 47 04             	mov    %eax,0x4(%edi)
80103b06:	0f 84 ba 00 00 00    	je     80103bc6 <fork+0x126>
  np->sz = curproc->sz;
80103b0c:	8b 03                	mov    (%ebx),%eax
80103b0e:	8b 55 e4             	mov    -0x1c(%ebp),%edx
  *nt->tf = *curthread->tf;
80103b11:	b9 13 00 00 00       	mov    $0x13,%ecx
  np->sz = curproc->sz;
80103b16:	89 02                	mov    %eax,(%edx)
  *nt->tf = *curthread->tf;
80103b18:	8b 45 dc             	mov    -0x24(%ebp),%eax
  np->parent = curproc;
80103b1b:	89 5a 14             	mov    %ebx,0x14(%edx)
  *nt->tf = *curthread->tf;
80103b1e:	8b 70 10             	mov    0x10(%eax),%esi
80103b21:	8b 45 e0             	mov    -0x20(%ebp),%eax
80103b24:	8b 78 10             	mov    0x10(%eax),%edi
80103b27:	f3 a5                	rep movsl %ds:(%esi),%es:(%edi)
  for(i = 0; i < NOFILE; i++)
80103b29:	31 f6                	xor    %esi,%esi
80103b2b:	89 d7                	mov    %edx,%edi
  nt->tf->eax = 0;
80103b2d:	8b 40 10             	mov    0x10(%eax),%eax
80103b30:	c7 40 1c 00 00 00 00 	movl   $0x0,0x1c(%eax)
80103b37:	89 f6                	mov    %esi,%esi
80103b39:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
    if(curproc->ofile[i])
80103b40:	8b 44 b3 1c          	mov    0x1c(%ebx,%esi,4),%eax
80103b44:	85 c0                	test   %eax,%eax
80103b46:	74 10                	je     80103b58 <fork+0xb8>
      np->ofile[i] = filedup(curproc->ofile[i]);
80103b48:	83 ec 0c             	sub    $0xc,%esp
80103b4b:	50                   	push   %eax
80103b4c:	e8 af d2 ff ff       	call   80100e00 <filedup>
80103b51:	83 c4 10             	add    $0x10,%esp
80103b54:	89 44 b7 1c          	mov    %eax,0x1c(%edi,%esi,4)
  for(i = 0; i < NOFILE; i++)
80103b58:	83 c6 01             	add    $0x1,%esi
80103b5b:	83 fe 10             	cmp    $0x10,%esi
80103b5e:	75 e0                	jne    80103b40 <fork+0xa0>
  nt->cwd = idup(curthread->cwd);
80103b60:	8b 45 dc             	mov    -0x24(%ebp),%eax
80103b63:	83 ec 0c             	sub    $0xc,%esp
  safestrcpy(np->name, curproc->name, sizeof(curproc->name));
80103b66:	83 c3 5c             	add    $0x5c,%ebx
  nt->cwd = idup(curthread->cwd);
80103b69:	ff 70 20             	pushl  0x20(%eax)
80103b6c:	e8 ff da ff ff       	call   80101670 <idup>
  safestrcpy(np->name, curproc->name, sizeof(curproc->name));
80103b71:	8b 7d e4             	mov    -0x1c(%ebp),%edi
  nt->cwd = idup(curthread->cwd);
80103b74:	8b 75 e0             	mov    -0x20(%ebp),%esi
  safestrcpy(np->name, curproc->name, sizeof(curproc->name));
80103b77:	83 c4 0c             	add    $0xc,%esp
  nt->cwd = idup(curthread->cwd);
80103b7a:	89 46 20             	mov    %eax,0x20(%esi)
  safestrcpy(np->name, curproc->name, sizeof(curproc->name));
80103b7d:	8d 47 5c             	lea    0x5c(%edi),%eax
80103b80:	6a 10                	push   $0x10
80103b82:	53                   	push   %ebx
80103b83:	50                   	push   %eax
80103b84:	e8 87 0c 00 00       	call   80104810 <safestrcpy>
  pid = np->pid;
80103b89:	8b 5f 10             	mov    0x10(%edi),%ebx
  acquire(&ptable.lock);
80103b8c:	c7 04 24 40 2d 11 80 	movl   $0x80112d40,(%esp)
80103b93:	e8 88 09 00 00       	call   80104520 <acquire>
  np->state = USED;
80103b98:	c7 47 0c 02 00 00 00 	movl   $0x2,0xc(%edi)
  nt->state = RUNNABLE;
80103b9f:	c7 46 04 02 00 00 00 	movl   $0x2,0x4(%esi)
  release(&ptable.lock);
80103ba6:	c7 04 24 40 2d 11 80 	movl   $0x80112d40,(%esp)
80103bad:	e8 2e 0a 00 00       	call   801045e0 <release>
  return pid;
80103bb2:	83 c4 10             	add    $0x10,%esp
}
80103bb5:	8d 65 f4             	lea    -0xc(%ebp),%esp
80103bb8:	89 d8                	mov    %ebx,%eax
80103bba:	5b                   	pop    %ebx
80103bbb:	5e                   	pop    %esi
80103bbc:	5f                   	pop    %edi
80103bbd:	5d                   	pop    %ebp
80103bbe:	c3                   	ret    
    return -1;
80103bbf:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
80103bc4:	eb ef                	jmp    80103bb5 <fork+0x115>
    kfree(nt->kstack);
80103bc6:	8b 5d e0             	mov    -0x20(%ebp),%ebx
80103bc9:	83 ec 0c             	sub    $0xc,%esp
80103bcc:	ff 33                	pushl  (%ebx)
80103bce:	e8 5d e7 ff ff       	call   80102330 <kfree>
    np->state = UNUSED;
80103bd3:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
    nt->kstack = 0;
80103bd6:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
    return -1;
80103bdc:	83 c4 10             	add    $0x10,%esp
    np->state = UNUSED;
80103bdf:	c7 41 0c 00 00 00 00 	movl   $0x0,0xc(%ecx)
    nt->state = UNINIT;
80103be6:	c7 43 04 00 00 00 00 	movl   $0x0,0x4(%ebx)
    return -1;
80103bed:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
80103bf2:	eb c1                	jmp    80103bb5 <fork+0x115>
80103bf4:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
80103bfa:	8d bf 00 00 00 00    	lea    0x0(%edi),%edi
...
80103c06:	83 ec 1c             	sub    $0x1c,%esp
  struct cpu *c = mycpu();
80103c09:	e8 f2 fb ff ff       	call   80103800 <mycpu>
  c->proc = 0;
80103c0e:	c7 80 ac 00 00 00 00 	movl   $0x0,0xac(%eax)
80103c15:	00 00 00 
  c->thread = 0;
80103c18:	c7 80 b0 00 00 00 00 	movl   $0x0,0xb0(%eax)
80103c1f:	00 00 00 
  struct cpu *c = mycpu();
80103c22:	89 c7                	mov    %eax,%edi
80103c24:	8d 40 04             	lea    0x4(%eax),%eax
...
80103c2b:	83 ec 0c             	sub    $0xc,%esp
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103c2e:	be 74 2d 11 80       	mov    $0x80112d74,%esi
    acquire(&ptable.lock);
80103c33:	68 40 2d 11 80       	push   $0x80112d40
80103c38:	e8 e3 08 00 00       	call   80104520 <acquire>
80103c3d:	83 c4 10             	add    $0x10,%esp
80103c40:	eb 15                	jmp    80103c57 <scheduler+0x57>
80103c42:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103c48:	83 c6 70             	add    $0x70,%esi
80103c4b:	81 fe 74 49 11 80    	cmp    $0x80114974,%esi
80103c51:	0f 83 90 00 00 00    	jae    80103ce7 <scheduler+0xe7>
      if(p->state != USED){
80103c57:	83 7e 0c 02          	cmpl   $0x2,0xc(%esi)
80103c5b:	75 eb                	jne    80103c48 <scheduler+0x48>
      for(t = p->threads; t < &p->threads[NTHREAD]; t++){
80103c5d:	8b 4e 6c             	mov    0x6c(%esi),%ecx
80103c60:	89 cb                	mov    %ecx,%ebx
80103c62:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
        if(t->state != RUNNABLE){
80103c68:	83 7b 04 02          	cmpl   $0x2,0x4(%ebx)
80103c6c:	75 5d                	jne    80103ccb <scheduler+0xcb>
        if(p != t->tproc)
80103c6e:	39 73 0c             	cmp    %esi,0xc(%ebx)
80103c71:	74 10                	je     80103c83 <scheduler+0x83>
          cprintf("proc not thread\n");
80103c73:	83 ec 0c             	sub    $0xc,%esp
80103c76:	68 30 76 10 80       	push   $0x80107630
80103c7b:	e8 e0 c9 ff ff       	call   80100660 <cprintf>
80103c80:	83 c4 10             	add    $0x10,%esp
        switchuvm(p);
80103c83:	83 ec 0c             	sub    $0xc,%esp
        c->proc = p;
80103c86:	89 b7 ac 00 00 00    	mov    %esi,0xac(%edi)
        c->thread = t;
80103c8c:	89 9f b0 00 00 00    	mov    %ebx,0xb0(%edi)
        switchuvm(p);
80103c92:	56                   	push   %esi
80103c93:	e8 38 2d 00 00       	call   801069d0 <switchuvm>
        t->state = RUNNING;
80103c98:	c7 43 04 03 00 00 00 	movl   $0x3,0x4(%ebx)
        swtch(&(c->scheduler), t->context);
80103c9f:	58                   	pop    %eax
80103ca0:	5a                   	pop    %edx
80103ca1:	ff 73 14             	pushl  0x14(%ebx)
80103ca4:	ff 75 e4             	pushl  -0x1c(%ebp)
80103ca7:	e8 bf 0b 00 00       	call   8010486b <swtch>
        switchkvm();
80103cac:	e8 ff 2c 00 00       	call   801069b0 <switchkvm>
        c->proc = 0;
80103cb1:	c7 87 ac 00 00 00 00 	movl   $0x0,0xac(%edi)
80103cb8:	00 00 00 
        c->thread = 0;
80103cbb:	c7 87 b0 00 00 00 00 	movl   $0x0,0xb0(%edi)
80103cc2:	00 00 00 
80103cc5:	83 c4 10             	add    $0x10,%esp
80103cc8:	8b 4e 6c             	mov    0x6c(%esi),%ecx
      for(t = p->threads; t < &p->threads[NTHREAD]; t++){
80103ccb:	8d 91 40 02 00 00    	lea    0x240(%ecx),%edx
80103cd1:	83 c3 24             	add    $0x24,%ebx
80103cd4:	39 d3                	cmp    %edx,%ebx
80103cd6:	72 90                	jb     80103c68 <scheduler+0x68>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103cd8:	83 c6 70             	add    $0x70,%esi
80103cdb:	81 fe 74 49 11 80    	cmp    $0x80114974,%esi
80103ce1:	0f 82 70 ff ff ff    	jb     80103c57 <scheduler+0x57>
    release(&ptable.lock);
80103ce7:	83 ec 0c             	sub    $0xc,%esp
80103cea:	68 40 2d 11 80       	push   $0x80112d40
80103cef:	e8 ec 08 00 00       	call   801045e0 <release>
    sti();
80103cf4:	83 c4 10             	add    $0x10,%esp
80103cf7:	e9 2e ff ff ff       	jmp    80103c2a <scheduler+0x2a>
...
80103dde:	e8 6d 06 00 00       	call   80104450 <pushcli>
  c = mycpu();
80103de3:	e8 18 fa ff ff       	call   80103800 <mycpu>
  t = c->thread;
...
80103ed8:	68 8e 76 10 80       	push   $0x8010768e
80103edd:	e8 ae c4 ff ff       	call   80100390 <panic>
    panic("init exiting");
80103ee2:	83 ec 0c             	sub    $0xc,%esp
80103ee5:	68 81 76 10 80       	push   $0x80107681
...
80103fe9:	68 a0 76 10 80       	push   $0x801076a0
80103fee:	e8 9d c3 ff ff       	call   80100390 <panic>
    panic("sleep");
80103ff3:	83 ec 0c             	sub    $0xc,%esp
80103ff6:	68 9a 76 10 80       	push   $0x8010769a
...
80104009:	e8 42 04 00 00       	call   80104450 <pushcli>
  c = mycpu();
8010400e:	e8 ed f7 ff ff       	call   80103800 <mycpu>
  p = c->proc;
...
80104068:	0f 84 df 00 00 00    	je     8010414d <wait+0x14d>
8010406e:	8b 46 18             	mov    0x18(%esi),%eax
80104071:	85 c0                	test   %eax,%eax
80104073:	0f 85 d4 00 00 00    	jne    8010414d <wait+0x14d>
...
80104097:	eb 19                	jmp    801040b2 <wait+0xb2>
80104099:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
801040a0:	8d 82 40 02 00 00    	lea    0x240(%edx),%eax
801040a6:	83 c6 24             	add    $0x24,%esi
            hasNonTerminated = 1;
801040a9:	bf 01 00 00 00       	mov    $0x1,%edi
        for(t = p->threads; t < &p->threads[NTHREAD]; t++){
801040ae:	39 c6                	cmp    %eax,%esi
801040b0:	73 3c                	jae    801040ee <wait+0xee>
          if(t->state == TERMINATED){
801040b2:	83 7e 04 05          	cmpl   $0x5,0x4(%esi)
801040b6:	75 e8                	jne    801040a0 <wait+0xa0>
            if(t->kstack)
801040b8:	8b 06                	mov    (%esi),%eax
801040ba:	85 c0                	test   %eax,%eax
801040bc:	74 0c                	je     801040ca <wait+0xca>
              kfree(t->kstack);
801040be:	83 ec 0c             	sub    $0xc,%esp
801040c1:	50                   	push   %eax
801040c2:	e8 69 e2 ff ff       	call   80102330 <kfree>
801040c7:	83 c4 10             	add    $0x10,%esp
            t->kstack = 0;
801040ca:	c7 06 00 00 00 00    	movl   $0x0,(%esi)
            t->tid = 0;
801040d0:	c7 46 08 00 00 00 00 	movl   $0x0,0x8(%esi)
        for(t = p->threads; t < &p->threads[NTHREAD]; t++){
801040d7:	83 c6 24             	add    $0x24,%esi
            t->tproc = 0;
801040da:	c7 46 e8 00 00 00 00 	movl   $0x0,-0x18(%esi)
801040e1:	8b 53 6c             	mov    0x6c(%ebx),%edx
        for(t = p->threads; t < &p->threads[NTHREAD]; t++){
801040e4:	8d 82 40 02 00 00    	lea    0x240(%edx),%eax
801040ea:	39 c6                	cmp    %eax,%esi
801040ec:	72 c4                	jb     801040b2 <wait+0xb2>
  int havekids, pid = 0;
801040ee:	31 f6                	xor    %esi,%esi
        if(!hasNonTerminated){
801040f0:	85 ff                	test   %edi,%edi
801040f2:	75 3f                	jne    80104133 <wait+0x133>
          freevm(p->pgdir);
801040f4:	83 ec 0c             	sub    $0xc,%esp
801040f7:	ff 73 04             	pushl  0x4(%ebx)
          pid = p->pid;
801040fa:	8b 73 10             	mov    0x10(%ebx),%esi
          p->kstack = 0;
801040fd:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
          freevm(p->pgdir);
80104104:	e8 77 2c 00 00       	call   80106d80 <freevm>
          p->pid = 0;
80104109:	c7 43 10 00 00 00 00 	movl   $0x0,0x10(%ebx)
          p->parent = 0;
80104110:	c7 43 14 00 00 00 00 	movl   $0x0,0x14(%ebx)
          p->threads = 0;
80104117:	83 c4 10             	add    $0x10,%esp
          p->name[0] = 0;
8010411a:	c6 43 5c 00          	movb   $0x0,0x5c(%ebx)
          p->killed = 0;
8010411e:	c7 43 18 00 00 00 00 	movl   $0x0,0x18(%ebx)
          p->state = UNUSED;
80104125:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
          p->threads = 0;
8010412c:	c7 43 6c 00 00 00 00 	movl   $0x0,0x6c(%ebx)
        release(&ptable.lock);
80104133:	83 ec 0c             	sub    $0xc,%esp
80104136:	68 40 2d 11 80       	push   $0x80112d40
8010413b:	e8 a0 04 00 00       	call   801045e0 <release>
        return pid;
80104140:	83 c4 10             	add    $0x10,%esp
}
80104143:	8d 65 f4             	lea    -0xc(%ebp),%esp
80104146:	89 f0                	mov    %esi,%eax
80104148:	5b                   	pop    %ebx
80104149:	5e                   	pop    %esi
8010414a:	5f                   	pop    %edi
8010414b:	5d                   	pop    %ebp
...
80104150:	be ff ff ff ff       	mov    $0xffffffff,%esi
      release(&ptable.lock);
80104155:	68 40 2d 11 80       	push   $0x80112d40
8010415a:	e8 81 04 00 00       	call   801045e0 <release>
      return -1;
8010415f:	83 c4 10             	add    $0x10,%esp
80104162:	eb df                	jmp    80104143 <wait+0x143>
...
8010422f:	83 f8 03             	cmp    $0x3,%eax
      ...
      state = "???";
80104232:	ba b1 76 10 80       	mov    $0x801076b1,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80104237:	77 11                	ja     8010424a <procdump+0x3a>
80104239:	8b 14 85 04 77 10 80 	mov    -0x7fef88fc(,%eax,4),%edx
      state = "???";
80104240:	b8 b1 76 10 80       	mov    $0x801076b1,%eax
...
80104255:	68 b5 76 10 80       	push   $0x801076b5
...
80104294:	68 17 7a 10 80       	push   $0x80107a17
...
80104323:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
80104329:	e8 72 f5 ff ff       	call   801038a0 <myproc>
...
801043b3:	e8 e8 f4 ff ff       	call   801038a0 <myproc>
...
8010446f:	e8 8c f3 ff ff       	call   80103800 <mycpu>
80104474:	89 98 a8 00 00 00    	mov    %ebx,0xa8(%eax)
  mycpu()->ncli += 1;
8010447a:	e8 81 f3 ff ff       	call   80103800 <mycpu>
...
801044bc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  if(mycpu()->ncli == 0 && mycpu()->intena)
801044c0:	e8 3b f3 ff ff       	call   80103800 <mycpu>
...
801044d5:	68 1f 77 10 80       	push   $0x8010771f
801044da:	e8 b1 be ff ff       	call   80100390 <panic>
    panic("popcli");
801044df:	83 ec 0c             	sub    $0xc,%esp
801044e2:	68 36 77 10 80       	push   $0x80107736
...
80104508:	e8 f3 f2 ff ff       	call   80103800 <mycpu>
...
801045c7:	68 3d 77 10 80       	push   $0x8010773d
...
8010461c:	68 45 77 10 80       	push   $0x80107745
...
80104887:	8b 5d 08             	mov    0x8(%ebp),%ebx
  struct proc *curproc = myproc();
8010488a:	e8 11 f0 ff ff       	call   801038a0 <myproc>
...
80104935:	e8 96 ef ff ff       	call   801038d0 <mythread>
...
80104943:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80104946:	e8 55 ef ff ff       	call   801038a0 <myproc>
  if(addr >= curproc->sz || addr+4 > curproc->sz)
...
80104988:	8b 5d 10             	mov    0x10(%ebp),%ebx
  int i;
  struct proc *curproc = myproc();
8010498b:	e8 10 ef ff ff       	call   801038a0 <myproc>
...
80104a24:	53                   	push   %ebx
  int num;
  struct proc *curproc = myproc();
80104a25:	e8 76 ee ff ff       	call   801038a0 <myproc>
80104a2a:	89 c6                	mov    %eax,%esi
  struct kthread *curthread = mythread();
80104a2c:	e8 9f ee ff ff       	call   801038d0 <mythread>
...
80104a41:	8b 14 85 80 77 10 80 	mov    -0x7fef8880(,%eax,4),%edx
...
80104a68:	68 4d 77 10 80       	push   $0x8010774d
...
80104bc4:	68 f4 77 10 80       	push   $0x801077f4
...
80104bdc:	68 f3 77 10 80       	push   $0x801077f3
...
80104bf5:	68 e7 77 10 80       	push   $0x801077e7
...
80104c0a:	68 f6 77 10 80       	push   $0x801077f6
80104c0f:	e8 7c b7 ff ff       	call   80100390 <panic>
    panic("create: ialloc");
80104c14:	83 ec 0c             	sub    $0xc,%esp
80104c17:	68 d8 77 10 80       	push   $0x801077d8
...
80104c54:	e8 47 ec ff ff       	call   801038a0 <myproc>
...
80104c99:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
80104c9b:	e8 00 ec ff ff       	call   801038a0 <myproc>
...
80104de3:	78 2b                	js     80104e10 <sys_close+0x40>
  myproc()->ofile[fd] = 0;
80104de5:	e8 b6 ea ff ff       	call   801038a0 <myproc>
...
80105009:	58                   	pop    %eax
8010500a:	5a                   	pop    %edx
8010500b:	68 f4 77 10 80       	push   $0x801077f4
...
80105024:	68 f3 77 10 80       	push   $0x801077f3
...
8010521f:	0f 84 a6 00 00 00    	je     801052cb <sys_open+0x12b>
  struct proc *curproc = myproc();
80105225:	e8 76 e6 ff ff       	call   801038a0 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
801053f5:	83 ec 10             	sub    $0x10,%esp
  ...
  //struct proc *curproc = myproc();
  struct kthread *curthread = mythread();
801053f8:	e8 d3 e4 ff ff       	call   801038d0 <mythread>
...
801055cf:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
801055d1:	e8 ca e2 ff ff       	call   801038a0 <myproc>
...
801055f7:	8b 7d e4             	mov    -0x1c(%ebp),%edi
  struct proc *curproc = myproc();
801055fa:	e8 a1 e2 ff ff       	call   801038a0 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
80105631:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
      myproc()->ofile[fd0] = 0;
80105638:	e8 63 e2 ff ff       	call   801038a0 <myproc>
...
80105673:	5d                   	pop    %ebp
  return fork();
80105674:	e9 27 e4 ff ff       	jmp    80103aa0 <fork>
...
801056e3:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
801056e6:	e8 b5 e1 ff ff       	call   801038a0 <myproc>
...
80105707:	78 27                	js     80105730 <sys_sbrk+0x40>
    return -1;
  addr = myproc()->sz;
80105709:	e8 92 e1 ff ff       	call   801038a0 <myproc>
  if(growproc(n) < 0)
...
80105716:	e8 e5 e2 ff ff       	call   80103a00 <growproc>
...
8010579f:	73 2f                	jae    801057d0 <sys_sleep+0x90>
    if(myproc()->killed){
801057a1:	e8 fa e0 ff ff       	call   801038a0 <myproc>
...
8010588e:	00 00 ef 
  initlock(&tickslock, "time");
80105891:	68 39 78 10 80       	push   $0x80107839
...
80105910:	ff 24 85 e0 78 10 80 	jmp    *-0x7fef8720(,%eax,4)
...
80105920:	e8 7b df ff ff       	call   801038a0 <myproc>
...
80105940:	e8 3b df ff ff       	call   80103880 <cpuid>
...
80105951:	e8 4a df ff ff       	call   801038a0 <myproc>
80105956:	89 45 e0             	mov    %eax,-0x20(%ebp)
80105959:	e8 42 df ff ff       	call   801038a0 <myproc>
    cprintf("pid %d %s: trap %d err %d on cpu %d "
...
80105975:	68 9c 78 10 80       	push   $0x8010789c
8010597a:	e8 e1 ac ff ff       	call   80100660 <cprintf>
            tf->err, cpuid(), tf->eip, rcr2());
    myproc()->killed = 1;
8010597f:	83 c4 20             	add    $0x20,%esp
80105982:	e8 19 df ff ff       	call   801038a0 <myproc>
...
80105997:	e8 04 df ff ff       	call   801038a0 <myproc>
...
801059b4:	e8 17 df ff ff       	call   801038d0 <mythread>
801059b9:	85 c0                	test   %eax,%eax
801059bb:	74 0b                	je     801059c8 <trap+0xd8>
801059bd:	e8 0e df ff ff       	call   801038d0 <mythread>
...
801059c6:	74 68                	je     80105a30 <trap+0x140>
  ...
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
801059c8:	e8 d3 de ff ff       	call   801038a0 <myproc>
801059cd:	85 c0                	test   %eax,%eax
801059cf:	74 19                	je     801059ea <trap+0xfa>
801059d1:	e8 ca de ff ff       	call   801038a0 <myproc>
...
80105a3d:	8d 76 00             	lea    0x0(%esi),%esi
    if(cpuid() == 0){
80105a40:	e8 3b de ff ff       	call   80103880 <cpuid>
...
80105a6d:	e8 fe cc ff ff       	call   80102770 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105a72:	e8 29 de ff ff       	call   801038a0 <myproc>
...
80105a8d:	e8 de cc ff ff       	call   80102770 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105a92:	e8 09 de ff ff       	call   801038a0 <myproc>
...
80105aaf:	e8 cc dd ff ff       	call   80103880 <cpuid>
80105ab4:	56                   	push   %esi
80105ab5:	53                   	push   %ebx
80105ab6:	50                   	push   %eax
80105ab7:	68 44 78 10 80       	push   $0x80107844
...
80105b44:	0f 20 d6             	mov    %cr2,%esi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80105b47:	e8 34 dd ff ff       	call   80103880 <cpuid>
...
80105b55:	68 68 78 10 80       	push   $0x80107868
80105b5a:	e8 01 ab ff ff       	call   80100660 <cprintf>
      panic("trap");
80105b5f:	83 c4 14             	add    $0x14,%esp
80105b62:	68 3e 78 10 80       	push   $0x8010783e
...
80105c5c:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
80105c5f:	bb 60 79 10 80       	mov    $0x80107960,%ebx
  ioapicenable(IRQ_COM1, 0);
...
8010686d:	68 68 79 10 80       	push   $0x80107968
...
80106923:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
80106926:	e8 55 cf ff ff       	call   80103880 <cpuid>
...
801069ff:	e8 fc cd ff ff       	call   80103800 <mycpu>
80106a04:	89 c6                	mov    %eax,%esi
80106a06:	e8 f5 cd ff ff       	call   80103800 <mycpu>
80106a0b:	89 c7                	mov    %eax,%edi
80106a0d:	e8 ee cd ff ff       	call   80103800 <mycpu>
80106a12:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106a15:	83 c7 08             	add    $0x8,%edi
80106a18:	e8 e3 cd ff ff       	call   80103800 <mycpu>
...
80106b49:	68 ad 79 10 80       	push   $0x801079ad
...
80106cad:	68 e5 79 10 80       	push   $0x801079e5
...
80106ce3:	68 fd 79 10 80       	push   $0x801079fd
...
80106dec:	68 19 7a 10 80       	push   $0x80107a19
...
80106ebf:	68 2a 7a 10 80       	push   $0x80107a2a
...
80106fa9:	68 4e 7a 10 80       	push   $0x80107a4e

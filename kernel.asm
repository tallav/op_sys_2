...
80101ed8:	68 de 76 10 80       	push   $0x801076de
...
80102332:	81 fb c8 d4 11 80    	cmp    $0x8011d4c8,%ebx
...
80102ec7:	68 c8 d4 11 80       	push   $0x8011d4c8
...
8010362c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103630:	81 c3 7c 02 00 00    	add    $0x27c,%ebx
80103636:	81 fb 74 cc 11 80    	cmp    $0x8011cc74,%ebx
...
8010365f:	89 15 04 a0 10 80    	mov    %edx,0x8010a004
  release(&ptable.lock);
80103665:	e8 66 0e 00 00       	call   801044d0 <release>
...
80103687:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
8010368a:	c7 40 14 12 57 10 80 	movl   $0x80105712,0x14(%eax)
  p->context = (struct context*)sp;
...
80103699:	e8 82 0e 00 00       	call   80104520 <memset>
...
801036c2:	e8 09 0e 00 00       	call   801044d0 <release>
}
...
801036eb:	e8 e0 0d 00 00       	call   801044d0 <release>
...
80103740:	e8 8b 0b 00 00       	call   801042d0 <initlock>
}
...
80103776:	b9 34 28 11 80       	mov    $0x80112834,%ecx
  for (i = 0; i < ncpu; ++i) {
...
8010378a:	81 c1 b4 00 00 00    	add    $0xb4,%ecx
80103790:	39 c3                	cmp    %eax,%ebx
80103792:	75 ec                	jne    80103780 <mycpu+0x30>
80103794:	69 c2 b4 00 00 00    	imul   $0xb4,%edx,%eax
...
801037e0:	c9                   	leave  
  return mycpu()-cpus;
801037e1:	c1 f8 02             	sar    $0x2,%eax
801037e4:	69 c0 a5 4f fa a4    	imul   $0xa4fa4fa5,%eax,%eax
}
801037ea:	c3                   	ret    
801037eb:	90                   	nop
...
801037f4:	83 ec 04             	sub    $0x4,%esp
  pushcli();
801037f7:	e8 44 0b 00 00       	call   80104340 <pushcli>
  c = mycpu();
801037fc:	e8 4f ff ff ff       	call   80103750 <mycpu>
  p = c->proc;
80103801:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103807:	e8 74 0b 00 00       	call   80104380 <popcli>
}
...
80103824:	83 ec 04             	sub    $0x4,%esp
  pushcli();
80103827:	e8 14 0b 00 00       	call   80104340 <pushcli>
  c = mycpu();
8010382c:	e8 1f ff ff ff       	call   80103750 <mycpu>
  t = c->thread;
80103831:	8b 98 b0 00 00 00    	mov    0xb0(%eax),%ebx
  popcli();
80103837:	e8 44 0b 00 00       	call   80104380 <popcli>
}
...
80103863:	e8 78 34 00 00       	call   80106ce0 <setupkvm>
...
80103881:	e8 3a 31 00 00       	call   801069c0 <inituvm>
...
80103896:	e8 85 0c 00 00       	call   80104520 <memset>
...
801038ef:	68 05 75 10 80       	push   $0x80107505
801038f4:	50                   	push   %eax
801038f5:	e8 06 0e 00 00       	call   80104700 <safestrcpy>
  p->cwd = namei("/");
801038fa:	c7 04 24 0e 75 10 80 	movl   $0x8010750e,(%esp)
80103901:	e8 ea e5 ff ff       	call   80101ef0 <namei>
80103906:	89 43 68             	mov    %eax,0x68(%ebx)
  acquire(&ptable.lock);
80103909:	c7 04 24 40 2d 11 80 	movl   $0x80112d40,(%esp)
80103910:	e8 fb 0a 00 00       	call   80104410 <acquire>
  p->state = RUNNABLE;
80103915:	c7 43 0c 03 00 00 00 	movl   $0x3,0xc(%ebx)
  release(&ptable.lock);
8010391c:	c7 04 24 40 2d 11 80 	movl   $0x80112d40,(%esp)
80103923:	e8 a8 0b 00 00       	call   801044d0 <release>
}
...
80103933:	68 ec 74 10 80       	push   $0x801074ec
...
80103945:	8b 75 08             	mov    0x8(%ebp),%esi
  pushcli();
80103948:	e8 f3 09 00 00       	call   80104340 <pushcli>
  c = mycpu();
8010394d:	e8 fe fd ff ff       	call   80103750 <mycpu>
  p = c->proc;
80103952:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103958:	e8 23 0a 00 00       	call   80104380 <popcli>
  if(n > 0){
...
8010396c:	e8 3f 2f 00 00       	call   801068b0 <switchuvm>
  return 0;
...
8010398a:	e8 71 31 00 00       	call   80106b00 <allocuvm>
...
801039aa:	e8 81 32 00 00       	call   80106c30 <deallocuvm>
...
801039c6:	83 ec 1c             	sub    $0x1c,%esp
  pushcli();
801039c9:	e8 72 09 00 00       	call   80104340 <pushcli>
  c = mycpu();
801039ce:	e8 7d fd ff ff       	call   80103750 <mycpu>
  p = c->proc;
801039d3:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801039d9:	e8 a2 09 00 00       	call   80104380 <popcli>
  if((np = allocproc()) == 0){
...
801039f8:	e8 b3 33 00 00       	call   80106db0 <copyuvm>
...
80103a71:	e8 8a 0c 00 00       	call   80104700 <safestrcpy>
  pid = np->pid;
80103a76:	8b 5f 10             	mov    0x10(%edi),%ebx
  acquire(&ptable.lock);
80103a79:	c7 04 24 40 2d 11 80 	movl   $0x80112d40,(%esp)
80103a80:	e8 8b 09 00 00       	call   80104410 <acquire>
  np->state = RUNNABLE;
80103a85:	c7 47 0c 03 00 00 00 	movl   $0x3,0xc(%edi)
  release(&ptable.lock);
80103a8c:	c7 04 24 40 2d 11 80 	movl   $0x80112d40,(%esp)
80103a93:	e8 38 0a 00 00       	call   801044d0 <release>
  return pid;
...
80103ae6:	83 ec 1c             	sub    $0x1c,%esp
  struct cpu *c = mycpu();
80103ae9:	e8 62 fc ff ff       	call   80103750 <mycpu>
  c->thread = 0;
80103aee:	c7 80 b0 00 00 00 00 	movl   $0x0,0xb0(%eax)
80103af5:	00 00 00 
  struct cpu *c = mycpu();
80103af8:	89 45 e0             	mov    %eax,-0x20(%ebp)
80103afb:	83 c0 04             	add    $0x4,%eax
80103afe:	89 45 d8             	mov    %eax,-0x28(%ebp)
...
80103b0c:	bf 74 2d 11 80       	mov    $0x80112d74,%edi
    acquire(&ptable.lock);
80103b11:	68 40 2d 11 80       	push   $0x80112d40
80103b16:	e8 f5 08 00 00       	call   80104410 <acquire>
80103b1b:	83 c4 10             	add    $0x10,%esp
80103b1e:	eb 0f                	jmp    80103b2f <scheduler+0x4f>
80103b20:	8b 7d e4             	mov    -0x1c(%ebp),%edi
    for(p = ptable.proc; !foundThread && p < &ptable.proc[NPROC]; p++){
80103b23:	81 ff 74 cc 11 80    	cmp    $0x8011cc74,%edi
80103b29:	0f 83 ab 00 00 00    	jae    80103bda <scheduler+0xfa>
      if(p->state != RUNNABLE)
80103b2f:	83 7f 0c 03          	cmpl   $0x3,0xc(%edi)
80103b33:	8d 87 7c 02 00 00    	lea    0x27c(%edi),%eax
80103b39:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80103b3c:	75 e2                	jne    80103b20 <scheduler+0x40>
        for(int i = 0; !foundThread && i < NTHREADS; i++){
80103b3e:	31 db                	xor    %ebx,%ebx
80103b40:	8d 87 80 00 00 00    	lea    0x80(%edi),%eax
80103b46:	89 7d dc             	mov    %edi,-0x24(%ebp)
80103b49:	89 df                	mov    %ebx,%edi
80103b4b:	eb 05                	jmp    80103b52 <scheduler+0x72>
80103b4d:	8d 76 00             	lea    0x0(%esi),%esi
80103b50:	89 d7                	mov    %edx,%edi
          if(t->state == RUNNABLE)
80103b52:	8b 30                	mov    (%eax),%esi
        for(int i = 0; !foundThread && i < NTHREADS; i++){
80103b54:	8d 57 01             	lea    0x1(%edi),%edx
80103b57:	83 fa 0f             	cmp    $0xf,%edx
80103b5a:	0f 9e c3             	setle  %bl
80103b5d:	83 fe 03             	cmp    $0x3,%esi
80103b60:	0f 95 c1             	setne  %cl
80103b63:	83 c0 20             	add    $0x20,%eax
80103b66:	84 cb                	test   %cl,%bl
80103b68:	75 e6                	jne    80103b50 <scheduler+0x70>
80103b6a:	89 fb                	mov    %edi,%ebx
80103b6c:	8b 7d dc             	mov    -0x24(%ebp),%edi
          t = &(p->threads[i]);
80103b6f:	8b 4d e0             	mov    -0x20(%ebp),%ecx
80103b72:	89 da                	mov    %ebx,%edx
      switchuvm(p);
80103b74:	83 ec 0c             	sub    $0xc,%esp
      swtch(&(c->scheduler), t->context);
80103b77:	83 c3 04             	add    $0x4,%ebx
          t = &(p->threads[i]);
80103b7a:	c1 e2 05             	shl    $0x5,%edx
      swtch(&(c->scheduler), t->context);
80103b7d:	c1 e3 05             	shl    $0x5,%ebx
          t = &(p->threads[i]);
80103b80:	8d 44 17 7c          	lea    0x7c(%edi,%edx,1),%eax
80103b84:	89 55 dc             	mov    %edx,-0x24(%ebp)
80103b87:	89 81 b0 00 00 00    	mov    %eax,0xb0(%ecx)
      switchuvm(p);
80103b8d:	57                   	push   %edi
80103b8e:	e8 1d 2d 00 00       	call   801068b0 <switchuvm>
      p->state = RUNNING;
80103b93:	8b 45 e4             	mov    -0x1c(%ebp),%eax
      t->state = RUNNING;
80103b96:	8b 55 dc             	mov    -0x24(%ebp),%edx
      p->state = RUNNING;
80103b99:	c7 80 90 fd ff ff 04 	movl   $0x4,-0x270(%eax)
80103ba0:	00 00 00 
      t->state = RUNNING;
80103ba3:	c7 84 17 80 00 00 00 	movl   $0x4,0x80(%edi,%edx,1)
80103baa:	04 00 00 00 
      swtch(&(c->scheduler), t->context);
80103bae:	58                   	pop    %eax
80103baf:	5a                   	pop    %edx
80103bb0:	ff 74 1f 10          	pushl  0x10(%edi,%ebx,1)
80103bb4:	ff 75 d8             	pushl  -0x28(%ebp)
80103bb7:	e8 9f 0b 00 00       	call   8010475b <swtch>
      switchkvm();
80103bbc:	e8 cf 2c 00 00       	call   80106890 <switchkvm>
      c->thread = 0;
80103bc1:	8b 4d e0             	mov    -0x20(%ebp),%ecx
    for(p = ptable.proc; !foundThread && p < &ptable.proc[NPROC]; p++){
80103bc4:	83 c4 10             	add    $0x10,%esp
80103bc7:	83 fe 03             	cmp    $0x3,%esi
      c->thread = 0;
80103bca:	c7 81 b0 00 00 00 00 	movl   $0x0,0xb0(%ecx)
80103bd1:	00 00 00 
    for(p = ptable.proc; !foundThread && p < &ptable.proc[NPROC]; p++){
80103bd4:	0f 85 46 ff ff ff    	jne    80103b20 <scheduler+0x40>
    release(&ptable.lock);
80103bda:	83 ec 0c             	sub    $0xc,%esp
80103bdd:	68 40 2d 11 80       	push   $0x80112d40
80103be2:	e8 e9 08 00 00       	call   801044d0 <release>
  for(;;){
80103be7:	83 c4 10             	add    $0x10,%esp
80103bea:	e9 19 ff ff ff       	jmp    80103b08 <scheduler+0x28>
80103bef:	90                   	nop
...
80103bf4:	53                   	push   %ebx
  pushcli();
80103bf5:	e8 46 07 00 00       	call   80104340 <pushcli>
  c = mycpu();
80103bfa:	e8 51 fb ff ff       	call   80103750 <mycpu>
  p = c->proc;
80103bff:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103c05:	e8 76 07 00 00       	call   80104380 <popcli>
  if(!holding(&ptable.lock))
80103c0a:	83 ec 0c             	sub    $0xc,%esp
80103c0d:	68 40 2d 11 80       	push   $0x80112d40
80103c12:	e8 c9 07 00 00       	call   801043e0 <holding>
...
80103c37:	75 41                	jne    80103c7a <sched+0x8a>
  intena = mycpu()->intena;
80103c39:	e8 12 fb ff ff       	call   80103750 <mycpu>
  swtch(&p->context, mycpu()->scheduler);
80103c3e:	83 c3 1c             	add    $0x1c,%ebx
  intena = mycpu()->intena;
80103c41:	8b b0 a8 00 00 00    	mov    0xa8(%eax),%esi
  swtch(&p->context, mycpu()->scheduler);
80103c47:	e8 04 fb ff ff       	call   80103750 <mycpu>
...
80103c53:	e8 03 0b 00 00       	call   8010475b <swtch>
  mycpu()->intena = intena;
80103c58:	e8 f3 fa ff ff       	call   80103750 <mycpu>
}
...
80103cb6:	83 ec 0c             	sub    $0xc,%esp
  pushcli();
80103cb9:	e8 82 06 00 00       	call   80104340 <pushcli>
  c = mycpu();
80103cbe:	e8 8d fa ff ff       	call   80103750 <mycpu>
  p = c->proc;
80103cc3:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80103cc9:	e8 b2 06 00 00       	call   80104380 <popcli>
  if(curproc == initproc)
...
80103d14:	c7 46 68 00 00 00 00 	movl   $0x0,0x68(%esi)
  acquire(&ptable.lock);
80103d1b:	c7 04 24 40 2d 11 80 	movl   $0x80112d40,(%esp)
80103d22:	e8 e9 06 00 00       	call   80104410 <acquire>
...
wakeup1(void *chan)
{
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103d2d:	b8 74 2d 11 80       	mov    $0x80112d74,%eax
80103d32:	eb 10                	jmp    80103d44 <exit+0x94>
80103d34:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80103d38:	05 7c 02 00 00       	add    $0x27c,%eax
80103d3d:	3d 74 cc 11 80       	cmp    $0x8011cc74,%eax
...
80103d4f:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103d56:	05 7c 02 00 00       	add    $0x27c,%eax
80103d5b:	3d 74 cc 11 80       	cmp    $0x8011cc74,%eax
80103d60:	72 e2                	jb     80103d44 <exit+0x94>
      p->parent = initproc;
80103d62:	8b 0d b8 a5 10 80    	mov    0x8010a5b8,%ecx
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103d68:	ba 74 2d 11 80       	mov    $0x80112d74,%edx
80103d6d:	eb 0f                	jmp    80103d7e <exit+0xce>
80103d6f:	90                   	nop
80103d70:	81 c2 7c 02 00 00    	add    $0x27c,%edx
80103d76:	81 fa 74 cc 11 80    	cmp    $0x8011cc74,%edx
...
80103d8a:	75 e4                	jne    80103d70 <exit+0xc0>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103d8c:	b8 74 2d 11 80       	mov    $0x80112d74,%eax
80103d91:	eb 11                	jmp    80103da4 <exit+0xf4>
80103d93:	90                   	nop
80103d94:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80103d98:	05 7c 02 00 00       	add    $0x27c,%eax
80103d9d:	3d 74 cc 11 80       	cmp    $0x8011cc74,%eax
...
80103dc7:	68 5d 75 10 80       	push   $0x8010755d
80103dcc:	e8 bf c5 ff ff       	call   80100390 <panic>
    panic("init exiting");
80103dd1:	83 ec 0c             	sub    $0xc,%esp
80103dd4:	68 50 75 10 80       	push   $0x80107550
...
80103de7:	68 40 2d 11 80       	push   $0x80112d40
80103dec:	e8 1f 06 00 00       	call   80104410 <acquire>
  pushcli();
80103df1:	e8 4a 05 00 00       	call   80104340 <pushcli>
  c = mycpu();
80103df6:	e8 55 f9 ff ff       	call   80103750 <mycpu>
  p = c->proc;
80103dfb:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103e01:	e8 7a 05 00 00       	call   80104380 <popcli>
  myproc()->state = RUNNABLE;
80103e06:	c7 43 0c 03 00 00 00 	movl   $0x3,0xc(%ebx)
  sched();
80103e0d:	e8 de fd ff ff       	call   80103bf0 <sched>
  release(&ptable.lock);
80103e12:	c7 04 24 40 2d 11 80 	movl   $0x80112d40,(%esp)
80103e19:	e8 b2 06 00 00       	call   801044d0 <release>
}
...
80103e3c:	8b 75 0c             	mov    0xc(%ebp),%esi
  pushcli();
80103e3f:	e8 fc 04 00 00       	call   80104340 <pushcli>
  c = mycpu();
80103e44:	e8 07 f9 ff ff       	call   80103750 <mycpu>
  p = c->proc;
80103e49:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103e4f:	e8 2c 05 00 00       	call   80104380 <popcli>
  if(p == 0)
...
80103e9a:	e8 31 06 00 00       	call   801044d0 <release>
    acquire(lk);
...
80103eab:	5d                   	pop    %ebp
    acquire(lk);
80103eac:	e9 5f 05 00 00       	jmp    80104410 <acquire>
...
80103ed9:	68 6f 75 10 80       	push   $0x8010756f
80103ede:	e8 ad c4 ff ff       	call   80100390 <panic>
    panic("sleep");
80103ee3:	83 ec 0c             	sub    $0xc,%esp
80103ee6:	68 69 75 10 80       	push   $0x80107569
...
80103ef4:	53                   	push   %ebx
  pushcli();
80103ef5:	e8 46 04 00 00       	call   80104340 <pushcli>
  c = mycpu();
80103efa:	e8 51 f8 ff ff       	call   80103750 <mycpu>
  p = c->proc;
80103eff:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80103f05:	e8 76 04 00 00       	call   80104380 <popcli>
  acquire(&ptable.lock);
80103f0a:	83 ec 0c             	sub    $0xc,%esp
80103f0d:	68 40 2d 11 80       	push   $0x80112d40
80103f12:	e8 f9 04 00 00       	call   80104410 <acquire>
80103f17:	83 c4 10             	add    $0x10,%esp
    havekids = 0;
80103f1a:	31 c0                	xor    %eax,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103f1c:	bb 74 2d 11 80       	mov    $0x80112d74,%ebx
80103f21:	eb 13                	jmp    80103f36 <wait+0x46>
80103f23:	90                   	nop
80103f24:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80103f28:	81 c3 7c 02 00 00    	add    $0x27c,%ebx
80103f2e:	81 fb 74 cc 11 80    	cmp    $0x8011cc74,%ebx
...
80103f3f:	74 37                	je     80103f78 <wait+0x88>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103f41:	81 c3 7c 02 00 00    	add    $0x27c,%ebx
      havekids = 1;
80103f47:	b8 01 00 00 00       	mov    $0x1,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103f4c:	81 fb 74 cc 11 80    	cmp    $0x8011cc74,%ebx
...
80103f62:	68 40 2d 11 80       	push   $0x80112d40
...
80103f8a:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
80103f91:	e8 ca 2c 00 00       	call   80106c60 <freevm>
        release(&ptable.lock);
80103f96:	c7 04 24 40 2d 11 80 	movl   $0x80112d40,(%esp)
        p->pid = 0;
...
80103fb6:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        release(&ptable.lock);
80103fbd:	e8 0e 05 00 00       	call   801044d0 <release>
        return pid;
...
80103ff7:	8b 5d 08             	mov    0x8(%ebp),%ebx
  acquire(&ptable.lock);
80103ffa:	68 40 2d 11 80       	push   $0x80112d40
80103fff:	e8 0c 04 00 00       	call   80104410 <acquire>
80104004:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80104007:	b8 74 2d 11 80       	mov    $0x80112d74,%eax
8010400c:	eb 0e                	jmp    8010401c <wakeup+0x2c>
8010400e:	66 90                	xchg   %ax,%ax
80104010:	05 7c 02 00 00       	add    $0x27c,%eax
80104015:	3d 74 cc 11 80       	cmp    $0x8011cc74,%eax
...
80104027:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
8010402e:	05 7c 02 00 00       	add    $0x27c,%eax
80104033:	3d 74 cc 11 80       	cmp    $0x8011cc74,%eax
80104038:	72 e2                	jb     8010401c <wakeup+0x2c>
  wakeup1(chan);
  release(&ptable.lock);
8010403a:	c7 45 08 40 2d 11 80 	movl   $0x80112d40,0x8(%ebp)
}
80104041:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80104044:	c9                   	leave  
  release(&ptable.lock);
80104045:	e9 86 04 00 00       	jmp    801044d0 <release>
...
8010405f:	e8 ac 03 00 00       	call   80104410 <acquire>
...
80104070:	05 7c 02 00 00       	add    $0x27c,%eax
80104075:	3d 74 cc 11 80       	cmp    $0x8011cc74,%eax
...
80104098:	68 40 2d 11 80       	push   $0x80112d40
8010409d:	e8 2e 04 00 00       	call   801044d0 <release>
      return 0;
...
801040b3:	68 40 2d 11 80       	push   $0x80112d40
801040b8:	e8 13 04 00 00       	call   801044d0 <release>
  return -1;
...
801040d6:	8d 75 e8             	lea    -0x18(%ebp),%esi
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801040d9:	bb 74 2d 11 80       	mov    $0x80112d74,%ebx
{
...
801040f5:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801040f8:	81 c3 7c 02 00 00    	add    $0x27c,%ebx
801040fe:	81 fb 74 cc 11 80    	cmp    $0x8011cc74,%ebx
...
80104111:	83 f8 05             	cmp    $0x5,%eax
      state = "???";
80104114:	ba 80 75 10 80       	mov    $0x80107580,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80104119:	77 11                	ja     8010412c <procdump+0x5c>
8010411b:	8b 14 85 e0 75 10 80 	mov    -0x7fef8a20(,%eax,4),%edx
      state = "???";
80104122:	b8 80 75 10 80       	mov    $0x80107580,%eax
...
80104134:	68 84 75 10 80       	push   $0x80107584
...
8010415b:	e8 90 01 00 00       	call   801042f0 <getcallerpcs>
...
80104179:	68 c1 6f 10 80       	push   $0x80106fc1
...
80104213:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
80104219:	e8 d2 f5 ff ff       	call   801037f0 <myproc>
...
801042a3:	e8 48 f5 ff ff       	call   801037f0 <myproc>
...
8010435f:	e8 ec f3 ff ff       	call   80103750 <mycpu>
...
8010438b:	75 35                	jne    801043c2 <popcli+0x42>
  ...
  if(--mycpu()->ncli < 0)
8010438d:	e8 be f3 ff ff       	call   80103750 <mycpu>
...
801043ac:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  if(mycpu()->ncli == 0 && mycpu()->intena)
801043b0:	e8 9b f3 ff ff       	call   80103750 <mycpu>
...
801043f8:	e8 53 f3 ff ff       	call   80103750 <mycpu>
...
80104454:	e8 f7 f2 ff ff       	call   80103750 <mycpu>
...
80104825:	e8 c6 ef ff ff       	call   801037f0 <myproc>
...
80104833:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80104836:	e8 b5 ef ff ff       	call   801037f0 <myproc>
  if(addr >= curproc->sz || addr+4 > curproc->sz)
...
80104878:	8b 5d 10             	mov    0x10(%ebp),%ebx
  int i;
  struct proc *curproc = myproc();
8010487b:	e8 70 ef ff ff       	call   801037f0 <myproc>
...
80104914:	83 ec 04             	sub    $0x4,%esp
  int num;
  struct proc *curproc = myproc();
80104917:	e8 d4 ee ff ff       	call   801037f0 <myproc>
...
80104b34:	e8 b7 ec ff ff       	call   801037f0 <myproc>
...
801050ff:	0f 84 a6 00 00 00    	je     801051ab <sys_open+0x12b>
  struct proc *curproc = myproc();
80105105:	e8 e6 e6 ff ff       	call   801037f0 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
801052d5:	83 ec 10             	sub    $0x10,%esp
  ...
  struct inode *ip;
  struct proc *curproc = myproc();
801052d8:	e8 13 e5 ff ff       	call   801037f0 <myproc>
...
801054af:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
801054b1:	e8 3a e3 ff ff       	call   801037f0 <myproc>
...
801054d7:	8b 7d e4             	mov    -0x1c(%ebp),%edi
  struct proc *curproc = myproc();
801054da:	e8 11 e3 ff ff       	call   801037f0 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
80105511:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
      myproc()->ofile[fd0] = 0;
80105518:	e8 d3 e2 ff ff       	call   801037f0 <myproc>
...
80105553:	5d                   	pop    %ebp
  return fork();
80105554:	e9 67 e4 ff ff       	jmp    801039c0 <fork>
...
801055f6:	e8 45 e3 ff ff       	call   80103940 <growproc>
...
80105640:	68 80 cc 11 80       	push   $0x8011cc80
...
8010564d:	83 c4 10             	add    $0x10,%esp
  ticks0 = ticks;
80105650:	8b 1d c0 d4 11 80    	mov    0x8011d4c0,%ebx
  while(ticks - ticks0 < n){
...
80105663:	68 80 cc 11 80       	push   $0x8011cc80
80105668:	68 c0 d4 11 80       	push   $0x8011d4c0
8010566d:	e8 be e7 ff ff       	call   80103e30 <sleep>
  while(ticks - ticks0 < n){
80105672:	a1 c0 d4 11 80       	mov    0x8011d4c0,%eax
...
80105690:	68 80 cc 11 80       	push   $0x8011cc80
...
801056b3:	68 80 cc 11 80       	push   $0x8011cc80
...
801056d4:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
801056d7:	68 80 cc 11 80       	push   $0x8011cc80
801056dc:	e8 2f ed ff ff       	call   80104410 <acquire>
  xticks = ticks;
801056e1:	8b 1d c0 d4 11 80    	mov    0x8011d4c0,%ebx
  release(&tickslock);
801056e7:	c7 04 24 80 cc 11 80 	movl   $0x8011cc80,(%esp)
...
80105737:	c7 04 c5 c2 cc 11 80 	movl   $0x8e000008,-0x7fee333e(,%eax,8)
8010573e:	08 00 00 8e 
80105742:	66 89 14 c5 c0 cc 11 	mov    %dx,-0x7fee3340(,%eax,8)
80105749:	80 
8010574a:	c1 ea 10             	shr    $0x10,%edx
8010574d:	66 89 14 c5 c6 cc 11 	mov    %dx,-0x7fee333a(,%eax,8)
80105754:	80 
  for(i = 0; i < 256; i++)
...
80105764:	83 ec 08             	sub    $0x8,%esp
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105767:	c7 05 c2 ce 11 80 08 	movl   $0xef000008,0x8011cec2
8010576e:	00 00 ef 
  initlock(&tickslock, "time");
80105771:	68 19 77 10 80       	push   $0x80107719
80105776:	68 80 cc 11 80       	push   $0x8011cc80
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
8010577b:	66 a3 c0 ce 11 80    	mov    %ax,0x8011cec0
80105781:	c1 e8 10             	shr    $0x10,%eax
80105784:	66 a3 c6 ce 11 80    	mov    %ax,0x8011cec6
  initlock(&tickslock, "time");
...
801057ab:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
801057af:	b8 c0 cc 11 80       	mov    $0x8011ccc0,%eax
...
80105820:	e8 ab df ff ff       	call   801037d0 <cpuid>
...
80105839:	e8 b2 df ff ff       	call   801037f0 <myproc>
    cprintf("pid %d %s: trap %d err %d on cpu %d "
...
80105862:	e8 89 df ff ff       	call   801037f0 <myproc>
...
8010586e:	e8 7d df ff ff       	call   801037f0 <myproc>
80105873:	85 c0                	test   %eax,%eax
80105875:	74 1d                	je     80105894 <trap+0xc4>
80105877:	e8 74 df ff ff       	call   801037f0 <myproc>
...
80105894:	e8 57 df ff ff       	call   801037f0 <myproc>
80105899:	85 c0                	test   %eax,%eax
8010589b:	74 0b                	je     801058a8 <trap+0xd8>
8010589d:	e8 4e df ff ff       	call   801037f0 <myproc>
...
801058a6:	74 68                	je     80105910 <trap+0x140>
  ...
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
801058a8:	e8 43 df ff ff       	call   801037f0 <myproc>
...
801058f0:	e8 1b f0 ff ff       	call   80104910 <syscall>
    if(myproc()->killed)
801058f5:	e8 f6 de ff ff       	call   801037f0 <myproc>
...
8010598f:	e8 3c de ff ff       	call   801037d0 <cpuid>
...
801059a6:	83 c4 10             	add    $0x10,%esp
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
801059a9:	e8 42 de ff ff       	call   801037f0 <myproc>
...
801059ca:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      exit();
801059d0:	e8 db e2 ff ff       	call   80103cb0 <exit>
801059d5:	e9 0e ff ff ff       	jmp    801058e8 <trap+0x118>
801059da:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    exit();
801059e0:	e8 cb e2 ff ff       	call   80103cb0 <exit>
801059e5:	e9 aa fe ff ff       	jmp    80105894 <trap+0xc4>
801059ea:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      acquire(&tickslock);
801059f0:	83 ec 0c             	sub    $0xc,%esp
801059f3:	68 80 cc 11 80       	push   $0x8011cc80
801059f8:	e8 13 ea ff ff       	call   80104410 <acquire>
      wakeup(&ticks);
801059fd:	c7 04 24 c0 d4 11 80 	movl   $0x8011d4c0,(%esp)
      ticks++;
80105a04:	83 05 c0 d4 11 80 01 	addl   $0x1,0x8011d4c0
      wakeup(&ticks);
80105a0b:	e8 e0 e5 ff ff       	call   80103ff0 <wakeup>
      release(&tickslock);
80105a10:	c7 04 24 80 cc 11 80 	movl   $0x8011cc80,(%esp)
...
80105a24:	0f 20 d6             	mov    %cr2,%esi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80105a27:	e8 a4 dd ff ff       	call   801037d0 <cpuid>
...
80106803:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
80106806:	e8 c5 cf ff ff       	call   801037d0 <cpuid>
8010680b:	69 c0 b4 00 00 00    	imul   $0xb4,%eax,%eax
  pd[0] = size-1;
...
80106890:	a1 c4 d4 11 80       	mov    0x8011d4c4,%eax
{
...
801068df:	e8 6c ce ff ff       	call   80103750 <mycpu>
801068e4:	89 c6                	mov    %eax,%esi
801068e6:	e8 65 ce ff ff       	call   80103750 <mycpu>
801068eb:	89 c7                	mov    %eax,%edi
801068ed:	e8 5e ce ff ff       	call   80103750 <mycpu>
801068f2:	89 45 e4             	mov    %eax,-0x1c(%ebp)
801068f5:	83 c7 08             	add    $0x8,%edi
801068f8:	e8 53 ce ff ff       	call   80103750 <mycpu>
...
80106941:	e8 0a ce ff ff       	call   80103750 <mycpu>
...
80106959:	e8 f2 cd ff ff       	call   80103750 <mycpu>
8010695e:	81 c6 00 10 00 00    	add    $0x1000,%esi
80106964:	89 70 0c             	mov    %esi,0xc(%eax)
  mycpu()->ts.iomb = (ushort) 0xFFFF;
80106967:	e8 e4 cd ff ff       	call   80103750 <mycpu>
...
80106d6b:	a3 c4 d4 11 80       	mov    %eax,0x8011d4c4
  lcr3(V2P(kpgdir));   // switch to the kernel page table

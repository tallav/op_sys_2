 ...
 3c9:	85 d2                	test   %edx,%edx
{
 ...
 3f7:	f7 f1                	div    %ecx
 3f9:	0f b6 92 10 0c 00 00 	movzbl 0xc10(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, const char *fmt, ...)
{
 ...
 614:	e9 8f fe ff ff       	jmp    4a8 <printf+0x48>
          s = "(null)";
 619:	bb 07 0c 00 00       	mov    $0xc07,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 631:	a1 80 10 00 00       	mov    0x1080,%eax
{
 ...
 66d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 66f:	a3 80 10 00 00       	mov    %eax,0x1080
}
 674:	5b                   	pop    %ebx
 675:	5e                   	pop    %esi
 676:	5f                   	pop    %edi
 ...
 686:	72 ce                	jb     656 <free+0x26>
{
 ...
 6a7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 6aa:	a3 80 10 00 00       	mov    %eax,0x1080
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6c9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6cc:	8b 15 80 10 00 00    	mov    0x1080,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 70f:	73 47                	jae    758 <malloc+0x98>
    ...
    if(p == freep)
 711:	39 05 80 10 00 00    	cmp    %eax,0x1080
 ...
 736:	e8 f5 fe ff ff       	call   630 <free>
  return freep;
 73b:	8b 15 80 10 00 00    	mov    0x1080,%edx
 ...
 764:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 767:	89 15 80 10 00 00    	mov    %edx,0x1080
}
 ...
 779:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 780:	c7 05 80 10 00 00 84 	movl   $0x1084,0x1080
 787:	10 00 00 
 78a:	c7 05 84 10 00 00 84 	movl   $0x1084,0x1084
 791:	10 00 00 
    base.s.size = 0;
 794:	b8 84 10 00 00       	mov    $0x1084,%eax
 799:	c7 05 88 10 00 00 00 	movl   $0x0,0x1088
 7a0:	00 00 00 
...
void create_tree(struct tree_node* node, int depth){
 ...
 7e7:	03 15 94 10 00 00    	add    0x1094,%edx
        return;
    }
    if(curLevel != depth-2){
 7ed:	39 0d 7c 10 00 00    	cmp    %ecx,0x107c
 7f3:	a1 8c 10 00 00       	mov    0x108c,%eax
 7f8:	74 08                	je     802 <create_tree+0x42>
        index = level_index[depth-1];
 7fa:	8b 02                	mov    (%edx),%eax
        curLevel = depth-2;
 7fc:	89 0d 7c 10 00 00    	mov    %ecx,0x107c
    }
    node->level = curLevel;
    node->index = index;
 ...
 80b:	89 4b 14             	mov    %ecx,0x14(%ebx)
    index++;
 80e:	a3 8c 10 00 00       	mov    %eax,0x108c
    level_index[depth-1] = index;
 ...
 870:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
        node->lockPath = (int*)malloc(treeDepth*sizeof(int));
 876:	a1 90 10 00 00       	mov    0x1090,%eax
...
trnmnt_tree* trnmnt_tree_alloc(int depth){
 ...
 8c4:	8d 53 01             	lea    0x1(%ebx),%edx
    treeDepth = depth;
 8c7:	89 1d 90 10 00 00    	mov    %ebx,0x1090
    tree->depth = depth;
 ...
 8fe:	83 ec 08             	sub    $0x8,%esp
    level_index = arr;
 901:	89 0d 94 10 00 00    	mov    %ecx,0x1094
    create_tree(tree->root, depth+1);
 907:	52                   	push   %edx
 908:	ff 36                	pushl  (%esi)
...
int trnmnt_tree_release(trnmnt_tree* tree,int ID){
 ...
 b76:	8b 35 90 10 00 00    	mov    0x1090,%esi
    struct tree_node* leaf = find_leaf(tree->root, ID);

 ...
 236:	31 f6                	xor    %esi,%esi
{
 ...
 24a:	50                   	push   %eax
 24b:	8d 86 40 14 00 00    	lea    0x1440(%esi),%eax
 251:	50                   	push   %eax
 ...
 265:	01 c6                	add    %eax,%esi
    p = buf;
 267:	bb 40 14 00 00       	mov    $0x1440,%ebx
    buf[m] = '\0';
 26c:	c6 86 40 14 00 00 00 	movb   $0x0,0x1440(%esi)
 ...
 2d2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    if(p == buf)
 2d8:	81 fb 40 14 00 00    	cmp    $0x1440,%ebx
 ...
 2ed:	83 ec 04             	sub    $0x4,%esp
      m -= p - buf;
 2f0:	2d 40 14 00 00       	sub    $0x1440,%eax
 2f5:	29 c6                	sub    %eax,%esi
      memmove(buf, p, m);
 2f7:	56                   	push   %esi
 2f8:	53                   	push   %ebx
 2f9:	68 40 14 00 00       	push   $0x1440
 ...
 679:	85 d2                	test   %edx,%edx
{
 ...
 6a7:	f7 f1                	div    %ecx
 6a9:	0f b6 92 c4 0e 00 00 	movzbl 0xec4(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, const char *fmt, ...)
{
 ...
 8c4:	e9 8f fe ff ff       	jmp    758 <printf+0x48>
          s = "(null)";
 8c9:	bb ba 0e 00 00       	mov    $0xeba,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 8e1:	a1 20 14 00 00       	mov    0x1420,%eax
{
 ...
 91d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 91f:	a3 20 14 00 00       	mov    %eax,0x1420
}
 924:	5b                   	pop    %ebx
 925:	5e                   	pop    %esi
 926:	5f                   	pop    %edi
 ...
 936:	72 ce                	jb     906 <free+0x26>
{
 ...
 957:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 95a:	a3 20 14 00 00       	mov    %eax,0x1420
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 979:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 97c:	8b 15 20 14 00 00    	mov    0x1420,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 9bf:	73 47                	jae    a08 <malloc+0x98>
    ...
    if(p == freep)
 9c1:	39 05 20 14 00 00    	cmp    %eax,0x1420
 ...
 9e6:	e8 f5 fe ff ff       	call   8e0 <free>
  return freep;
 9eb:	8b 15 20 14 00 00    	mov    0x1420,%edx
 ...
 a14:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 a17:	89 15 20 14 00 00    	mov    %edx,0x1420
}
 ...
 a29:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 a30:	c7 05 20 14 00 00 24 	movl   $0x1424,0x1420
 a37:	14 00 00 
 a3a:	c7 05 24 14 00 00 24 	movl   $0x1424,0x1424
 a41:	14 00 00 
    base.s.size = 0;
 a44:	b8 24 14 00 00       	mov    $0x1424,%eax
...
void create_tree(struct tree_node* node, int depth){
 ...
 a97:	03 15 40 18 00 00    	add    0x1840,%edx
        return;
    }
    if(curLevel != depth-2){
 a9d:	39 0d 18 14 00 00    	cmp    %ecx,0x1418
 aa3:	a1 2c 14 00 00       	mov    0x142c,%eax
 aa8:	74 08                	je     ab2 <create_tree+0x42>
        index = level_index[depth-1];
 aaa:	8b 02                	mov    (%edx),%eax
        curLevel = depth-2;
 aac:	89 0d 18 14 00 00    	mov    %ecx,0x1418
    }
    node->level = curLevel;
    node->index = index;
 ...
 abb:	89 4b 14             	mov    %ecx,0x14(%ebx)
    index++;
 abe:	a3 2c 14 00 00       	mov    %eax,0x142c
    level_index[depth-1] = index;
 ...
 b20:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
        node->lockPath = (int*)malloc(treeDepth*sizeof(int));
 b26:	a1 30 14 00 00       	mov    0x1430,%eax
...
trnmnt_tree* trnmnt_tree_alloc(int depth){
 ...
 b74:	8d 53 01             	lea    0x1(%ebx),%edx
    treeDepth = depth;
 b77:	89 1d 30 14 00 00    	mov    %ebx,0x1430
    tree->depth = depth;
 ...
 bae:	83 ec 08             	sub    $0x8,%esp
    level_index = arr;
 bb1:	89 0d 40 18 00 00    	mov    %ecx,0x1840
    create_tree(tree->root, depth+1);
 bb7:	52                   	push   %edx
 bb8:	ff 36                	pushl  (%esi)
...
int trnmnt_tree_release(trnmnt_tree* tree,int ID){
 ...
 e26:	8b 35 30 14 00 00    	mov    0x1430,%esi
    struct tree_node* leaf = find_leaf(tree->root, ID);

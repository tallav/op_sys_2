 ...
 3a9:	85 d2                	test   %edx,%edx
{
 ...
 3d7:	f7 f1                	div    %ecx
 3d9:	0f b6 92 e4 0b 00 00 	movzbl 0xbe4(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, const char *fmt, ...)
{
 ...
 5f4:	e9 8f fe ff ff       	jmp    488 <printf+0x48>
          s = "(null)";
 5f9:	bb db 0b 00 00       	mov    $0xbdb,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 611:	a1 4c 10 00 00       	mov    0x104c,%eax
{
 ...
 64d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 64f:	a3 4c 10 00 00       	mov    %eax,0x104c
}
 654:	5b                   	pop    %ebx
 655:	5e                   	pop    %esi
 656:	5f                   	pop    %edi
 ...
 666:	72 ce                	jb     636 <free+0x26>
{
 ...
 687:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 68a:	a3 4c 10 00 00       	mov    %eax,0x104c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6a9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6ac:	8b 15 4c 10 00 00    	mov    0x104c,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6ef:	73 47                	jae    738 <malloc+0x98>
    ...
    if(p == freep)
 6f1:	39 05 4c 10 00 00    	cmp    %eax,0x104c
 ...
 716:	e8 f5 fe ff ff       	call   610 <free>
  return freep;
 71b:	8b 15 4c 10 00 00    	mov    0x104c,%edx
 ...
 744:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 747:	89 15 4c 10 00 00    	mov    %edx,0x104c
}
 ...
 759:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 760:	c7 05 4c 10 00 00 50 	movl   $0x1050,0x104c
 767:	10 00 00 
 76a:	c7 05 50 10 00 00 50 	movl   $0x1050,0x1050
 771:	10 00 00 
    base.s.size = 0;
 774:	b8 50 10 00 00       	mov    $0x1050,%eax
 779:	c7 05 54 10 00 00 00 	movl   $0x0,0x1054
 780:	00 00 00 
...
void create_tree(struct tree_node* node, int depth){
 ...
 7c7:	03 15 60 10 00 00    	add    0x1060,%edx
        return;
    }
    if(curLevel != depth-2){
 7cd:	39 0d 48 10 00 00    	cmp    %ecx,0x1048
 7d3:	a1 58 10 00 00       	mov    0x1058,%eax
 7d8:	74 08                	je     7e2 <create_tree+0x42>
        index = level_index[depth-1];
 7da:	8b 02                	mov    (%edx),%eax
        curLevel = depth-2;
 7dc:	89 0d 48 10 00 00    	mov    %ecx,0x1048
    }
    node->level = curLevel;
    node->index = index;
 ...
 7eb:	89 4b 14             	mov    %ecx,0x14(%ebx)
    index++;
 7ee:	a3 58 10 00 00       	mov    %eax,0x1058
    level_index[depth-1] = index;
 ...
 850:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
        node->lockPath = (int*)malloc(treeDepth*sizeof(int));
 856:	a1 5c 10 00 00       	mov    0x105c,%eax
...
trnmnt_tree* trnmnt_tree_alloc(int depth){
 ...
 8a4:	8d 53 01             	lea    0x1(%ebx),%edx
    treeDepth = depth;
 8a7:	89 1d 5c 10 00 00    	mov    %ebx,0x105c
    tree->depth = depth;
 ...
 8de:	83 ec 08             	sub    $0x8,%esp
    level_index = arr;
 8e1:	89 0d 60 10 00 00    	mov    %ecx,0x1060
    create_tree(tree->root, depth+1);
 8e7:	52                   	push   %edx
 8e8:	ff 36                	pushl  (%esi)
...
int trnmnt_tree_release(trnmnt_tree* tree,int ID){
 ...
 b56:	8b 35 5c 10 00 00    	mov    0x105c,%esi
    struct tree_node* leaf = find_leaf(tree->root, ID);

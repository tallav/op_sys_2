 ...
 459:	85 d2                	test   %edx,%edx
{
 ...
 487:	f7 f1                	div    %ecx
 489:	0f b6 92 a4 0c 00 00 	movzbl 0xca4(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, const char *fmt, ...)
{
 ...
 6a4:	e9 8f fe ff ff       	jmp    538 <printf+0x48>
          s = "(null)";
 6a9:	bb 9c 0c 00 00       	mov    $0xc9c,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 6c1:	a1 40 11 00 00       	mov    0x1140,%eax
{
 ...
 6fd:	89 08                	mov    %ecx,(%eax)
  freep = p;
 6ff:	a3 40 11 00 00       	mov    %eax,0x1140
}
 704:	5b                   	pop    %ebx
 705:	5e                   	pop    %esi
 706:	5f                   	pop    %edi
 ...
 716:	72 ce                	jb     6e6 <free+0x26>
{
 ...
 737:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 73a:	a3 40 11 00 00       	mov    %eax,0x1140
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 759:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 75c:	8b 15 40 11 00 00    	mov    0x1140,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 79f:	73 47                	jae    7e8 <malloc+0x98>
    ...
    if(p == freep)
 7a1:	39 05 40 11 00 00    	cmp    %eax,0x1140
 ...
 7c6:	e8 f5 fe ff ff       	call   6c0 <free>
  return freep;
 7cb:	8b 15 40 11 00 00    	mov    0x1140,%edx
 ...
 7f4:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 7f7:	89 15 40 11 00 00    	mov    %edx,0x1140
}
 ...
 809:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 810:	c7 05 40 11 00 00 44 	movl   $0x1144,0x1140
 817:	11 00 00 
 81a:	c7 05 44 11 00 00 44 	movl   $0x1144,0x1144
 821:	11 00 00 
    base.s.size = 0;
 824:	b8 44 11 00 00       	mov    $0x1144,%eax
 829:	c7 05 48 11 00 00 00 	movl   $0x0,0x1148
 830:	00 00 00 
...
void create_tree(struct tree_node* node, int depth){
 ...
 861:	0f 84 8a 00 00 00    	je     8f1 <create_tree+0xa1>
 867:	8d 04 b5 fc ff ff ff 	lea    -0x4(,%esi,4),%eax
 86e:	89 45 e4             	mov    %eax,-0x1c(%ebp)
 871:	8d 4e fe             	lea    -0x2(%esi),%ecx
 874:	8b 55 e4             	mov    -0x1c(%ebp),%edx
 877:	03 15 60 13 00 00    	add    0x1360,%edx
        return;
    }
    if(curLevel != depth-2){
 87d:	39 0d 3c 11 00 00    	cmp    %ecx,0x113c
 883:	a1 4c 11 00 00       	mov    0x114c,%eax
 888:	74 08                	je     892 <create_tree+0x42>
        index = level_index[depth-1];
 88a:	8b 02                	mov    (%edx),%eax
        curLevel = depth-2;
 88c:	89 0d 3c 11 00 00    	mov    %ecx,0x113c
    }
    node->level = curLevel;
    node->index = index;
 892:	89 43 10             	mov    %eax,0x10(%ebx)
    index++;
 895:	83 c0 01             	add    $0x1,%eax
    level_index[depth-1] = index;
    if(depth == 1){
 898:	83 fe 01             	cmp    $0x1,%esi
    node->level = curLevel;
 89b:	89 4b 14             	mov    %ecx,0x14(%ebx)
    index++;
 89e:	a3 4c 11 00 00       	mov    %eax,0x114c
    level_index[depth-1] = index;
 8a3:	89 02                	mov    %eax,(%edx)
    if(depth == 1){
 8a5:	74 59                	je     900 <create_tree+0xb0>
        node->left_child = 0;
        node->right_child = 0;
 ...
 8aa:	83 ee 01             	sub    $0x1,%esi
        struct tree_node *left = malloc(sizeof(struct tree_node));
 8ad:	6a 1c                	push   $0x1c
 8af:	e8 9c fe ff ff       	call   750 <malloc>
 8b4:	89 c7                	mov    %eax,%edi
        struct tree_node *right = malloc(sizeof(struct tree_node));
 8b6:	c7 04 24 1c 00 00 00 	movl   $0x1c,(%esp)
 8bd:	e8 8e fe ff ff       	call   750 <malloc>
        left->parent = node;
 8c2:	89 5f 08             	mov    %ebx,0x8(%edi)
        right->parent = node;
 8c5:	89 58 08             	mov    %ebx,0x8(%eax)
        node->left_child = left;
 8c8:	89 3b                	mov    %edi,(%ebx)
        node->right_child = right;
 8ca:	89 43 04             	mov    %eax,0x4(%ebx)
 8cd:	89 45 e0             	mov    %eax,-0x20(%ebp)
        node->mutex_id = kthread_mutex_alloc();
 8d0:	e8 4d fb ff ff       	call   422 <kthread_mutex_alloc>
 8d5:	89 43 0c             	mov    %eax,0xc(%ebx)
        create_tree(left, depth-1);
 8d8:	58                   	pop    %eax
 8d9:	5a                   	pop    %edx
 8da:	56                   	push   %esi
 8db:	57                   	push   %edi
 8dc:	e8 6f ff ff ff       	call   850 <create_tree>
 8e1:	8b 55 e0             	mov    -0x20(%ebp),%edx
 8e4:	83 6d e4 04          	subl   $0x4,-0x1c(%ebp)
    if(depth == 0){
 8e8:	83 c4 10             	add    $0x10,%esp
 8eb:	85 f6                	test   %esi,%esi
 8ed:	89 d3                	mov    %edx,%ebx
 8ef:	75 80                	jne    871 <create_tree+0x21>
 ...
 8f9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
        node->left_child = 0;
 900:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
        node->lockPath = (int*)malloc(treeDepth*sizeof(int));
 906:	a1 50 11 00 00       	mov    0x1150,%eax
 90b:	83 ec 0c             	sub    $0xc,%esp
        node->right_child = 0;
 90e:	c7 43 04 00 00 00 00 	movl   $0x0,0x4(%ebx)
        node->lockPath = (int*)malloc(treeDepth*sizeof(int));
 915:	c1 e0 02             	shl    $0x2,%eax
 918:	50                   	push   %eax
 919:	e8 32 fe ff ff       	call   750 <malloc>
 91e:	83 c4 10             	add    $0x10,%esp
 921:	89 43 18             	mov    %eax,0x18(%ebx)
}
...
trnmnt_tree* trnmnt_tree_alloc(int depth){
 ...
 93a:	7e 74                	jle    9b0 <trnmnt_tree_alloc+0x80>
    trnmnt_tree *tree = malloc(sizeof(trnmnt_tree));
 93c:	83 ec 0c             	sub    $0xc,%esp
 93f:	6a 08                	push   $0x8
 941:	e8 0a fe ff ff       	call   750 <malloc>
    struct tree_node *root = malloc(sizeof(struct tree_node));
 946:	c7 04 24 1c 00 00 00 	movl   $0x1c,(%esp)
    trnmnt_tree *tree = malloc(sizeof(trnmnt_tree));
 94d:	89 c6                	mov    %eax,%esi
    struct tree_node *root = malloc(sizeof(struct tree_node));
 94f:	e8 fc fd ff ff       	call   750 <malloc>
    int arr[depth+1];
 954:	8d 53 01             	lea    0x1(%ebx),%edx
    treeDepth = depth;
 957:	89 1d 50 11 00 00    	mov    %ebx,0x1150
    tree->depth = depth;
 95d:	89 5e 04             	mov    %ebx,0x4(%esi)
    tree->root = root;
 960:	89 06                	mov    %eax,(%esi)
    root->parent = 0;
 962:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
    int arr[depth+1];
 969:	83 c4 10             	add    $0x10,%esp
 96c:	8d 04 95 12 00 00 00 	lea    0x12(,%edx,4),%eax
 973:	83 e0 f0             	and    $0xfffffff0,%eax
 976:	29 c4                	sub    %eax,%esp
    for(int i = 0; i < depth+1; i++)
 978:	31 c0                	xor    %eax,%eax
    int arr[depth+1];
 97a:	89 e1                	mov    %esp,%ecx
 ...
 98c:	75 f2                	jne    980 <trnmnt_tree_alloc+0x50>
    create_tree(tree->root, depth+1);
 98e:	83 ec 08             	sub    $0x8,%esp
    level_index = arr;
 991:	89 0d 60 13 00 00    	mov    %ecx,0x1360
    create_tree(tree->root, depth+1);
 997:	52                   	push   %edx
 998:	ff 36                	pushl  (%esi)
 99a:	e8 b1 fe ff ff       	call   850 <create_tree>
    return tree;
 99f:	83 c4 10             	add    $0x10,%esp
}
 9a2:	8d 65 f8             	lea    -0x8(%ebp),%esp
 ...
 9b0:	8d 65 f8             	lea    -0x8(%ebp),%esp
        return 0;
 9b3:	31 f6                	xor    %esi,%esi
}
 9b5:	89 f0                	mov    %esi,%eax
 9b7:	5b                   	pop    %ebx
 9b8:	5e                   	pop    %esi
 9b9:	5d                   	pop    %ebp
 9ba:	c3                   	ret    
...
void print_node(struct tree_node *n,int l){
 ...
 9cc:	8b 5d 0c             	mov    0xc(%ebp),%ebx
	if(!n) return;
 9cf:	85 f6                	test   %esi,%esi
 9d1:	74 5a                	je     a2d <print_node+0x6d>
    int i;
	print_node(n->right_child,l+1);
 9d3:	8d 43 01             	lea    0x1(%ebx),%eax
 9d6:	83 ec 08             	sub    $0x8,%esp
 9d9:	50                   	push   %eax
 9da:	ff 76 04             	pushl  0x4(%esi)
 9dd:	89 45 e4             	mov    %eax,-0x1c(%ebp)
 9e0:	e8 db ff ff ff       	call   9c0 <print_node>
	for(i=0;i<l;++i){
 9e5:	83 c4 10             	add    $0x10,%esp
 9e8:	85 db                	test   %ebx,%ebx
 9ea:	7e 1d                	jle    a09 <print_node+0x49>
 9ec:	31 ff                	xor    %edi,%edi
 9ee:	66 90                	xchg   %ax,%ax
		printf(1,"    ");
 9f0:	83 ec 08             	sub    $0x8,%esp
	for(i=0;i<l;++i){
 9f3:	83 c7 01             	add    $0x1,%edi
		printf(1,"    ");
 9f6:	68 b5 0c 00 00       	push   $0xcb5
 9fb:	6a 01                	push   $0x1
 9fd:	e8 ee fa ff ff       	call   4f0 <printf>
	for(i=0;i<l;++i){
 a02:	83 c4 10             	add    $0x10,%esp
 a05:	39 df                	cmp    %ebx,%edi
 a07:	75 e7                	jne    9f0 <print_node+0x30>
    }
	printf(1,"%d,%d,%d\n",n->level, n->index, n->mutex_id);
 a09:	83 ec 0c             	sub    $0xc,%esp
 a0c:	ff 76 0c             	pushl  0xc(%esi)
 a0f:	ff 76 10             	pushl  0x10(%esi)
 a12:	ff 76 14             	pushl  0x14(%esi)
 a15:	68 ba 0c 00 00       	push   $0xcba
 a1a:	6a 01                	push   $0x1
 a1c:	e8 cf fa ff ff       	call   4f0 <printf>
	print_node(n->left_child,l+1);
 a21:	8b 36                	mov    (%esi),%esi
	if(!n) return;
 a23:	83 c4 20             	add    $0x20,%esp
	print_node(n->left_child,l+1);
 a26:	8b 5d e4             	mov    -0x1c(%ebp),%ebx
	if(!n) return;
 a29:	85 f6                	test   %esi,%esi
 a2b:	75 a6                	jne    9d3 <print_node+0x13>
}
...
void print_tree(trnmnt_tree *t){
 ...
 a4b:	74 0f                	je     a5c <print_tree+0x1c>
	print_node(t->root,0);
 a4d:	83 ec 08             	sub    $0x8,%esp
 a50:	6a 00                	push   $0x0
 a52:	ff 30                	pushl  (%eax)
 a54:	e8 67 ff ff ff       	call   9c0 <print_node>
...
int delete_node(struct tree_node *node){
 ...
 a69:	8b 5d 08             	mov    0x8(%ebp),%ebx
    if (node != 0){ 
 a6c:	85 db                	test   %ebx,%ebx
 a6e:	74 5e                	je     ace <delete_node+0x6e>
        if(kthread_mutex_dealloc(node->mutex_id) == -1){
 a70:	83 ec 0c             	sub    $0xc,%esp
 a73:	ff 73 0c             	pushl  0xc(%ebx)
 a76:	e8 af f9 ff ff       	call   42a <kthread_mutex_dealloc>
 a7b:	83 c4 10             	add    $0x10,%esp
 a7e:	83 f8 ff             	cmp    $0xffffffff,%eax
 a81:	74 4b                	je     ace <delete_node+0x6e>
        delete_node(node->left_child); 
 a83:	83 ec 0c             	sub    $0xc,%esp
 a86:	ff 33                	pushl  (%ebx)
 a88:	e8 d3 ff ff ff       	call   a60 <delete_node>
        delete_node(node->right_child); 
 a8d:	58                   	pop    %eax
 a8e:	ff 73 04             	pushl  0x4(%ebx)
 a91:	e8 ca ff ff ff       	call   a60 <delete_node>
        if(node->lockPath){
 a96:	8b 43 18             	mov    0x18(%ebx),%eax
 a99:	83 c4 10             	add    $0x10,%esp
        node->left_child = 0;
 a9c:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
        node->right_child = 0;
 aa2:	c7 43 04 00 00 00 00 	movl   $0x0,0x4(%ebx)
        if(node->lockPath){
 aa9:	85 c0                	test   %eax,%eax
 aab:	74 13                	je     ac0 <delete_node+0x60>
            free(node->lockPath);
 aad:	83 ec 0c             	sub    $0xc,%esp
 ab0:	50                   	push   %eax
 ab1:	e8 0a fc ff ff       	call   6c0 <free>
            node->lockPath = 0;
 ab6:	c7 43 18 00 00 00 00 	movl   $0x0,0x18(%ebx)
 abd:	83 c4 10             	add    $0x10,%esp
        free(node); 
 ac0:	83 ec 0c             	sub    $0xc,%esp
 ac3:	53                   	push   %ebx
 ac4:	e8 f7 fb ff ff       	call   6c0 <free>
 ac9:	83 c4 10             	add    $0x10,%esp
 acc:	31 c0                	xor    %eax,%eax
}
 ace:	8b 5d fc             	mov    -0x4(%ebp),%ebx
 ad1:	c9                   	leave  
 ad2:	c3                   	ret    
 ad3:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
 ad9:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi

00000ae0 <trnmnt_tree_dealloc>:
...
int trnmnt_tree_dealloc(trnmnt_tree* tree){
 ...
 aeb:	ff 33                	pushl  (%ebx)
 aed:	e8 6e ff ff ff       	call   a60 <delete_node>
 af2:	83 c4 10             	add    $0x10,%esp
 af5:	85 c0                	test   %eax,%eax
 af7:	75 27                	jne    b20 <trnmnt_tree_dealloc+0x40>
        tree->root = 0;
        free(tree);
 af9:	83 ec 0c             	sub    $0xc,%esp
        tree->root = 0;
 afc:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
 b02:	89 c6                	mov    %eax,%esi
        free(tree);
 b04:	53                   	push   %ebx
 b05:	e8 b6 fb ff ff       	call   6c0 <free>
        tree = 0;
        return 0;
 ...
 b25:	eb e6                	jmp    b0d <trnmnt_tree_dealloc+0x2d>
...
struct tree_node* find_leaf(struct tree_node* node, int ID){
 ...
 b3c:	8b 5d 0c             	mov    0xc(%ebp),%ebx
    if(node->right_child == 0 && node->left_child == 0){ 
 b3f:	8b 72 04             	mov    0x4(%edx),%esi
 b42:	8b 02                	mov    (%edx),%eax
 b44:	85 f6                	test   %esi,%esi
 b46:	75 18                	jne    b60 <find_leaf+0x30>
 b48:	85 c0                	test   %eax,%eax
 b4a:	75 14                	jne    b60 <find_leaf+0x30>
        if(ID == node->index){
 b4c:	39 5a 10             	cmp    %ebx,0x10(%edx)
 b4f:	0f 44 c2             	cmove  %edx,%eax
        if(leaf1)
            return leaf1;
        else
            return leaf2;
 ...
 b63:	53                   	push   %ebx
 b64:	50                   	push   %eax
 b65:	e8 c6 ff ff ff       	call   b30 <find_leaf>
 b6a:	5a                   	pop    %edx
 b6b:	59                   	pop    %ecx
 ...
 b6e:	89 c7                	mov    %eax,%edi
        struct tree_node* leaf2 = find_leaf(node->right_child, ID);
 b70:	e8 bb ff ff ff       	call   b30 <find_leaf>
 b75:	83 c4 10             	add    $0x10,%esp
        if(leaf1)
 b78:	85 ff                	test   %edi,%edi
 b7a:	0f 45 c7             	cmovne %edi,%eax
} 
...
int trnmnt_tree_acquire(trnmnt_tree* tree,int ID){
 ...
 b94:	56                   	push   %esi
 b95:	53                   	push   %ebx
 b96:	83 ec 14             	sub    $0x14,%esp
    struct tree_node* leaf = find_leaf(tree->root, ID);
 b99:	8b 45 08             	mov    0x8(%ebp),%eax
 b9c:	ff 75 0c             	pushl  0xc(%ebp)
 b9f:	ff 30                	pushl  (%eax)
 ba1:	e8 8a ff ff ff       	call   b30 <find_leaf>
 ba6:	8b 50 08             	mov    0x8(%eax),%edx
 ba9:	83 c4 10             	add    $0x10,%esp
 bac:	89 c7                	mov    %eax,%edi
    while(curNode->parent){
 bae:	89 c3                	mov    %eax,%ebx
 bb0:	85 d2                	test   %edx,%edx
 bb2:	74 32                	je     be6 <trnmnt_tree_acquire+0x56>
        int level = curNode->parent->level;
 bb4:	8b 72 14             	mov    0x14(%edx),%esi
        int mutex_lock = kthread_mutex_lock(mutexID);
 bb7:	83 ec 0c             	sub    $0xc,%esp
 bba:	ff 72 0c             	pushl  0xc(%edx)
 bbd:	e8 70 f8 ff ff       	call   432 <kthread_mutex_lock>
        leaf->lockPath[level] = curNode->parent->mutex_id;
 bc2:	8b 53 08             	mov    0x8(%ebx),%edx
        if(mutex_lock == -1){
 bc5:	83 c4 10             	add    $0x10,%esp
 bc8:	83 f8 ff             	cmp    $0xffffffff,%eax
        leaf->lockPath[level] = curNode->parent->mutex_id;
 bcb:	8b 4a 0c             	mov    0xc(%edx),%ecx
 bce:	8b 57 18             	mov    0x18(%edi),%edx
 bd1:	89 0c b2             	mov    %ecx,(%edx,%esi,4)
        if(mutex_lock == -1){
 bd4:	74 12                	je     be8 <trnmnt_tree_acquire+0x58>
        if(mutex_lock == 0){
 bd6:	85 c0                	test   %eax,%eax
 bd8:	8b 53 08             	mov    0x8(%ebx),%edx
 bdb:	75 d3                	jne    bb0 <trnmnt_tree_acquire+0x20>
 bdd:	89 d3                	mov    %edx,%ebx
 bdf:	8b 52 08             	mov    0x8(%edx),%edx
    while(curNode->parent){
 be2:	85 d2                	test   %edx,%edx
 be4:	75 ce                	jne    bb4 <trnmnt_tree_acquire+0x24>
    return 0;
...
int trnmnt_tree_release(trnmnt_tree* tree,int ID){
 ...
 bf4:	56                   	push   %esi
 bf5:	53                   	push   %ebx
 bf6:	83 ec 14             	sub    $0x14,%esp
    struct tree_node* leaf = find_leaf(tree->root, ID);
 bf9:	8b 45 08             	mov    0x8(%ebp),%eax
 bfc:	ff 75 0c             	pushl  0xc(%ebp)
 bff:	ff 30                	pushl  (%eax)
 c01:	e8 2a ff ff ff       	call   b30 <find_leaf>
    for(int i = treeDepth-1; i >= 0; i--){
 c06:	8b 35 50 11 00 00    	mov    0x1150,%esi
    struct tree_node* leaf = find_leaf(tree->root, ID);
 c0c:	83 c4 10             	add    $0x10,%esp
    for(int i = treeDepth-1; i >= 0; i--){
 c0f:	83 ee 01             	sub    $0x1,%esi
 c12:	78 44                	js     c58 <trnmnt_tree_release+0x68>
 c14:	89 c7                	mov    %eax,%edi
 c16:	8d 1c b5 00 00 00 00 	lea    0x0(,%esi,4),%ebx
 c1d:	eb 16                	jmp    c35 <trnmnt_tree_release+0x45>
 c1f:	90                   	nop
        leaf->lockPath[i] = 0;
 c20:	8b 47 18             	mov    0x18(%edi),%eax
    for(int i = treeDepth-1; i >= 0; i--){
 c23:	83 ee 01             	sub    $0x1,%esi
        leaf->lockPath[i] = 0;
 c26:	c7 04 18 00 00 00 00 	movl   $0x0,(%eax,%ebx,1)
 c2d:	83 eb 04             	sub    $0x4,%ebx
    for(int i = treeDepth-1; i >= 0; i--){
 c30:	83 fe ff             	cmp    $0xffffffff,%esi
 c33:	74 23                	je     c58 <trnmnt_tree_release+0x68>
        int res = kthread_mutex_unlock(leaf->lockPath[i]);
 c35:	8b 47 18             	mov    0x18(%edi),%eax
 c38:	83 ec 0c             	sub    $0xc,%esp
 c3b:	ff 34 18             	pushl  (%eax,%ebx,1)
 c3e:	e8 f7 f7 ff ff       	call   43a <kthread_mutex_unlock>
        if(res == -1){
 c43:	83 c4 10             	add    $0x10,%esp
 c46:	83 f8 ff             	cmp    $0xffffffff,%eax
 c49:	75 d5                	jne    c20 <trnmnt_tree_release+0x30>
}

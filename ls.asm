 ...
 679:	85 d2                	test   %edx,%edx
{
 ...
 6a7:	f7 f1                	div    %ecx
 6a9:	0f b6 92 d8 0e 00 00 	movzbl 0xed8(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, const char *fmt, ...)
{
 ...
 8c4:	e9 8f fe ff ff       	jmp    758 <printf+0x48>
          s = "(null)";
 8c9:	bb ce 0e 00 00       	mov    $0xece,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 8e1:	a1 c8 13 00 00       	mov    0x13c8,%eax
{
 ...
 91d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 91f:	a3 c8 13 00 00       	mov    %eax,0x13c8
}
 924:	5b                   	pop    %ebx
 925:	5e                   	pop    %esi
 926:	5f                   	pop    %edi
 ...
 936:	72 ce                	jb     906 <free+0x26>
{
 ...
 957:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 95a:	a3 c8 13 00 00       	mov    %eax,0x13c8
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 979:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 97c:	8b 15 c8 13 00 00    	mov    0x13c8,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 9bf:	73 47                	jae    a08 <malloc+0x98>
    ...
    if(p == freep)
 9c1:	39 05 c8 13 00 00    	cmp    %eax,0x13c8
 ...
 9e6:	e8 f5 fe ff ff       	call   8e0 <free>
  return freep;
 9eb:	8b 15 c8 13 00 00    	mov    0x13c8,%edx
 ...
 a14:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 a17:	89 15 c8 13 00 00    	mov    %edx,0x13c8
}
 ...
 a29:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 a30:	c7 05 c8 13 00 00 cc 	movl   $0x13cc,0x13c8
 a37:	13 00 00 
 a3a:	c7 05 cc 13 00 00 cc 	movl   $0x13cc,0x13cc
 a41:	13 00 00 
    base.s.size = 0;
 a44:	b8 cc 13 00 00       	mov    $0x13cc,%eax
 a49:	c7 05 d0 13 00 00 00 	movl   $0x0,0x13d0
 a50:	00 00 00 
...
void create_tree(struct tree_node* node, int depth){
 ...
 a81:	0f 84 8a 00 00 00    	je     b11 <create_tree+0xa1>
 a87:	8d 04 b5 fc ff ff ff 	lea    -0x4(,%esi,4),%eax
 a8e:	89 45 e4             	mov    %eax,-0x1c(%ebp)
 a91:	8d 4e fe             	lea    -0x2(%esi),%ecx
 a94:	8b 55 e4             	mov    -0x1c(%ebp),%edx
 a97:	03 15 dc 13 00 00    	add    0x13dc,%edx
        return;
    }
    if(curLevel != depth-2){
 a9d:	39 0d b4 13 00 00    	cmp    %ecx,0x13b4
 aa3:	a1 d4 13 00 00       	mov    0x13d4,%eax
 aa8:	74 08                	je     ab2 <create_tree+0x42>
        index = level_index[depth-1];
 aaa:	8b 02                	mov    (%edx),%eax
        curLevel = depth-2;
 aac:	89 0d b4 13 00 00    	mov    %ecx,0x13b4
    }
    node->level = curLevel;
    node->index = index;
 ab2:	89 43 10             	mov    %eax,0x10(%ebx)
    index++;
 ab5:	83 c0 01             	add    $0x1,%eax
    level_index[depth-1] = index;
    if(depth == 1){
 ab8:	83 fe 01             	cmp    $0x1,%esi
    node->level = curLevel;
 abb:	89 4b 14             	mov    %ecx,0x14(%ebx)
    index++;
 abe:	a3 d4 13 00 00       	mov    %eax,0x13d4
    level_index[depth-1] = index;
 ac3:	89 02                	mov    %eax,(%edx)
    if(depth == 1){
 ac5:	74 59                	je     b20 <create_tree+0xb0>
        node->left_child = 0;
        node->right_child = 0;
 ...
 aca:	83 ee 01             	sub    $0x1,%esi
        struct tree_node *left = malloc(sizeof(struct tree_node));
 acd:	6a 1c                	push   $0x1c
 acf:	e8 9c fe ff ff       	call   970 <malloc>
 ad4:	89 c7                	mov    %eax,%edi
        struct tree_node *right = malloc(sizeof(struct tree_node));
 ad6:	c7 04 24 1c 00 00 00 	movl   $0x1c,(%esp)
 add:	e8 8e fe ff ff       	call   970 <malloc>
        left->parent = node;
 ae2:	89 5f 08             	mov    %ebx,0x8(%edi)
        right->parent = node;
 ae5:	89 58 08             	mov    %ebx,0x8(%eax)
        node->left_child = left;
 ae8:	89 3b                	mov    %edi,(%ebx)
        node->right_child = right;
 aea:	89 43 04             	mov    %eax,0x4(%ebx)
 aed:	89 45 e0             	mov    %eax,-0x20(%ebp)
        node->mutex_id = kthread_mutex_alloc();
 af0:	e8 4d fb ff ff       	call   642 <kthread_mutex_alloc>
 af5:	89 43 0c             	mov    %eax,0xc(%ebx)
        create_tree(left, depth-1);
 af8:	58                   	pop    %eax
 af9:	5a                   	pop    %edx
 afa:	56                   	push   %esi
 afb:	57                   	push   %edi
 afc:	e8 6f ff ff ff       	call   a70 <create_tree>
 b01:	8b 55 e0             	mov    -0x20(%ebp),%edx
 b04:	83 6d e4 04          	subl   $0x4,-0x1c(%ebp)
    if(depth == 0){
 b08:	83 c4 10             	add    $0x10,%esp
 b0b:	85 f6                	test   %esi,%esi
 b0d:	89 d3                	mov    %edx,%ebx
 b0f:	75 80                	jne    a91 <create_tree+0x21>
 ...
 b20:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
        node->lockPath = (int*)malloc(treeDepth*sizeof(int));
 b26:	a1 d8 13 00 00       	mov    0x13d8,%eax
 b2b:	83 ec 0c             	sub    $0xc,%esp
        node->right_child = 0;
 b2e:	c7 43 04 00 00 00 00 	movl   $0x0,0x4(%ebx)
        node->lockPath = (int*)malloc(treeDepth*sizeof(int));
 b35:	c1 e0 02             	shl    $0x2,%eax
 b38:	50                   	push   %eax
 b39:	e8 32 fe ff ff       	call   970 <malloc>
 b3e:	83 c4 10             	add    $0x10,%esp
 b41:	89 43 18             	mov    %eax,0x18(%ebx)
}
...
trnmnt_tree* trnmnt_tree_alloc(int depth){
 ...
 b5a:	7e 74                	jle    bd0 <trnmnt_tree_alloc+0x80>
    trnmnt_tree *tree = malloc(sizeof(trnmnt_tree));
 b5c:	83 ec 0c             	sub    $0xc,%esp
 b5f:	6a 08                	push   $0x8
 b61:	e8 0a fe ff ff       	call   970 <malloc>
    struct tree_node *root = malloc(sizeof(struct tree_node));
 b66:	c7 04 24 1c 00 00 00 	movl   $0x1c,(%esp)
    trnmnt_tree *tree = malloc(sizeof(trnmnt_tree));
 b6d:	89 c6                	mov    %eax,%esi
    struct tree_node *root = malloc(sizeof(struct tree_node));
 b6f:	e8 fc fd ff ff       	call   970 <malloc>
    int arr[depth+1];
 b74:	8d 53 01             	lea    0x1(%ebx),%edx
    treeDepth = depth;
 b77:	89 1d d8 13 00 00    	mov    %ebx,0x13d8
    tree->depth = depth;
 b7d:	89 5e 04             	mov    %ebx,0x4(%esi)
    tree->root = root;
 b80:	89 06                	mov    %eax,(%esi)
    root->parent = 0;
 b82:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
    int arr[depth+1];
 b89:	83 c4 10             	add    $0x10,%esp
 b8c:	8d 04 95 12 00 00 00 	lea    0x12(,%edx,4),%eax
 b93:	83 e0 f0             	and    $0xfffffff0,%eax
 b96:	29 c4                	sub    %eax,%esp
    for(int i = 0; i < depth+1; i++)
 b98:	31 c0                	xor    %eax,%eax
    int arr[depth+1];
 b9a:	89 e1                	mov    %esp,%ecx
 b9c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
        arr[i] = 0;
 ba0:	c7 04 81 00 00 00 00 	movl   $0x0,(%ecx,%eax,4)
    for(int i = 0; i < depth+1; i++)
 ba7:	83 c0 01             	add    $0x1,%eax
 baa:	39 c2                	cmp    %eax,%edx
 bac:	75 f2                	jne    ba0 <trnmnt_tree_alloc+0x50>
    create_tree(tree->root, depth+1);
 bae:	83 ec 08             	sub    $0x8,%esp
    level_index = arr;
 bb1:	89 0d dc 13 00 00    	mov    %ecx,0x13dc
    create_tree(tree->root, depth+1);
 bb7:	52                   	push   %edx
 bb8:	ff 36                	pushl  (%esi)
 bba:	e8 b1 fe ff ff       	call   a70 <create_tree>
    return tree;
...
void print_node(struct tree_node *n,int l){
 ...
 bec:	8b 5d 0c             	mov    0xc(%ebp),%ebx
	if(!n) return;
 bef:	85 f6                	test   %esi,%esi
 bf1:	74 5a                	je     c4d <print_node+0x6d>
    int i;
	print_node(n->right_child,l+1);
 bf3:	8d 43 01             	lea    0x1(%ebx),%eax
 bf6:	83 ec 08             	sub    $0x8,%esp
 bf9:	50                   	push   %eax
 bfa:	ff 76 04             	pushl  0x4(%esi)
 bfd:	89 45 e4             	mov    %eax,-0x1c(%ebp)
 c00:	e8 db ff ff ff       	call   be0 <print_node>
	for(i=0;i<l;++i){
 c05:	83 c4 10             	add    $0x10,%esp
 c08:	85 db                	test   %ebx,%ebx
 c0a:	7e 1d                	jle    c29 <print_node+0x49>
 c0c:	31 ff                	xor    %edi,%edi
 ...
 c13:	83 c7 01             	add    $0x1,%edi
		printf(1,"    ");
 c16:	68 e9 0e 00 00       	push   $0xee9
 c1b:	6a 01                	push   $0x1
 c1d:	e8 ee fa ff ff       	call   710 <printf>
	for(i=0;i<l;++i){
 c22:	83 c4 10             	add    $0x10,%esp
 c25:	39 df                	cmp    %ebx,%edi
 c27:	75 e7                	jne    c10 <print_node+0x30>
    }
	printf(1,"%d,%d,%d\n",n->level, n->index, n->mutex_id);
 c29:	83 ec 0c             	sub    $0xc,%esp
 c2c:	ff 76 0c             	pushl  0xc(%esi)
 c2f:	ff 76 10             	pushl  0x10(%esi)
 c32:	ff 76 14             	pushl  0x14(%esi)
 c35:	68 ee 0e 00 00       	push   $0xeee
 c3a:	6a 01                	push   $0x1
 c3c:	e8 cf fa ff ff       	call   710 <printf>
	print_node(n->left_child,l+1);
 c41:	8b 36                	mov    (%esi),%esi
	if(!n) return;
 c43:	83 c4 20             	add    $0x20,%esp
	print_node(n->left_child,l+1);
 c46:	8b 5d e4             	mov    -0x1c(%ebp),%ebx
	if(!n) return;
 c49:	85 f6                	test   %esi,%esi
 c4b:	75 a6                	jne    bf3 <print_node+0x13>
}
...
void print_tree(trnmnt_tree *t){
 ...
 c6b:	74 0f                	je     c7c <print_tree+0x1c>
	print_node(t->root,0);
 c6d:	83 ec 08             	sub    $0x8,%esp
 c70:	6a 00                	push   $0x0
 c72:	ff 30                	pushl  (%eax)
 c74:	e8 67 ff ff ff       	call   be0 <print_node>
...
int delete_node(struct tree_node *node){
 ...
 c89:	8b 5d 08             	mov    0x8(%ebp),%ebx
    if (node != 0){ 
 c8c:	85 db                	test   %ebx,%ebx
 c8e:	74 5e                	je     cee <delete_node+0x6e>
        if(kthread_mutex_dealloc(node->mutex_id) == -1){
 c90:	83 ec 0c             	sub    $0xc,%esp
 c93:	ff 73 0c             	pushl  0xc(%ebx)
 c96:	e8 af f9 ff ff       	call   64a <kthread_mutex_dealloc>
 c9b:	83 c4 10             	add    $0x10,%esp
 c9e:	83 f8 ff             	cmp    $0xffffffff,%eax
 ca1:	74 4b                	je     cee <delete_node+0x6e>
        delete_node(node->left_child); 
 ca3:	83 ec 0c             	sub    $0xc,%esp
 ca6:	ff 33                	pushl  (%ebx)
 ca8:	e8 d3 ff ff ff       	call   c80 <delete_node>
        delete_node(node->right_child); 
 cad:	58                   	pop    %eax
 cae:	ff 73 04             	pushl  0x4(%ebx)
 cb1:	e8 ca ff ff ff       	call   c80 <delete_node>
        if(node->lockPath){
 cb6:	8b 43 18             	mov    0x18(%ebx),%eax
 cb9:	83 c4 10             	add    $0x10,%esp
        node->left_child = 0;
 cbc:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
        node->right_child = 0;
 cc2:	c7 43 04 00 00 00 00 	movl   $0x0,0x4(%ebx)
        if(node->lockPath){
 cc9:	85 c0                	test   %eax,%eax
 ccb:	74 13                	je     ce0 <delete_node+0x60>
            free(node->lockPath);
 ccd:	83 ec 0c             	sub    $0xc,%esp
 cd0:	50                   	push   %eax
 cd1:	e8 0a fc ff ff       	call   8e0 <free>
            node->lockPath = 0;
 cd6:	c7 43 18 00 00 00 00 	movl   $0x0,0x18(%ebx)
 cdd:	83 c4 10             	add    $0x10,%esp
        free(node); 
 ce0:	83 ec 0c             	sub    $0xc,%esp
 ce3:	53                   	push   %ebx
 ce4:	e8 f7 fb ff ff       	call   8e0 <free>
 ce9:	83 c4 10             	add    $0x10,%esp
 cec:	31 c0                	xor    %eax,%eax
}
 cee:	8b 5d fc             	mov    -0x4(%ebp),%ebx
 cf1:	c9                   	leave  
 cf2:	c3                   	ret    
 cf3:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
 cf9:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi

00000d00 <trnmnt_tree_dealloc>:
...
int trnmnt_tree_dealloc(trnmnt_tree* tree){
 ...
 d0b:	ff 33                	pushl  (%ebx)
 d0d:	e8 6e ff ff ff       	call   c80 <delete_node>
 d12:	83 c4 10             	add    $0x10,%esp
 d15:	85 c0                	test   %eax,%eax
 d17:	75 27                	jne    d40 <trnmnt_tree_dealloc+0x40>
        tree->root = 0;
        free(tree);
 d19:	83 ec 0c             	sub    $0xc,%esp
        tree->root = 0;
 d1c:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
 d22:	89 c6                	mov    %eax,%esi
        free(tree);
 d24:	53                   	push   %ebx
 d25:	e8 b6 fb ff ff       	call   8e0 <free>
        tree = 0;
        return 0;
 ...
 d45:	eb e6                	jmp    d2d <trnmnt_tree_dealloc+0x2d>
...
struct tree_node* find_leaf(struct tree_node* node, int ID){
 ...
 d5c:	8b 5d 0c             	mov    0xc(%ebp),%ebx
    if(node->right_child == 0 && node->left_child == 0){ 
 d5f:	8b 72 04             	mov    0x4(%edx),%esi
 d62:	8b 02                	mov    (%edx),%eax
 d64:	85 f6                	test   %esi,%esi
 d66:	75 18                	jne    d80 <find_leaf+0x30>
 d68:	85 c0                	test   %eax,%eax
 d6a:	75 14                	jne    d80 <find_leaf+0x30>
        if(ID == node->index){
 d6c:	39 5a 10             	cmp    %ebx,0x10(%edx)
 d6f:	0f 44 c2             	cmove  %edx,%eax
        if(leaf1)
            return leaf1;
        else
            return leaf2;
 ...
 d83:	53                   	push   %ebx
 d84:	50                   	push   %eax
 d85:	e8 c6 ff ff ff       	call   d50 <find_leaf>
 d8a:	5a                   	pop    %edx
 d8b:	59                   	pop    %ecx
 ...
 d8d:	56                   	push   %esi
        struct tree_node* leaf1 = find_leaf(node->left_child, ID);
 d8e:	89 c7                	mov    %eax,%edi
        struct tree_node* leaf2 = find_leaf(node->right_child, ID);
 d90:	e8 bb ff ff ff       	call   d50 <find_leaf>
 d95:	83 c4 10             	add    $0x10,%esp
        if(leaf1)
 d98:	85 ff                	test   %edi,%edi
 d9a:	0f 45 c7             	cmovne %edi,%eax
} 
...
int trnmnt_tree_acquire(trnmnt_tree* tree,int ID){
 ...
 dbf:	ff 30                	pushl  (%eax)
 dc1:	e8 8a ff ff ff       	call   d50 <find_leaf>
 dc6:	8b 50 08             	mov    0x8(%eax),%edx
 dc9:	83 c4 10             	add    $0x10,%esp
 dcc:	89 c7                	mov    %eax,%edi
    while(curNode->parent){
 dce:	89 c3                	mov    %eax,%ebx
 dd0:	85 d2                	test   %edx,%edx
 dd2:	74 32                	je     e06 <trnmnt_tree_acquire+0x56>
        int level = curNode->parent->level;
 dd4:	8b 72 14             	mov    0x14(%edx),%esi
        int mutex_lock = kthread_mutex_lock(mutexID);
 dd7:	83 ec 0c             	sub    $0xc,%esp
 dda:	ff 72 0c             	pushl  0xc(%edx)
 ddd:	e8 70 f8 ff ff       	call   652 <kthread_mutex_lock>
        leaf->lockPath[level] = curNode->parent->mutex_id;
 de2:	8b 53 08             	mov    0x8(%ebx),%edx
        if(mutex_lock == -1){
 de5:	83 c4 10             	add    $0x10,%esp
 de8:	83 f8 ff             	cmp    $0xffffffff,%eax
        leaf->lockPath[level] = curNode->parent->mutex_id;
 deb:	8b 4a 0c             	mov    0xc(%edx),%ecx
 dee:	8b 57 18             	mov    0x18(%edi),%edx
 df1:	89 0c b2             	mov    %ecx,(%edx,%esi,4)
        if(mutex_lock == -1){
 df4:	74 12                	je     e08 <trnmnt_tree_acquire+0x58>
        if(mutex_lock == 0){
 df6:	85 c0                	test   %eax,%eax
 df8:	8b 53 08             	mov    0x8(%ebx),%edx
 dfb:	75 d3                	jne    dd0 <trnmnt_tree_acquire+0x20>
 dfd:	89 d3                	mov    %edx,%ebx
 dff:	8b 52 08             	mov    0x8(%edx),%edx
    while(curNode->parent){
 e02:	85 d2                	test   %edx,%edx
 e04:	75 ce                	jne    dd4 <trnmnt_tree_acquire+0x24>
    return 0;
...
int trnmnt_tree_release(trnmnt_tree* tree,int ID){
 ...
 e14:	56                   	push   %esi
 e15:	53                   	push   %ebx
 e16:	83 ec 14             	sub    $0x14,%esp
    struct tree_node* leaf = find_leaf(tree->root, ID);
 e19:	8b 45 08             	mov    0x8(%ebp),%eax
 e1c:	ff 75 0c             	pushl  0xc(%ebp)
 e1f:	ff 30                	pushl  (%eax)
 e21:	e8 2a ff ff ff       	call   d50 <find_leaf>
    for(int i = treeDepth-1; i >= 0; i--){
 e26:	8b 35 d8 13 00 00    	mov    0x13d8,%esi
    struct tree_node* leaf = find_leaf(tree->root, ID);
 e2c:	83 c4 10             	add    $0x10,%esp
    for(int i = treeDepth-1; i >= 0; i--){
 e2f:	83 ee 01             	sub    $0x1,%esi
 e32:	78 44                	js     e78 <trnmnt_tree_release+0x68>
 e34:	89 c7                	mov    %eax,%edi
 e36:	8d 1c b5 00 00 00 00 	lea    0x0(,%esi,4),%ebx
 e3d:	eb 16                	jmp    e55 <trnmnt_tree_release+0x45>
 e3f:	90                   	nop
        leaf->lockPath[i] = 0;
 e40:	8b 47 18             	mov    0x18(%edi),%eax
    for(int i = treeDepth-1; i >= 0; i--){
 e43:	83 ee 01             	sub    $0x1,%esi
        leaf->lockPath[i] = 0;
 e46:	c7 04 18 00 00 00 00 	movl   $0x0,(%eax,%ebx,1)
 e4d:	83 eb 04             	sub    $0x4,%ebx
    for(int i = treeDepth-1; i >= 0; i--){
 e50:	83 fe ff             	cmp    $0xffffffff,%esi
 e53:	74 23                	je     e78 <trnmnt_tree_release+0x68>
        int res = kthread_mutex_unlock(leaf->lockPath[i]);
 e55:	8b 47 18             	mov    0x18(%edi),%eax
 e58:	83 ec 0c             	sub    $0xc,%esp
 e5b:	ff 34 18             	pushl  (%eax,%ebx,1)
 e5e:	e8 f7 f7 ff ff       	call   65a <kthread_mutex_unlock>
        if(res == -1){
 e63:	83 c4 10             	add    $0x10,%esp
 e66:	83 f8 ff             	cmp    $0xffffffff,%eax
 e69:	75 d5                	jne    e40 <trnmnt_tree_release+0x30>
}
 e6b:	8d 65 f4             	lea    -0xc(%ebp),%esp
 e6e:	5b                   	pop    %ebx
 e6f:	5e                   	pop    %esi
 e70:	5f                   	pop    %edi
 e71:	5d                   	pop    %ebp

 ...
 489:	85 d2                	test   %edx,%edx
{
 ...
 4b7:	f7 f1                	div    %ecx
 4b9:	0f b6 92 c0 0c 00 00 	movzbl 0xcc0(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, const char *fmt, ...)
{
 ...
 6d4:	e9 8f fe ff ff       	jmp    568 <printf+0x48>
          s = "(null)";
 6d9:	bb b7 0c 00 00       	mov    $0xcb7,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 6f1:	a1 30 11 00 00       	mov    0x1130,%eax
{
 ...
 72d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 72f:	a3 30 11 00 00       	mov    %eax,0x1130
}
 734:	5b                   	pop    %ebx
 735:	5e                   	pop    %esi
 736:	5f                   	pop    %edi
 ...
 746:	72 ce                	jb     716 <free+0x26>
{
 ...
 767:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 76a:	a3 30 11 00 00       	mov    %eax,0x1130
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 789:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 78c:	8b 15 30 11 00 00    	mov    0x1130,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7cf:	73 47                	jae    818 <malloc+0x98>
    ...
    if(p == freep)
 7d1:	39 05 30 11 00 00    	cmp    %eax,0x1130
 ...
 7f6:	e8 f5 fe ff ff       	call   6f0 <free>
  return freep;
 7fb:	8b 15 30 11 00 00    	mov    0x1130,%edx
 ...
 824:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 827:	89 15 30 11 00 00    	mov    %edx,0x1130
}
 ...
 839:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 840:	c7 05 30 11 00 00 34 	movl   $0x1134,0x1130
 847:	11 00 00 
 84a:	c7 05 34 11 00 00 34 	movl   $0x1134,0x1134
 851:	11 00 00 
    base.s.size = 0;
 854:	b8 34 11 00 00       	mov    $0x1134,%eax
 859:	c7 05 38 11 00 00 00 	movl   $0x0,0x1138
 860:	00 00 00 
...
void create_tree(struct tree_node* node, int depth){
 ...
 88c:	8b 5d 08             	mov    0x8(%ebp),%ebx
    if(depth == 0){
 88f:	85 f6                	test   %esi,%esi
 891:	0f 84 8a 00 00 00    	je     921 <create_tree+0xa1>
 897:	8d 04 b5 fc ff ff ff 	lea    -0x4(,%esi,4),%eax
 89e:	89 45 e4             	mov    %eax,-0x1c(%ebp)
 8a1:	8d 4e fe             	lea    -0x2(%esi),%ecx
 8a4:	8b 55 e4             	mov    -0x1c(%ebp),%edx
 8a7:	03 15 44 11 00 00    	add    0x1144,%edx
        return;
    }
    if(curLevel != depth-2){
 8ad:	39 0d 2c 11 00 00    	cmp    %ecx,0x112c
 8b3:	a1 3c 11 00 00       	mov    0x113c,%eax
 8b8:	74 08                	je     8c2 <create_tree+0x42>
        index = level_index[depth-1];
 8ba:	8b 02                	mov    (%edx),%eax
        curLevel = depth-2;
 8bc:	89 0d 2c 11 00 00    	mov    %ecx,0x112c
    }
    node->level = curLevel;
    node->index = index;
 8c2:	89 43 10             	mov    %eax,0x10(%ebx)
    index++;
 8c5:	83 c0 01             	add    $0x1,%eax
    level_index[depth-1] = index;
    if(depth == 1){
 8c8:	83 fe 01             	cmp    $0x1,%esi
    node->level = curLevel;
 8cb:	89 4b 14             	mov    %ecx,0x14(%ebx)
    index++;
 8ce:	a3 3c 11 00 00       	mov    %eax,0x113c
    level_index[depth-1] = index;
 8d3:	89 02                	mov    %eax,(%edx)
    if(depth == 1){
 8d5:	74 59                	je     930 <create_tree+0xb0>
        node->left_child = 0;
        node->right_child = 0;
 ...
 8da:	83 ee 01             	sub    $0x1,%esi
        struct tree_node *left = malloc(sizeof(struct tree_node));
 8dd:	6a 1c                	push   $0x1c
 8df:	e8 9c fe ff ff       	call   780 <malloc>
 8e4:	89 c7                	mov    %eax,%edi
        struct tree_node *right = malloc(sizeof(struct tree_node));
 8e6:	c7 04 24 1c 00 00 00 	movl   $0x1c,(%esp)
 8ed:	e8 8e fe ff ff       	call   780 <malloc>
        left->parent = node;
 8f2:	89 5f 08             	mov    %ebx,0x8(%edi)
        right->parent = node;
 8f5:	89 58 08             	mov    %ebx,0x8(%eax)
        node->left_child = left;
 8f8:	89 3b                	mov    %edi,(%ebx)
        node->right_child = right;
 8fa:	89 43 04             	mov    %eax,0x4(%ebx)
 8fd:	89 45 e0             	mov    %eax,-0x20(%ebp)
        node->mutex_id = kthread_mutex_alloc();
 900:	e8 4d fb ff ff       	call   452 <kthread_mutex_alloc>
 905:	89 43 0c             	mov    %eax,0xc(%ebx)
        create_tree(left, depth-1);
 908:	58                   	pop    %eax
 909:	5a                   	pop    %edx
 90a:	56                   	push   %esi
 90b:	57                   	push   %edi
 90c:	e8 6f ff ff ff       	call   880 <create_tree>
 911:	8b 55 e0             	mov    -0x20(%ebp),%edx
 914:	83 6d e4 04          	subl   $0x4,-0x1c(%ebp)
    if(depth == 0){
 918:	83 c4 10             	add    $0x10,%esp
 91b:	85 f6                	test   %esi,%esi
 91d:	89 d3                	mov    %edx,%ebx
 91f:	75 80                	jne    8a1 <create_tree+0x21>
 ...
 929:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
        node->left_child = 0;
 930:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
        node->lockPath = (int*)malloc(treeDepth*sizeof(int));
 936:	a1 40 11 00 00       	mov    0x1140,%eax
 93b:	83 ec 0c             	sub    $0xc,%esp
        node->right_child = 0;
 93e:	c7 43 04 00 00 00 00 	movl   $0x0,0x4(%ebx)
        node->lockPath = (int*)malloc(treeDepth*sizeof(int));
 945:	c1 e0 02             	shl    $0x2,%eax
 948:	50                   	push   %eax
 949:	e8 32 fe ff ff       	call   780 <malloc>
 94e:	83 c4 10             	add    $0x10,%esp
 951:	89 43 18             	mov    %eax,0x18(%ebx)
}
...
trnmnt_tree* trnmnt_tree_alloc(int depth){
 ...
 96a:	7e 74                	jle    9e0 <trnmnt_tree_alloc+0x80>
    trnmnt_tree *tree = malloc(sizeof(trnmnt_tree));
 96c:	83 ec 0c             	sub    $0xc,%esp
 96f:	6a 08                	push   $0x8
 971:	e8 0a fe ff ff       	call   780 <malloc>
    struct tree_node *root = malloc(sizeof(struct tree_node));
 976:	c7 04 24 1c 00 00 00 	movl   $0x1c,(%esp)
    trnmnt_tree *tree = malloc(sizeof(trnmnt_tree));
 97d:	89 c6                	mov    %eax,%esi
    struct tree_node *root = malloc(sizeof(struct tree_node));
 97f:	e8 fc fd ff ff       	call   780 <malloc>
    int arr[depth+1];
 984:	8d 53 01             	lea    0x1(%ebx),%edx
    treeDepth = depth;
 987:	89 1d 40 11 00 00    	mov    %ebx,0x1140
    tree->depth = depth;
 98d:	89 5e 04             	mov    %ebx,0x4(%esi)
    tree->root = root;
 990:	89 06                	mov    %eax,(%esi)
    root->parent = 0;
 992:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
    int arr[depth+1];
 999:	83 c4 10             	add    $0x10,%esp
 99c:	8d 04 95 12 00 00 00 	lea    0x12(,%edx,4),%eax
 9a3:	83 e0 f0             	and    $0xfffffff0,%eax
 9a6:	29 c4                	sub    %eax,%esp
    for(int i = 0; i < depth+1; i++)
 9a8:	31 c0                	xor    %eax,%eax
    int arr[depth+1];
 9aa:	89 e1                	mov    %esp,%ecx
 9ac:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
        arr[i] = 0;
 9b0:	c7 04 81 00 00 00 00 	movl   $0x0,(%ecx,%eax,4)
    for(int i = 0; i < depth+1; i++)
 9b7:	83 c0 01             	add    $0x1,%eax
 9ba:	39 c2                	cmp    %eax,%edx
 9bc:	75 f2                	jne    9b0 <trnmnt_tree_alloc+0x50>
    create_tree(tree->root, depth+1);
 9be:	83 ec 08             	sub    $0x8,%esp
    level_index = arr;
 9c1:	89 0d 44 11 00 00    	mov    %ecx,0x1144
    create_tree(tree->root, depth+1);
 9c7:	52                   	push   %edx
 9c8:	ff 36                	pushl  (%esi)
 9ca:	e8 b1 fe ff ff       	call   880 <create_tree>
    return tree;
...
void print_node(struct tree_node *n,int l){
 ...
 9fc:	8b 5d 0c             	mov    0xc(%ebp),%ebx
	if(!n) return;
 9ff:	85 f6                	test   %esi,%esi
 a01:	74 5a                	je     a5d <print_node+0x6d>
    int i;
	print_node(n->right_child,l+1);
 a03:	8d 43 01             	lea    0x1(%ebx),%eax
 a06:	83 ec 08             	sub    $0x8,%esp
 a09:	50                   	push   %eax
 a0a:	ff 76 04             	pushl  0x4(%esi)
 a0d:	89 45 e4             	mov    %eax,-0x1c(%ebp)
 a10:	e8 db ff ff ff       	call   9f0 <print_node>
	for(i=0;i<l;++i){
 a15:	83 c4 10             	add    $0x10,%esp
 a18:	85 db                	test   %ebx,%ebx
 a1a:	7e 1d                	jle    a39 <print_node+0x49>
 ...
 a23:	83 c7 01             	add    $0x1,%edi
		printf(1,"    ");
 a26:	68 d1 0c 00 00       	push   $0xcd1
 a2b:	6a 01                	push   $0x1
 a2d:	e8 ee fa ff ff       	call   520 <printf>
	for(i=0;i<l;++i){
 a32:	83 c4 10             	add    $0x10,%esp
 a35:	39 df                	cmp    %ebx,%edi
 a37:	75 e7                	jne    a20 <print_node+0x30>
    }
	printf(1,"%d,%d,%d\n",n->level, n->index, n->mutex_id);
 a39:	83 ec 0c             	sub    $0xc,%esp
 a3c:	ff 76 0c             	pushl  0xc(%esi)
 a3f:	ff 76 10             	pushl  0x10(%esi)
 a42:	ff 76 14             	pushl  0x14(%esi)
 a45:	68 d6 0c 00 00       	push   $0xcd6
 a4a:	6a 01                	push   $0x1
 a4c:	e8 cf fa ff ff       	call   520 <printf>
	print_node(n->left_child,l+1);
 a51:	8b 36                	mov    (%esi),%esi
	if(!n) return;
 a53:	83 c4 20             	add    $0x20,%esp
	print_node(n->left_child,l+1);
 a56:	8b 5d e4             	mov    -0x1c(%ebp),%ebx
	if(!n) return;
 a59:	85 f6                	test   %esi,%esi
 a5b:	75 a6                	jne    a03 <print_node+0x13>
}
...
void print_tree(trnmnt_tree *t){
 ...
 a7b:	74 0f                	je     a8c <print_tree+0x1c>
	print_node(t->root,0);
 a7d:	83 ec 08             	sub    $0x8,%esp
 a80:	6a 00                	push   $0x0
 a82:	ff 30                	pushl  (%eax)
 a84:	e8 67 ff ff ff       	call   9f0 <print_node>
...
int delete_node(struct tree_node *node){
 ...
 a99:	8b 5d 08             	mov    0x8(%ebp),%ebx
    if (node != 0){ 
 a9c:	85 db                	test   %ebx,%ebx
 a9e:	74 5e                	je     afe <delete_node+0x6e>
        if(kthread_mutex_dealloc(node->mutex_id) == -1){
 aa0:	83 ec 0c             	sub    $0xc,%esp
 aa3:	ff 73 0c             	pushl  0xc(%ebx)
 aa6:	e8 af f9 ff ff       	call   45a <kthread_mutex_dealloc>
 aab:	83 c4 10             	add    $0x10,%esp
 aae:	83 f8 ff             	cmp    $0xffffffff,%eax
 ab1:	74 4b                	je     afe <delete_node+0x6e>
        delete_node(node->left_child); 
 ab3:	83 ec 0c             	sub    $0xc,%esp
 ab6:	ff 33                	pushl  (%ebx)
 ab8:	e8 d3 ff ff ff       	call   a90 <delete_node>
        delete_node(node->right_child); 
 abd:	58                   	pop    %eax
 abe:	ff 73 04             	pushl  0x4(%ebx)
 ac1:	e8 ca ff ff ff       	call   a90 <delete_node>
        if(node->lockPath){
 ac6:	8b 43 18             	mov    0x18(%ebx),%eax
 ac9:	83 c4 10             	add    $0x10,%esp
        node->left_child = 0;
 acc:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
        node->right_child = 0;
 ad2:	c7 43 04 00 00 00 00 	movl   $0x0,0x4(%ebx)
        if(node->lockPath){
 ad9:	85 c0                	test   %eax,%eax
 adb:	74 13                	je     af0 <delete_node+0x60>
            free(node->lockPath);
 add:	83 ec 0c             	sub    $0xc,%esp
 ae0:	50                   	push   %eax
 ae1:	e8 0a fc ff ff       	call   6f0 <free>
            node->lockPath = 0;
 ae6:	c7 43 18 00 00 00 00 	movl   $0x0,0x18(%ebx)
 aed:	83 c4 10             	add    $0x10,%esp
        free(node); 
 af0:	83 ec 0c             	sub    $0xc,%esp
 af3:	53                   	push   %ebx
 af4:	e8 f7 fb ff ff       	call   6f0 <free>
 af9:	83 c4 10             	add    $0x10,%esp
 afc:	31 c0                	xor    %eax,%eax
}
 afe:	8b 5d fc             	mov    -0x4(%ebp),%ebx
 b01:	c9                   	leave  
 b02:	c3                   	ret    
 b03:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
 b09:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi

00000b10 <trnmnt_tree_dealloc>:
...
int trnmnt_tree_dealloc(trnmnt_tree* tree){
 ...
 b1b:	ff 33                	pushl  (%ebx)
 b1d:	e8 6e ff ff ff       	call   a90 <delete_node>
 b22:	83 c4 10             	add    $0x10,%esp
 b25:	85 c0                	test   %eax,%eax
 b27:	75 27                	jne    b50 <trnmnt_tree_dealloc+0x40>
        tree->root = 0;
        free(tree);
 b29:	83 ec 0c             	sub    $0xc,%esp
        tree->root = 0;
 b2c:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
 b32:	89 c6                	mov    %eax,%esi
        free(tree);
 b34:	53                   	push   %ebx
 b35:	e8 b6 fb ff ff       	call   6f0 <free>
        tree = 0;
        return 0;
 ...
 b49:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
        return -1;
 b50:	be ff ff ff ff       	mov    $0xffffffff,%esi
 b55:	eb e6                	jmp    b3d <trnmnt_tree_dealloc+0x2d>
...
struct tree_node* find_leaf(struct tree_node* node, int ID){
 ...
 b6f:	8b 72 04             	mov    0x4(%edx),%esi
 b72:	8b 02                	mov    (%edx),%eax
 b74:	85 f6                	test   %esi,%esi
 b76:	75 18                	jne    b90 <find_leaf+0x30>
 b78:	85 c0                	test   %eax,%eax
 b7a:	75 14                	jne    b90 <find_leaf+0x30>
        if(ID == node->index){
 b7c:	39 5a 10             	cmp    %ebx,0x10(%edx)
 b7f:	0f 44 c2             	cmove  %edx,%eax
        if(leaf1)
            return leaf1;
        else
            return leaf2;
 ...
 b93:	53                   	push   %ebx
 b94:	50                   	push   %eax
 b95:	e8 c6 ff ff ff       	call   b60 <find_leaf>
 b9a:	5a                   	pop    %edx
 b9b:	59                   	pop    %ecx
 ...
 b9e:	89 c7                	mov    %eax,%edi
        struct tree_node* leaf2 = find_leaf(node->right_child, ID);
 ba0:	e8 bb ff ff ff       	call   b60 <find_leaf>
 ba5:	83 c4 10             	add    $0x10,%esp
        if(leaf1)
 ba8:	85 ff                	test   %edi,%edi
 baa:	0f 45 c7             	cmovne %edi,%eax
} 
...
int trnmnt_tree_acquire(trnmnt_tree* tree,int ID){
 ...
 bcf:	ff 30                	pushl  (%eax)
 bd1:	e8 8a ff ff ff       	call   b60 <find_leaf>
 bd6:	8b 50 08             	mov    0x8(%eax),%edx
 bd9:	83 c4 10             	add    $0x10,%esp
 bdc:	89 c7                	mov    %eax,%edi
    while(curNode->parent){
 bde:	89 c3                	mov    %eax,%ebx
 be0:	85 d2                	test   %edx,%edx
 be2:	74 32                	je     c16 <trnmnt_tree_acquire+0x56>
        int level = curNode->parent->level;
 be4:	8b 72 14             	mov    0x14(%edx),%esi
        int mutex_lock = kthread_mutex_lock(mutexID);
 be7:	83 ec 0c             	sub    $0xc,%esp
 bea:	ff 72 0c             	pushl  0xc(%edx)
 bed:	e8 70 f8 ff ff       	call   462 <kthread_mutex_lock>
        leaf->lockPath[level] = curNode->parent->mutex_id;
 bf2:	8b 53 08             	mov    0x8(%ebx),%edx
        if(mutex_lock == -1){
 bf5:	83 c4 10             	add    $0x10,%esp
 bf8:	83 f8 ff             	cmp    $0xffffffff,%eax
        leaf->lockPath[level] = curNode->parent->mutex_id;
 bfb:	8b 4a 0c             	mov    0xc(%edx),%ecx
 bfe:	8b 57 18             	mov    0x18(%edi),%edx
 c01:	89 0c b2             	mov    %ecx,(%edx,%esi,4)
        if(mutex_lock == -1){
 c04:	74 12                	je     c18 <trnmnt_tree_acquire+0x58>
        if(mutex_lock == 0){
 c06:	85 c0                	test   %eax,%eax
 c08:	8b 53 08             	mov    0x8(%ebx),%edx
 c0b:	75 d3                	jne    be0 <trnmnt_tree_acquire+0x20>
 c0d:	89 d3                	mov    %edx,%ebx
 c0f:	8b 52 08             	mov    0x8(%edx),%edx
    while(curNode->parent){
 c12:	85 d2                	test   %edx,%edx
 c14:	75 ce                	jne    be4 <trnmnt_tree_acquire+0x24>
    return 0;
 c16:	31 c0                	xor    %eax,%eax
}
...
int trnmnt_tree_release(trnmnt_tree* tree,int ID){
 ...
 c24:	56                   	push   %esi
 c25:	53                   	push   %ebx
 c26:	83 ec 14             	sub    $0x14,%esp
    struct tree_node* leaf = find_leaf(tree->root, ID);
 c29:	8b 45 08             	mov    0x8(%ebp),%eax
 c2c:	ff 75 0c             	pushl  0xc(%ebp)
 c2f:	ff 30                	pushl  (%eax)
 c31:	e8 2a ff ff ff       	call   b60 <find_leaf>
    for(int i = treeDepth-1; i >= 0; i--){
 c36:	8b 35 40 11 00 00    	mov    0x1140,%esi
    struct tree_node* leaf = find_leaf(tree->root, ID);
 c3c:	83 c4 10             	add    $0x10,%esp
    for(int i = treeDepth-1; i >= 0; i--){
 c3f:	83 ee 01             	sub    $0x1,%esi
 c42:	78 44                	js     c88 <trnmnt_tree_release+0x68>
 c44:	89 c7                	mov    %eax,%edi
 c46:	8d 1c b5 00 00 00 00 	lea    0x0(,%esi,4),%ebx
 c4d:	eb 16                	jmp    c65 <trnmnt_tree_release+0x45>
 c4f:	90                   	nop
        leaf->lockPath[i] = 0;
 c50:	8b 47 18             	mov    0x18(%edi),%eax
    for(int i = treeDepth-1; i >= 0; i--){
 c53:	83 ee 01             	sub    $0x1,%esi
        leaf->lockPath[i] = 0;
 c56:	c7 04 18 00 00 00 00 	movl   $0x0,(%eax,%ebx,1)
 c5d:	83 eb 04             	sub    $0x4,%ebx
    for(int i = treeDepth-1; i >= 0; i--){
 c60:	83 fe ff             	cmp    $0xffffffff,%esi
 c63:	74 23                	je     c88 <trnmnt_tree_release+0x68>
        int res = kthread_mutex_unlock(leaf->lockPath[i]);
 c65:	8b 47 18             	mov    0x18(%edi),%eax
 c68:	83 ec 0c             	sub    $0xc,%esp
 c6b:	ff 34 18             	pushl  (%eax,%ebx,1)
 c6e:	e8 f7 f7 ff ff       	call   46a <kthread_mutex_unlock>
        if(res == -1){
 c73:	83 c4 10             	add    $0x10,%esp
 c76:	83 f8 ff             	cmp    $0xffffffff,%eax
 c79:	75 d5                	jne    c50 <trnmnt_tree_release+0x30>
}

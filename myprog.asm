...
main(int argc, char *argv[])
{
  ...
  12:	68 a0 0f 00 00       	push   $0xfa0
  17:	e8 94 07 00 00       	call   7b0 <malloc>
  1c:	89 c3                	mov    %eax,%ebx
	void(*start_func)();
	start_func = (void*)run;
	int pid = getpid();
  1e:	e8 3f 04 00 00       	call   462 <getpid>
	printf(1, "%d\n",pid);
  23:	83 c4 0c             	add    $0xc,%esp
  26:	50                   	push   %eax
  27:	68 de 08 00 00       	push   $0x8de
  2c:	6a 01                	push   $0x1
  2e:	e8 1d 05 00 00       	call   550 <printf>
    printf(1, "start_func address: %d\n", start_func);
  33:	83 c4 0c             	add    $0xc,%esp
  36:	68 a0 00 00 00       	push   $0xa0
  3b:	68 26 09 00 00       	push   $0x926
  40:	6a 01                	push   $0x1
  42:	e8 09 05 00 00       	call   550 <printf>
	int tid = kthread_create(start_func, stack);
  47:	58                   	pop    %eax
  48:	5a                   	pop    %edx
  49:	53                   	push   %ebx
  4a:	68 a0 00 00 00       	push   $0xa0
  4f:	e8 2e 04 00 00       	call   482 <kthread_create>
  54:	89 c3                	mov    %eax,%ebx
	//int rest = kthread_join(tid);
	int rest = 0;
    sleep(50000);
  56:	c7 04 24 50 c3 00 00 	movl   $0xc350,(%esp)
  5d:	e8 10 04 00 00       	call   472 <sleep>
	printf(1, "result: %d, tid: %d\n", rest, tid);
  62:	53                   	push   %ebx
  63:	6a 00                	push   $0x0
  65:	68 3e 09 00 00       	push   $0x93e
  6a:	6a 01                	push   $0x1
  6c:	e8 df 04 00 00       	call   550 <printf>
    exit();
  71:	83 c4 20             	add    $0x20,%esp
  74:	e8 69 03 00 00       	call   3e2 <exit>
  79:	66 90                	xchg   %ax,%ax
  7b:	66 90                	xchg   %ax,%ax
  7d:	66 90                	xchg   %ax,%ax
  7f:	90                   	nop

00000080 <printSomething>:
printSomething(){
  80:	55                   	push   %ebp
  81:	89 e5                	mov    %esp,%ebp
  83:	83 ec 10             	sub    $0x10,%esp
    printf(1,"\nhello\n");
  86:	68 a8 08 00 00       	push   $0x8a8
  8b:	6a 01                	push   $0x1
...
run(){
  ...
  a4:	53                   	push   %ebx
	int id = kthread_id();
  a5:	e8 e0 03 00 00       	call   48a <kthread_id>
  aa:	89 c6                	mov    %eax,%esi
	int pid = getpid();
  ac:	e8 b1 03 00 00       	call   462 <getpid>
	printf(1, "my id: %d\n", id);
  ...
  cc:	6a 01                	push   $0x1
  ce:	e8 7d 04 00 00       	call   550 <printf>
	printf(1,"hey");
  d3:	58                   	pop    %eax
  d4:	5a                   	pop    %edx
  d5:	68 c7 08 00 00       	push   $0x8c7
  da:	6a 01                	push   $0x1
...
exitTest(){
 ...
 int pid = fork();
  f6:	e8 df 02 00 00       	call   3da <fork>
    if(pid == 0){
  fb:	85 c0                	test   %eax,%eax
  fd:	75 33                	jne    132 <exitTest+0x42>
        int tid1 = kthread_id();
  ff:	e8 86 03 00 00       	call   48a <kthread_id>
        printf(1, "child - thread id: %d\n", tid1);
 104:	51                   	push   %ecx
 105:	50                   	push   %eax
 106:	68 cb 08 00 00       	push   $0x8cb
 10b:	6a 01                	push   $0x1
 10d:	e8 3e 04 00 00       	call   550 <printf>
        kthread_exit();
 112:	e8 7b 03 00 00       	call   492 <kthread_exit>
        printf(1, "exited thread\n");
 117:	58                   	pop    %eax
 118:	5a                   	pop    %edx
 119:	68 e2 08 00 00       	push   $0x8e2
 11e:	6a 01                	push   $0x1
 120:	e8 2b 04 00 00       	call   550 <printf>
 125:	83 c4 10             	add    $0x10,%esp
    wait();
 128:	e8 bd 02 00 00       	call   3ea <wait>
    exit();
 12d:	e8 b0 02 00 00       	call   3e2 <exit>
        int tid2 = kthread_id();
 132:	e8 53 03 00 00       	call   48a <kthread_id>
        printf(1, "parent - thread id: %d\n", tid2);
 137:	52                   	push   %edx
 138:	50                   	push   %eax
 139:	68 f1 08 00 00       	push   $0x8f1
 13e:	6a 01                	push   $0x1
 140:	e8 0b 04 00 00       	call   550 <printf>
 145:	83 c4 10             	add    $0x10,%esp
 148:	eb de                	jmp    128 <exitTest+0x38>
 14a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi

00000150 <createThreadsTest>:
createThreadsTest(){
 150:	55                   	push   %ebp
 ...
 157:	68 a0 0f 00 00       	push   $0xfa0
 15c:	e8 4f 06 00 00       	call   7b0 <malloc>
    printf(1,"func address from myprog %d\n", (void*)kthread_id);
 161:	83 c4 0c             	add    $0xc,%esp
    char* stackPointer = (char*)malloc(4000);
 164:	89 c3                	mov    %eax,%ebx
    printf(1,"func address from myprog %d\n", (void*)kthread_id);
 166:	68 8a 04 00 00       	push   $0x48a
 16b:	68 09 09 00 00       	push   $0x909
 170:	6a 01                	push   $0x1
 172:	e8 d9 03 00 00       	call   550 <printf>
    kthread_create(start_func,stackPointer);
 177:	58                   	pop    %eax
 178:	5a                   	pop    %edx
 179:	53                   	push   %ebx
 17a:	68 80 00 00 00       	push   $0x80
 17f:	e8 fe 02 00 00       	call   482 <kthread_create>
}
...
00000492 <kthread_exit>:
SYSCALL(kthread_exit)
 492:	b8 18 00 00 00       	mov    $0x18,%eax
 497:	cd 40                	int    $0x40
 499:	c3                   	ret    

0000049a <kthread_join>:
 ...
 4b9:	85 d2                	test   %edx,%edx
{
 ...
 4e7:	f7 f1                	div    %ecx
 4e9:	0f b6 92 5c 09 00 00 	movzbl 0x95c(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, const char *fmt, ...)
{
 ...
 704:	e9 8f fe ff ff       	jmp    598 <printf+0x48>
          s = "(null)";
 709:	bb 53 09 00 00       	mov    $0x953,%ebx
        while(*s != 0){
 ...
 721:	a1 8c 0c 00 00       	mov    0xc8c,%eax
{
 ...
 75d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 75f:	a3 8c 0c 00 00       	mov    %eax,0xc8c
}
 764:	5b                   	pop    %ebx
 765:	5e                   	pop    %esi
 766:	5f                   	pop    %edi
 ...
 776:	72 ce                	jb     746 <free+0x26>
{
 ...
 797:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 79a:	a3 8c 0c 00 00       	mov    %eax,0xc8c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 7b9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 7bc:	8b 15 8c 0c 00 00    	mov    0xc8c,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7ff:	73 47                	jae    848 <malloc+0x98>
    ...
    if(p == freep)
 801:	39 05 8c 0c 00 00    	cmp    %eax,0xc8c
 ...
 826:	e8 f5 fe ff ff       	call   720 <free>
  return freep;
 82b:	8b 15 8c 0c 00 00    	mov    0xc8c,%edx
 ...
 854:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 857:	89 15 8c 0c 00 00    	mov    %edx,0xc8c
}
 ...
 877:	0c 00 00 
 87a:	c7 05 90 0c 00 00 90 	movl   $0xc90,0xc90
 881:	0c 00 00 
    base.s.size = 0;
 884:	b8 90 0c 00 00       	mov    $0xc90,%eax
 889:	c7 05 94 0c 00 00 00 	movl   $0x0,0xc94
 890:	00 00 00 

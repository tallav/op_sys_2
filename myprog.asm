...
main(int argc, char *argv[])
{
  ...
  18:	75 33                	jne    4d <main+0x4d>
        int tid1 = kthread_id();
  1a:	e8 4b 03 00 00       	call   36a <kthread_id>
        printf(1, "child - thread id: %d\n", tid1);
  1f:	51                   	push   %ecx
  20:	50                   	push   %eax
  21:	68 88 07 00 00       	push   $0x788
  26:	6a 01                	push   $0x1
  28:	e8 03 04 00 00       	call   430 <printf>
        kthread_exit();
  2d:	e8 40 03 00 00       	call   372 <kthread_exit>
        printf(1, "exited thread\n");
  32:	58                   	pop    %eax
  33:	5a                   	pop    %edx
  34:	68 9f 07 00 00       	push   $0x79f
  39:	6a 01                	push   $0x1
  ...
  40:	83 c4 10             	add    $0x10,%esp
    ...
    wait();
  43:	e8 82 02 00 00       	call   2ca <wait>
    exit();
  48:	e8 75 02 00 00       	call   2c2 <exit>
        int tid2 = kthread_id();
  4d:	e8 18 03 00 00       	call   36a <kthread_id>
        printf(1, "parent - thread id: %d\n", tid2);
  52:	52                   	push   %edx
  53:	50                   	push   %eax
  54:	68 ae 07 00 00       	push   $0x7ae
  59:	6a 01                	push   $0x1
  5b:	e8 d0 03 00 00       	call   430 <printf>
  60:	83 c4 10             	add    $0x10,%esp
  63:	eb de                	jmp    43 <main+0x43>
  65:	66 90                	xchg   %ax,%ax
  67:	66 90                	xchg   %ax,%ax
  69:	66 90                	xchg   %ax,%ax
  6b:	66 90                	xchg   %ax,%ax
...
printf(int fd, const char *fmt, ...)
{
 ...
 5e4:	e9 8f fe ff ff       	jmp    478 <printf+0x48>
          s = "(null)";
 5e9:	bb c6 07 00 00       	mov    $0x7c6,%ebx
        while(*s != 0){

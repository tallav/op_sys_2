...
main(int argc, char *argv[])
{
   ...
   e:	83 ec 04             	sub    $0x4,%esp
    test_kthread_create();
  11:	e8 3a 00 00 00       	call   50 <test_kthread_create>
    //test_kthread_exit();

    printf(1, "finish\n");
  16:	83 ec 08             	sub    $0x8,%esp
  19:	68 e1 07 00 00       	push   $0x7e1
  1e:	6a 01                	push   $0x1
  20:	e8 4b 04 00 00       	call   470 <printf>
    exit();
  25:	e8 d8 02 00 00       	call   302 <exit>
  2a:	66 90                	xchg   %ax,%ax
  2c:	66 90                	xchg   %ax,%ax
  2e:	66 90                	xchg   %ax,%ax
...
int printSomthing(){
  ...
  33:	83 ec 10             	sub    $0x10,%esp
    printf(1,"\n HELLO \n");
  36:	68 c8 07 00 00       	push   $0x7c8
  3b:	6a 01                	push   $0x1
  3d:	e8 2e 04 00 00       	call   470 <printf>
}
...
00000050 <test_kthread_create>:
void test_kthread_create(){
  50:	55                   	push   %ebp
  51:	89 e5                	mov    %esp,%ebp
  53:	83 ec 14             	sub    $0x14,%esp
    char* ustack = (char*)malloc(4000);
  56:	68 a0 0f 00 00       	push   $0xfa0
  5b:	e8 70 06 00 00       	call   6d0 <malloc>
    kthread_create(&printSomthing, ustack);
  60:	5a                   	pop    %edx
  61:	59                   	pop    %ecx
  62:	50                   	push   %eax
  63:	68 30 00 00 00       	push   $0x30
  68:	e8 35 03 00 00       	call   3a2 <kthread_create>
}
...
00000080 <test_kthread_exit>:
void test_kthread_exit(){
  80:	55                   	push   %ebp
  81:	89 e5                	mov    %esp,%ebp
  83:	83 ec 08             	sub    $0x8,%esp
    int tid = kthread_id();
  86:	e8 1f 03 00 00       	call   3aa <kthread_id>
    printf(1, "thread id: %d\n", tid);
  8b:	83 ec 04             	sub    $0x4,%esp
  8e:	50                   	push   %eax
  8f:	68 d2 07 00 00       	push   $0x7d2
  94:	6a 01                	push   $0x1
  ...
  9e:	c9                   	leave  
    kthread_exit();
  9f:	e9 0e 03 00 00       	jmp    3b2 <kthread_exit>
  a4:	66 90                	xchg   %ax,%ax
  a6:	66 90                	xchg   %ax,%ax
  a8:	66 90                	xchg   %ax,%ax
  aa:	66 90                	xchg   %ax,%ax
...
000003b2 <kthread_exit>:
SYSCALL(kthread_exit)
 3b2:	b8 18 00 00 00       	mov    $0x18,%eax
 3b7:	cd 40                	int    $0x40
 3b9:	c3                   	ret    

000003ba <kthread_join>:
...
printf(int fd, const char *fmt, ...)
{
 ...
 624:	e9 8f fe ff ff       	jmp    4b8 <printf+0x48>
          s = "(null)";
 629:	bb e9 07 00 00       	mov    $0x7e9,%ebx
        while(*s != 0){
 ...
 641:	a1 f4 0a 00 00       	mov    0xaf4,%eax
{
 ...
 67d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 67f:	a3 f4 0a 00 00       	mov    %eax,0xaf4
}
 684:	5b                   	pop    %ebx
 685:	5e                   	pop    %esi
 686:	5f                   	pop    %edi
 ...
 696:	72 ce                	jb     666 <free+0x26>
{
 ...
 6b7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 6ba:	a3 f4 0a 00 00       	mov    %eax,0xaf4
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6d9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6dc:	8b 15 f4 0a 00 00    	mov    0xaf4,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 71f:	73 47                	jae    768 <malloc+0x98>
    ...
    if(p == freep)
 721:	39 05 f4 0a 00 00    	cmp    %eax,0xaf4
 ...
 746:	e8 f5 fe ff ff       	call   640 <free>
  return freep;
 74b:	8b 15 f4 0a 00 00    	mov    0xaf4,%edx
 ...
 774:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 777:	89 15 f4 0a 00 00    	mov    %edx,0xaf4
}
 ...
 797:	0a 00 00 
 79a:	c7 05 f8 0a 00 00 f8 	movl   $0xaf8,0xaf8
 7a1:	0a 00 00 
    base.s.size = 0;
 7a4:	b8 f8 0a 00 00       	mov    $0xaf8,%eax
